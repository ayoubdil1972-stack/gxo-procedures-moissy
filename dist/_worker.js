var Vr=Object.defineProperty;var Nt=t=>{throw TypeError(t)};var Hr=(t,r,s)=>r in t?Vr(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var v=(t,r,s)=>Hr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Nt("Cannot "+s);var m=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),k=(t,r,s)=>r.has(t)?Nt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),w=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),T=(t,r,s)=>(lt(t,r,"access private method"),s);var Ft=(t,r,s,i)=>({set _(a){w(t,r,a,s)},get _(){return m(t,r,i)}});var ir={Stringify:1},O=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];te(n,o),s=o[0]}}return O(s,r)},te=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")te(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):te(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?O(nr(O(s[0],s.callbacks))):O(s[0]):ar(s,s.callbacks)},Ct=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),S=Symbol("STASH"),lr=Symbol("INTERNAL"),Xr=Symbol("MEMO"),rt=Symbol("PERMALINK"),Dt=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:Dt(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:Dt(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,Ee.push(s),s},Ee=[],Tt=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>O(n,n.callbacks)):O(a)};return s.values=r,s.Provider=s,s[Ct]=cr(r),Ee.push(s),s},Ce=t=>t.values.at(-1),Xe={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},We="data-precedence",ze=t=>Array.isArray(t)?t:[t],jt=new WeakMap,Pt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=jt.get(n)||{};jt.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=Xe[t];if(d.length>0){e:for(const[,u]of o)for(const h of d)if(((u==null?void 0:u[h])??null)===(s==null?void 0:s[h])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=o.map(([h])=>h);else{const h=[];u=o.map(([f,,g])=>{let x=h.indexOf(g);return x===-1&&(h.push(g),x=h.length-1),[f,x]}).sort((f,g)=>f[1]-g[1]).map(([f])=>f)}u.forEach(h=>{a[0]=a[0].replaceAll(h,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Be=(t,r,s)=>O(new z(t,s,ze(r??[])).toString()),Ue=(t,r,s,i)=>{if("itemProp"in s)return Be(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[We]=a);const o=new z(t,l,ze(r||[])).toString();return o instanceof Promise?o.then(c=>O(o,[...c.callbacks||[],Pt(t,c,l,a)])):O(o,[Pt(t,o,l,a)])},Wr=({children:t,...r})=>{const s=qt();if(s){const i=Ce(s);if(i==="svg"||i==="head")return new z("title",r,ze(t??[]))}return Ue("title",t,r,!1)},Yr=({children:t,...r})=>{const s=qt();return["src","async"].some(i=>!r[i])||s&&Ce(s)==="head"?Be("script",t,r):Ue("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,Ue("style",t,r,!0)):Be("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Be("link",t,r):Ue("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=qt();return s&&Ce(s)==="head"?Be("meta",t,r):Ue("meta",t,r,!1)},ur=(t,{children:r,...s})=>new z(t,s,ze(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),ts=t=>mr("input",t),rs=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Wr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Ne=void 0,qt=()=>Ne,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],_t=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")te(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof z?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):_t(a,r)}}},z=class{constructor(t,r,s){v(this,"tag");v(this,"props");v(this,"key");v(this,"children");v(this,"isEscaped",!0);v(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(O(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=Ne&&Ce(Ne)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";hr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',te(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,te(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&ns.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[O(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,te(l.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",_t(i,t),t[0]+=`</${r}>`}},dt=class extends z{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ee.length===0)t.unshift("",i);else{const a=Ee.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof z&&(n.localContexts=a),n)))}else i instanceof z?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},fr=class extends z{toStringToBuffer(t){_t(this.children,t)}},Ot=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},It=!1,Ye=(t,r,s)=>{if(!It){for(const i in vt)ct[i][Ct]=vt[i];It=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(Ne||(Ne=Tt("")),new z(t,r,[new dt(Ne,{value:t},s)])):new z(t,r,s)},os=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Lt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,u;if(t[o]?(u=t[o][0][0],i.req.routeIndex=o):u=o===t.length&&a||void 0,u)try{c=await u(i,()=>l(o+1))}catch(h){if(h instanceof Error&&r)i.error=h,c=await r(h,i),d=!0;else throw h}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},pr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=pr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},At=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>At(t,decodeURI),gr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return xs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=gr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},me=(t,r,...s)=>(s.length&&(r=me(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?At(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=ut(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=xr,ws=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,Mt=t=>At(t,vr),pe,P,Q,wr,Er,yt,W,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){k(this,Q);v(this,"raw");k(this,pe);k(this,P);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});k(this,W,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,w(this,P,s),w(this,pe,{})}param(t){return t?T(this,Q,wr).call(this,t):T(this,Q,Er).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return m(this,W).call(this,"text").then(t=>JSON.parse(t))}text(){return m(this,W).call(this,"text")}arrayBuffer(){return m(this,W).call(this,"arrayBuffer")}blob(){return m(this,W).call(this,"blob")}formData(){return m(this,W).call(this,"formData")}addValidatedData(t,r){m(this,pe)[t]=r}valid(t){return m(this,pe)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return m(this,P)}get matchedRoutes(){return m(this,P)[0].map(([[,t]])=>t)}get routePath(){return m(this,P)[0].map(([[,t]])=>t)[this.routeIndex].path}},pe=new WeakMap,P=new WeakMap,Q=new WeakSet,wr=function(t){const r=m(this,P)[0][this.routeIndex][1][t],s=T(this,Q,yt).call(this,r);return s&&/\%/.test(s)?Mt(s):s},Er=function(){const t={},r=Object.keys(m(this,P)[0][this.routeIndex][1]);for(const s of r){const i=T(this,Q,yt).call(this,m(this,P)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Mt(i):i)}return t},yt=function(t){return m(this,P)[1]?m(this,P)[1][t]:t},W=new WeakMap,Jt),Es="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),je,Pe,$,ge,V,j,Oe,be,xe,ie,Ie,Le,Y,he,Kt,ks=(Kt=class{constructor(t,r){k(this,Y);k(this,je);k(this,Pe);v(this,"env",{});k(this,$);v(this,"finalized",!1);v(this,"error");k(this,ge);k(this,V);k(this,j);k(this,Oe);k(this,be);k(this,xe);k(this,ie);k(this,Ie);k(this,Le);v(this,"render",(...t)=>(m(this,be)??w(this,be,r=>this.html(r)),m(this,be).call(this,...t)));v(this,"setLayout",t=>w(this,Oe,t));v(this,"getLayout",()=>m(this,Oe));v(this,"setRenderer",t=>{w(this,be,t)});v(this,"header",(t,r,s)=>{this.finalized&&w(this,j,new Response(m(this,j).body,m(this,j)));const i=m(this,j)?m(this,j).headers:m(this,ie)??w(this,ie,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});v(this,"status",t=>{w(this,ge,t)});v(this,"set",(t,r)=>{m(this,$)??w(this,$,new Map),m(this,$).set(t,r)});v(this,"get",t=>m(this,$)?m(this,$).get(t):void 0);v(this,"newResponse",(...t)=>T(this,Y,he).call(this,...t));v(this,"body",(t,r,s)=>T(this,Y,he).call(this,t,r,s));v(this,"text",(t,r,s)=>!m(this,ie)&&!m(this,ge)&&!r&&!s&&!this.finalized?new Response(t):T(this,Y,he).call(this,t,r,mt(Es,s)));v(this,"json",(t,r,s)=>T(this,Y,he).call(this,JSON.stringify(t),r,mt("application/json",s)));v(this,"html",(t,r,s)=>{const i=a=>T(this,Y,he).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});v(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});v(this,"notFound",()=>(m(this,xe)??w(this,xe,()=>new Response),m(this,xe).call(this,this)));w(this,je,t),r&&(w(this,V,r.executionCtx),this.env=r.env,w(this,xe,r.notFoundHandler),w(this,Le,r.path),w(this,Ie,r.matchResult))}get req(){return m(this,Pe)??w(this,Pe,new yr(m(this,je),m(this,Le),m(this,Ie))),m(this,Pe)}get event(){if(m(this,V)&&"respondWith"in m(this,V))return m(this,V);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,V))return m(this,V);throw Error("This context has no ExecutionContext")}get res(){return m(this,j)||w(this,j,new Response(null,{headers:m(this,ie)??w(this,ie,new Headers)}))}set res(t){if(m(this,j)&&t){t=new Response(t.body,t);for(const[r,s]of m(this,j).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=m(this,j).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}w(this,j,t),this.finalized=!0}get var(){return m(this,$)?Object.fromEntries(m(this,$)):{}}},je=new WeakMap,Pe=new WeakMap,$=new WeakMap,ge=new WeakMap,V=new WeakMap,j=new WeakMap,Oe=new WeakMap,be=new WeakMap,xe=new WeakMap,ie=new WeakMap,Ie=new WeakMap,Le=new WeakMap,Y=new WeakSet,he=function(t,r,s){const i=m(this,j)?new Headers(m(this,j).headers):m(this,ie)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,ge);return new Response(t,{status:a,headers:i})},Kt),R="ALL",Cs="all",Ts=["get","post","put","delete","options","patch"],kr="Can not add a route since the matcher is already built.",Cr=class extends Error{},qs="__COMPOSED_HANDLER",_s=t=>t.text("404 Not Found",404),zt=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},I,N,Tr,L,re,Ze,Je,ve,As=(ve=class{constructor(r={}){k(this,N);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");k(this,I,"/");v(this,"routes",[]);k(this,L,_s);v(this,"errorHandler",zt);v(this,"onError",r=>(this.errorHandler=r,this));v(this,"notFound",r=>(w(this,L,r),this));v(this,"fetch",(r,...s)=>T(this,N,Je).call(this,r,s[1],s[0],r.method));v(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${me("/",r)}`,s),i,a)));v(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(T(this,N,Je).call(this,r.request,r,void 0,r.request.method))})});[...Ts,Cs].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?w(this,I,l):T(this,N,re).call(this,n,m(this,I),l),o.forEach(c=>{T(this,N,re).call(this,n,m(this,I),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){w(this,I,c);for(const d of[n].flat())o.map(u=>{T(this,N,re).call(this,d.toUpperCase(),m(this,I),u)})}return this},this.use=(n,...l)=>(typeof n=="string"?w(this,I,n):(w(this,I,"*"),l.unshift(n)),l.forEach(o=>{T(this,N,re).call(this,R,m(this,I),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??gr:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===zt?n=a.handler:(n=async(o,c)=>(await Lt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[qs]=a.handler),T(l=i,N,re).call(l,a.method,a.path,n)}),this}basePath(r){const s=T(this,N,Tr).call(this);return s._basePath=me(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=me(this._basePath,r),d=c==="/"?0:c.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const o=async(c,d)=>{const u=await s(a(c.req.raw),...l(c));if(u)return u;await d()};return T(this,N,re).call(this,R,me(r,"*"),o),this}},I=new WeakMap,N=new WeakSet,Tr=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,w(r,L,m(this,L)),r.routes=this.routes,r},L=new WeakMap,re=function(r,s,i){r=r.toUpperCase(),s=me(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await T(this,N,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new ks(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:m(this,L)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await m(this,L).call(this,o)})}catch(u){return T(this,N,Ze).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:m(this,L).call(this,o))).catch(u=>T(this,N,Ze).call(this,u,o)):d??m(this,L).call(this,o)}const c=Lt(l[0],this.errorHandler,m(this,L));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return T(this,N,Ze).call(this,d,o)}})()},ve),qr=[];function Ss(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[R],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],qr];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Se=".*",Re="(?:|/.*)",fe=Symbol(),Rs=new Set(".\\+*[^]$()");function Ns(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Se||t===Re?1:r===Se||r===Re?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ae,ne,M,ce,Fs=(ce=class{constructor(){k(this,ae);k(this,ne);k(this,M,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(m(this,ae)!==void 0)throw fe;if(n)return;w(this,ae,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",Se]:["","",it]:l==="/*"?["","",Re]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let h=c[2]||it;if(u&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw fe;if(d=m(this,M)[h],!d){if(Object.keys(m(this,M)).some(f=>f!==Se&&f!==Re))throw fe;if(n)return;d=m(this,M)[h]=new ce,u!==""&&w(d,ne,a.varIndex++)}!n&&u!==""&&i.push([u,m(d,ne)])}else if(d=m(this,M)[l],!d){if(Object.keys(m(this,M)).some(u=>u.length>1&&u!==Se&&u!==Re))throw fe;if(n)return;d=m(this,M)[l]=new ce}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(m(this,M)).sort(Ns).map(i=>{const a=m(this,M)[i];return(typeof m(a,ne)=="number"?`(${i})@${m(a,ne)}`:Rs.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof m(this,ae)=="number"&&s.unshift(`#${m(this,ae)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ae=new WeakMap,ne=new WeakMap,M=new WeakMap,ce),at,Me,er,Ds=(er=class{constructor(){k(this,at,{varIndex:0});k(this,Me,new Fs)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return m(this,Me).insert(n,r,i,m(this,at),s),i}buildRegExp(){let t=m(this,Me).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,Me=new WeakMap,er),js=[/^$/,[],Object.create(null)],Ke=Object.create(null);function _r(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ps(){Ke=Object.create(null)}function Os(t){var d;const r=new Ds,s=[];if(t.length===0)return js;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,g])=>u?1:f?-1:h.length-g.length),a=Object.create(null);for(let u=0,h=-1,f=i.length;u<f;u++){const[g,x,y]=i[u];g?a[x]=[y.map(([E])=>[E,Object.create(null)]),qr]:h++;let b;try{b=r.insert(x,h,g)}catch(E){throw E===fe?new Cr(x):E}g||(s[h]=y.map(([E,C])=>{const _=Object.create(null);for(C-=1;C>=0;C--){const[q,A]=b[C];_[q]=A}return[E,_]}))}const[n,l,o]=r.buildRegExp();for(let u=0,h=s.length;u<h;u++)for(let f=0,g=s[u].length;f<g;f++){const x=(d=s[u][f])==null?void 0:d[1];if(!x)continue;const y=Object.keys(x);for(let b=0,E=y.length;b<E;b++)x[y[b]]=o[x[y[b]]]}const c=[];for(const u in l)c[u]=s[l[u]];return[n,c,a]}function de(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(_r(s).test(r))return[...t[s]]}}var Z,J,nt,Ar,tr,Is=(tr=class{constructor(){k(this,nt);v(this,"name","RegExpRouter");k(this,Z);k(this,J);v(this,"match",Ss);w(this,Z,{[R]:Object.create(null)}),w(this,J,{[R]:Object.create(null)})}add(t,r,s){var o;const i=m(this,Z),a=m(this,J);if(!i||!a)throw new Error(kr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[t][d]=[...c[R][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=_r(r);t===R?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=de(i[d],r)||de(i[R],r)||[])}):(o=i[t])[r]||(o[r]=de(i[t],r)||de(i[R],r)||[]),Object.keys(i).forEach(d=>{(t===R||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===R||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const l=br(r)||[r];for(let c=0,d=l.length;c<d;c++){const u=l[c];Object.keys(a).forEach(h=>{var f;(t===R||t===h)&&((f=a[h])[u]||(f[u]=[...de(i[h],u)||de(i[R],u)||[]]),a[h][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(m(this,J)).concat(Object.keys(m(this,Z))).forEach(r=>{t[r]||(t[r]=T(this,nt,Ar).call(this,r))}),w(this,Z,w(this,J,void 0)),Ps(),t}},Z=new WeakMap,J=new WeakMap,nt=new WeakSet,Ar=function(t){const r=[];let s=t===R;return[m(this,Z),m(this,J)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==R&&r.push(...Object.keys(i[R]).map(n=>[n,i[R][n]]))}),s?Os(r):null},tr),K,H,rr,Ls=(rr=class{constructor(t){v(this,"name","SmartRouter");k(this,K,[]);k(this,H,[]);w(this,K,t.routers)}add(t,r,s){if(!m(this,H))throw new Error(kr);m(this,H).push([t,r,s])}match(t,r){if(!m(this,H))throw new Error("Fatal error");const s=m(this,K),i=m(this,H),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof Cr)continue;throw c}this.match=o.match.bind(o),w(this,K,[o]),w(this,H,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(m(this,H)||m(this,K).length!==1)throw new Error("No active router has been determined yet.");return m(this,K)[0]}},K=new WeakMap,H=new WeakMap,rr),_e=Object.create(null),ee,D,oe,ye,F,G,se,we,Ms=(we=class{constructor(r,s,i){k(this,G);k(this,ee);k(this,D);k(this,oe);k(this,ye,0);k(this,F,_e);if(w(this,D,i||Object.create(null)),w(this,ee,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},w(this,ee,[a])}w(this,oe,[])}insert(r,s,i){w(this,ye,++Ft(this,ye)._);let a=this;const n=fs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],u=n[o+1],h=bs(d,u),f=Array.isArray(h)?h[0]:d;if(f in m(a,D)){a=m(a,D)[f],h&&l.push(h[1]);continue}m(a,D)[f]=new we,h&&(m(a,oe).push(h),l.push(h[1])),a=m(a,D)[f]}return m(a,ee).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:m(this,ye)}}),a}search(r,s){var c;const i=[];w(this,F,_e);let n=[this];const l=pr(s),o=[];for(let d=0,u=l.length;d<u;d++){const h=l[d],f=d===u-1,g=[];for(let x=0,y=n.length;x<y;x++){const b=n[x],E=m(b,D)[h];E&&(w(E,F,m(b,F)),f?(m(E,D)["*"]&&i.push(...T(this,G,se).call(this,m(E,D)["*"],r,m(b,F))),i.push(...T(this,G,se).call(this,E,r,m(b,F)))):g.push(E));for(let C=0,_=m(b,oe).length;C<_;C++){const q=m(b,oe)[C],A=m(b,F)===_e?{}:{...m(b,F)};if(q==="*"){const X=m(b,D)["*"];X&&(i.push(...T(this,G,se).call(this,X,r,m(b,F))),w(X,F,A),g.push(X));continue}const[Te,He,qe]=q;if(!h&&!(qe instanceof RegExp))continue;const B=m(b,D)[Te],$r=l.slice(d).join("/");if(qe instanceof RegExp){const X=qe.exec($r);if(X){if(A[He]=X[0],i.push(...T(this,G,se).call(this,B,r,m(b,F),A)),Object.keys(m(B,D)).length){w(B,F,A);const ot=((c=X[0].match(/\//))==null?void 0:c.length)??0;(o[ot]||(o[ot]=[])).push(B)}continue}}(qe===!0||qe.test(h))&&(A[He]=h,f?(i.push(...T(this,G,se).call(this,B,r,A,m(b,F))),m(B,D)["*"]&&i.push(...T(this,G,se).call(this,m(B,D)["*"],r,A,m(b,F)))):(w(B,F,A),g.push(B)))}}n=g.concat(o.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},ee=new WeakMap,D=new WeakMap,oe=new WeakMap,ye=new WeakMap,F=new WeakMap,G=new WeakSet,se=function(r,s,i,a){const n=[];for(let l=0,o=m(r,ee).length;l<o;l++){const c=m(r,ee)[l],d=c[s]||c[R],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==_e||a&&a!==_e))for(let h=0,f=d.possibleKeys.length;h<f;h++){const g=d.possibleKeys[h],x=u[d.score];d.params[g]=a!=null&&a[g]&&!x?a[g]:i[g]??(a==null?void 0:a[g]),u[d.score]=!0}}return n},we),le,sr,zs=(sr=class{constructor(){v(this,"name","TrieRouter");k(this,le);w(this,le,new Ms)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)m(this,le).insert(t,i[a],s);return}m(this,le).insert(t,r,s)}match(t,r){return m(this,le).search(t,r)}},le=new WeakMap,sr),Sr=class extends As{constructor(t={}){super(t),this.router=t.router??new Ls({routers:[new Is,new zs]})}},Bs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Bt=(t,r=$s)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Us={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},$s=Us,Vs=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Hs=Object.keys(Rr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??Vs;return async(a,n)=>{var u,h,f,g;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Gs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const x=t.mimes&&Bt(o,t.mimes)||Bt(o);if(a.header("Content-Type",x||"application/octet-stream"),t.precompressed&&(!x||Bs.test(x))){const y=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(b=>b.trim()));for(const b of Hs){if(!y.has(b))continue;const E=await c(o+Rr[b],a);if(E){d=E,a.header("Content-Encoding",b),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((g=t.onNotFound)==null?void 0:g.call(t,o,a)),await n()}},Xs=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Ws=t=>async function(s,i){return Qs({...t,getContent:async n=>Xs(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Ws(t),Fe="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},De=[],wt=new WeakMap,ke=void 0,Ks=()=>ke,U=t=>"t"in t,ht={onClick:["click",!1]},Ut=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},$t=(t,r)=>ke&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=Ut(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),wt.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&hr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=$t(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=Ut(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute($t(t,a))}}},ti=(t,r)=>{r[S][0]=0,De.push([t,r]);const s=r.tag[Ct]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{De.pop()}},Nr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[S][1][Pr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if(U(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Nr(o,r,s,i,a),o.s){for(let u=d;u<s.length;u++)s[u].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ri=t=>{for(;;t=t.tag===Fe||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==Fe&&t.e)return t.e}},Fr=t=>{var r,s,i,a,n,l;U(t)||((s=(r=t[S])==null?void 0:r[1][Pr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(Fr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Ae.delete(t),et.delete(t),delete t[S][3],t.a=!0)},Dr=(t,r,s)=>{t.c=r,jr(t,r,s)},Vt=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Ht=Symbol(),jr=(t,r,s)=>{var d;const i=[],a=[],n=[];Nr(t,r,i,a,n),a.forEach(Fr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const u=Vt(l,ri(t.nN));u!==void 0?(c=l[u],o=u):o=Vt(l,(d=i.find(h=>h.tag!==Fe&&h.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let u=0,h=i.length;u<h;u++,o++){const f=i[u];let g;if(f.s&&f.e)g=f.e,f.s=!1;else{const x=s||!f.e;U(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,g=f.e||(f.e=document.createTextNode(f.t))):(g=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(g,f.props,f.pP),jr(f,g,x))}f.tag===Fe?o--:s?g.parentNode||r.appendChild(g):l[o]!==g&&l[o-1]!==g&&(l[o+1]===g?r.appendChild(l[o]):r.insertBefore(g,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const u=[],h=[];n.forEach(([,f,,g,x])=>{f&&u.push(f),g&&h.push(g),x==null||x()}),u.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,l,o,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):ze(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const h=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let g;for(let x=0;x<s.length;x++){Array.isArray(s[x])&&s.splice(x,1,...s[x].flat());let y=ii(s[x]);if(y){typeof y.tag=="function"&&!y.tag[lr]&&(Ee.length>0&&(y[S][2]=Ee.map(E=>[E,E.values.at(-1)])),(l=t[5])!=null&&l.length&&(y[S][3]=t[5].at(-1)));let b;if(h&&h.length){const E=h.findIndex(U(y)?C=>U(C):y.key!==void 0?C=>C.key===y.key&&C.tag===y.tag:C=>C.tag===y.tag);E!==-1&&(b=h[E],h.splice(E,1))}if(b)if(U(y))b.t!==y.t&&(b.t=y.t,b.d=!0),y=b;else{const E=b.pP=b.props;if(b.props=y.props,b.f||(b.f=y.f||r.f),typeof y.tag=="function"){const C=b[S][2];b[S][2]=y[S][2]||[],b[S][3]=y[S][3],!b.f&&((b.o||b)===y.o||(c=(o=b.tag)[Xr])!=null&&c.call(o,E,b.props))&&si(C,b[S][2])&&(b.s=!0)}y=b}else if(!U(y)&&ke){const E=Ce(ke);E&&(y.n=E)}if(!U(y)&&!y.s&&(Et(t,y),delete y.f),f.push(y),g&&!g.s&&!y.s)for(let E=g;E&&!U(E);E=(d=E.vC)==null?void 0:d.at(-1))E.nN=y;g=y}}r.vR=i?[...r.vC,...h||[]]:h||[],r.vC=f,i&&delete r.pC}catch(h){if(r.f=!0,h===Ht){if(a)return;throw h}const[f,g,x]=((u=r[S])==null?void 0:u[3])||[];if(g){const y=()=>tt([0,!1,t[2]],x),b=et.get(x)||[];b.push(y),et.set(x,b);const E=g(h,()=>{const C=et.get(x);if(C){const _=C.indexOf(y);if(_!==-1)return C.splice(_,1),y()}});if(E){if(t[0]===1)t[1]=!0;else if(Et(t,x,[E]),(g.length===1||t!==f)&&x.c){Dr(x,x.c,!1);return}throw Ht}}throw h}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[S]=[0,[]];else{const r=Js[t.tag];r&&(ke||(ke=dr("")),t.props.children=[{tag:ke,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[S][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[S][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&Dr(r,r.c,!1)},Ae=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Ae.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Ae.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Ae.get(r);n&&(Ae.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:Fe,props:{children:t},key:s,e:r,p:1}),ft=0,Pr=1,pt=2,gt=3,bt=new WeakMap,Or=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Xt=[],oi=t=>{var l;const r=()=>typeof t=="function"?t():t,s=De.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[S][1])[ft]||(l[ft]=[]),n=i[S][0]++;return a[n]||(a[n]=[r(),o=>{const c=ni,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Xt.length){const[u,h]=Xt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),h]).then(([f])=>{if(!f||!(u===2||u===3))return;const g=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{g===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},St=(t,r)=>{var o;const s=De.at(-1);if(!s)return t;const[,i]=s,a=(o=i[S][1])[pt]||(o[pt]=[]),n=i[S][0]++,l=a[n];return Or(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},ci=(t,r)=>{var o;const s=De.at(-1);if(!s)return t();const[,i]=s,a=(o=i[S][1])[gt]||(o[gt]=[]),n=i[S][0]++,l=a[n];return Or(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},di=dr({pending:!1,data:null,method:null,action:null}),Wt=new Set,ui=t=>{Wt.add(t),t.finally(()=>Wt.delete(t))},Rt=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),ue=Object.create(null),Qe=Object.create(null),$e=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...u}=r,h=null,f=!1;const g=Xe[t];let x;if(g.length>0){const C=n.querySelectorAll(t);e:for(const _ of C)for(const q of Xe[t])if(_.getAttribute(q)===r[q]){h=_;break e}if(!h){const _=g.reduce((q,A)=>r[A]===void 0?q:`${q}-${A}-${r[A]}`,t);f=!Qe[_],h=Qe[_]||(Qe[_]=(()=>{const q=document.createElement(t);for(const A of g)r[A]!==void 0&&q.setAttribute(A,r[A]),r.rel&&q.setAttribute("rel",r.rel);return q})())}}else x=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[We]=c);const y=St(C=>{if(g.length>0){let _=!1;for(const q of n.querySelectorAll(t)){if(_&&q.getAttribute(We)!==c){n.insertBefore(C,q);return}q.getAttribute(We)===c&&(_=!0)}n.appendChild(C)}else if(x){let _=!1;for(const q of x)if(q===C){_=!0;break}_||n.insertBefore(C,n.contains(x[0])?x[0]:n.querySelector(t)),x=void 0}},[c]),b=Rt(r.ref,C=>{var A;const _=g[0];if(s===2&&(C.innerHTML=""),(f||x)&&y(C),!o&&!l)return;let q=ue[A=C.getAttribute(_)]||(ue[A]=new Promise((Te,He)=>{C.addEventListener("load",Te),C.addEventListener("error",He)}));l&&(q=q.then(l)),o&&(q=q.catch(o)),q.catch(()=>{})});if(a&&d==="render"){const C=Xe[t][0];if(r[C]){const _=r[C],q=ue[_]||(ue[_]=new Promise((A,Te)=>{y(h),h.addEventListener("load",A),h.addEventListener("error",Te)}));li(q)}}const E={tag:t,type:t,props:{...u,ref:b},ref:b};return E.p=s,h&&(E.e=h),ai(E,n)},mi=t=>{const r=Ks(),s=r&&Ce(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:$e("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:$e("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,$e("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:$e("link",t,1,"precedence"in t,!0),gi=t=>$e("meta",t,void 0,!1,!1),Ir=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=St(async d=>{const u=d.isTrusted?r:d.detail[Ir];if(typeof u!="function")return;d.preventDefault();const h=new FormData(d.target);a([h,!0]);const f=u(h);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),l=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Lr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=St(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ir]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Lr("input",t),vi=t=>Lr("button",t);Object.assign(vt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});Tt(null);new TextEncoder;var yi=Tt(null),wi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Ot(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${O(l)}${Ot(yi.Provider,{value:t},o)}`;return t.html(c)},Mr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Mr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Hi(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:l}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const p=new Sr;function zr(){const t=new Date;return new Date(t.toLocaleString("en-US",{timeZone:"Europe/Paris"})).toISOString()}p.use("/static/*",Ys({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));p.get("/login",Ve,t=>t.render(e(Pi,{})));p.get("/qrcode-chauffeur",Ve,t=>t.render(e(Oi,{})));p.get("/chauffeur/langue",Ve,t=>t.render(e(Ii,{})));p.get("/gestion-quais",Ve,t=>t.render(e(Ui,{})));p.get("/pdf-barcodes",t=>t.html($i()));p.get("/qrcode-generator",t=>t.html(Vi()));p.get("/scan-dechargement",t=>{const r=t.req.query("quai");return t.redirect(`/scan?quai=${r}`)});p.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
  ...
  `):t.html(`
    ...
    `)});p.post("/api/fin-controle",async t=>{try{const r=await t.req.json(),{quai:s,controleurNom:i}=r;if(!s||!i)return t.json({error:"Données manquantes"},400);const a=await t.env.DB.prepare(`
      ...
      FROM quai_status 
      WHERE quai_numero = ?
    `).bind(s).first();let n=null;if(a!=null&&a.timer_controle_start){const l=new Date(a.timer_controle_start.replace(" ","T")).getTime(),o=new Date(zr()).getTime();n=Math.floor((o-l)/1e3),console.log(`⏱️ Durée contrôle calculée: ${n}s`)}return await t.env.DB.prepare(`
      UPDATE quai_status 
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
...
</html>`));p.get("/chauffeur/consignes",t=>{const r=t.req.query("lang")||"fr";return t.redirect(`/consignes/${r}`)});p.get("/chauffeur/video",t=>t.redirect("/chauffeur/consignes?lang="+(t.req.query("lang")||"fr")));p.get("/chauffeur/inscription",t=>{const r=t.req.query("lang")||"fr";return t.html(Mi({lang:r}))});p.get("/chauffeur/taches",Ve,t=>t.render(e(zi,{})));p.post("/api/chauffeur/inscription",async t=>{try{const{pseudo:r,entreprise:s,numero_quai:i,langue:a,video_completed:n}=await t.req.json(),l=await t.env.DB.prepare(`
    ...
    `).bind(r.quai_numero,r.nom_agent,r.palettes_attendues,r.palettes_recues,r.palettes_a_rendre,a,r.autres_commentaire||null,i).run();console.log("✅ Fin de déchargement enregistrée - ID:",n.meta.last_row_id);try{const o=await t.env.DB.prepare(`
      ...
      `).bind(r.quai_numero).first();console.log("📊 Quai data:",o);let c=null;if(o!=null&&o.timer_start){const d=new Date(o.timer_start.replace(" ","T")).getTime(),u=new Date(zr()).getTime();c=Math.floor((u-d)/1e3),console.log(`⏱️ Durée calculée: ${c}s (${Math.floor(c/3600)}h ${Math.floor(c%3600/60)}m ${c%60}s)`)}console.log("💾 UPDATE avec:",{timerDuration:c,commentaire:`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,commentaire_auteur:r.nom_agent,quai_numero:r.quai_numero}),await t.env.DB.prepare(`
        UPDATE quai_status 
      ...
      `).bind(`✅ Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id} - Timer: voir historique`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme disponible (fallback) - Timer conservé dans commentaire")}let l=!1;try{console.log("🔍 Vérification alerte - Données reçues:",{palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,problemes:r.problemes});const o=parseInt(r.palettes_attendues)!==parseInt(r.palettes_recues);console.log("📊 Écart palettes:",o,`(${r.palettes_attendues} vs ${r.palettes_recues})`);const c=r.problemes||[],d=c.length>0;if(console.log("⚠️ Non-conformités:",d,"Nombre:",c.length),o||d){console.log("🚨 DÉCLENCHEMENT ALERTE - Création en cours..."),console.log("   Quai:",r.quai_numero),console.log("   ID:",r.numero_id),console.log("   Fournisseur:",r.fournisseur);const u=await t.env.DB.prepare(`
        ...
        `).run(),console.log("✅ Table controleur_alertes vérifiée");let h="";o&&(h=`Écart palettes: Attendues ${r.palettes_attendues}, Reçues ${r.palettes_recues}`);const f=JSON.stringify(c);console.log("📝 Non-conformités JSON:",f);const g=await t.env.DB.prepare(`
