var $r=Object.defineProperty;var Nt=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?$r(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var y=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Nt("Cannot "+s);var h=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),k=(t,r,s)=>r.has(t)?Nt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),E=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),A=(t,r,s)=>(lt(t,r,"access private method"),s);var Dt=(t,r,s,i)=>({set _(a){E(t,r,a,s)},get _(){return h(t,r,i)}});var ir={Stringify:1},I=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];se(n,o),s=o[0]}}return I(s,r)},se=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")se(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):se(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?I(nr(I(s[0],s.callbacks))):I(s[0]):ar(s,s.callbacks)},kt=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),S=Symbol("STASH"),lr=Symbol("INTERNAL"),Wr=Symbol("MEMO"),rt=Symbol("PERMALINK"),jt=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:jt(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:jt(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,ke.push(s),s},ke=[],_t=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>I(n,n.callbacks)):I(a)};return s.values=r,s.Provider=s,s[kt]=cr(r),ke.push(s),s},Ce=t=>t.values.at(-1),We={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},Xe="data-precedence",Be=t=>Array.isArray(t)?t:[t],Ft=new WeakMap,Pt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=Ft.get(n)||{};Ft.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=We[t];if(d.length>0){e:for(const[,u]of o)for(const m of d)if(((u==null?void 0:u[m])??null)===(s==null?void 0:s[m])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=o.map(([m])=>m);else{const m=[];u=o.map(([f,,g])=>{let b=m.indexOf(g);return b===-1&&(m.push(g),b=m.length-1),[f,b]}).sort((f,g)=>f[1]-g[1]).map(([f])=>f)}u.forEach(m=>{a[0]=a[0].replaceAll(m,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Ue=(t,r,s)=>I(new B(t,s,Be(r??[])).toString()),ze=(t,r,s,i)=>{if("itemProp"in s)return Ue(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[Xe]=a);const o=new B(t,l,Be(r||[])).toString();return o instanceof Promise?o.then(c=>I(o,[...c.callbacks||[],Pt(t,c,l,a)])):I(o,[Pt(t,o,l,a)])},Xr=({children:t,...r})=>{const s=Ct();if(s){const i=Ce(s);if(i==="svg"||i==="head")return new B("title",r,Be(t??[]))}return ze("title",t,r,!1)},Yr=({children:t,...r})=>{const s=Ct();return["src","async"].some(i=>!r[i])||s&&Ce(s)==="head"?Ue("script",t,r):ze("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,ze("style",t,r,!0)):Ue("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Ue("link",t,r):ze("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=Ct();return s&&Ce(s)==="head"?Ue("meta",t,r):ze("meta",t,r,!1)},ur=(t,{children:r,...s})=>new B(t,s,Be(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),ts=t=>mr("input",t),rs=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Xr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},De=void 0,Ct=()=>De,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],qt=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")se(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof B?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):qt(a,r)}}},B=class{constructor(t,r,s){y(this,"tag");y(this,"props");y(this,"key");y(this,"children");y(this,"isEscaped",!0);y(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(I(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=De&&Ce(De)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";hr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',se(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,se(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&ns.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[I(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,se(l.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",qt(i,t),t[0]+=`</${r}>`}},dt=class extends B{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(ke.length===0)t.unshift("",i);else{const a=ke.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof B&&(n.localContexts=a),n)))}else i instanceof B?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):se(i,t)}},fr=class extends B{toStringToBuffer(t){qt(this.children,t)}},Ot=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},It=!1,Ye=(t,r,s)=>{if(!It){for(const i in vt)ct[i][kt]=vt[i];It=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(De||(De=_t("")),new B(t,r,[new dt(De,{value:t},s)])):new B(t,r,s)},os=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Lt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,u;if(t[o]?(u=t[o][0][0],i.req.routeIndex=o):u=o===t.length&&a||void 0,u)try{c=await u(i,()=>l(o+1))}catch(m){if(m instanceof Error&&r)i.error=m,c=await r(m,i),d=!0;else throw m}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},pr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=pr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},At=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>At(t,decodeURI),gr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return xs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=gr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},fe=(t,r,...s)=>(s.length&&(r=fe(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?At(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=ut(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=xr,ws=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,Mt=t=>At(t,vr),be,O,X,wr,Er,yt,Z,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){k(this,X);y(this,"raw");k(this,be);k(this,O);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});k(this,Z,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,E(this,O,s),E(this,be,{})}param(t){return t?A(this,X,wr).call(this,t):A(this,X,Er).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return h(this,Z).call(this,"text").then(t=>JSON.parse(t))}text(){return h(this,Z).call(this,"text")}arrayBuffer(){return h(this,Z).call(this,"arrayBuffer")}blob(){return h(this,Z).call(this,"blob")}formData(){return h(this,Z).call(this,"formData")}addValidatedData(t,r){h(this,be)[t]=r}valid(t){return h(this,be)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return h(this,O)}get matchedRoutes(){return h(this,O)[0].map(([[,t]])=>t)}get routePath(){return h(this,O)[0].map(([[,t]])=>t)[this.routeIndex].path}},be=new WeakMap,O=new WeakMap,X=new WeakSet,wr=function(t){const r=h(this,O)[0][this.routeIndex][1][t],s=A(this,X,yt).call(this,r);return s&&/\%/.test(s)?Mt(s):s},Er=function(){const t={},r=Object.keys(h(this,O)[0][this.routeIndex][1]);for(const s of r){const i=A(this,X,yt).call(this,h(this,O)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Mt(i):i)}return t},yt=function(t){return h(this,O)[1]?h(this,O)[1][t]:t},Z=new WeakMap,Jt),Es="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),Pe,Oe,V,xe,G,F,Ie,ve,ye,ne,Le,Me,J,pe,Kt,Ts=(Kt=class{constructor(t,r){k(this,J);k(this,Pe);k(this,Oe);y(this,"env",{});k(this,V);y(this,"finalized",!1);y(this,"error");k(this,xe);k(this,G);k(this,F);k(this,Ie);k(this,ve);k(this,ye);k(this,ne);k(this,Le);k(this,Me);y(this,"render",(...t)=>(h(this,ve)??E(this,ve,r=>this.html(r)),h(this,ve).call(this,...t)));y(this,"setLayout",t=>E(this,Ie,t));y(this,"getLayout",()=>h(this,Ie));y(this,"setRenderer",t=>{E(this,ve,t)});y(this,"header",(t,r,s)=>{this.finalized&&E(this,F,new Response(h(this,F).body,h(this,F)));const i=h(this,F)?h(this,F).headers:h(this,ne)??E(this,ne,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});y(this,"status",t=>{E(this,xe,t)});y(this,"set",(t,r)=>{h(this,V)??E(this,V,new Map),h(this,V).set(t,r)});y(this,"get",t=>h(this,V)?h(this,V).get(t):void 0);y(this,"newResponse",(...t)=>A(this,J,pe).call(this,...t));y(this,"body",(t,r,s)=>A(this,J,pe).call(this,t,r,s));y(this,"text",(t,r,s)=>!h(this,ne)&&!h(this,xe)&&!r&&!s&&!this.finalized?new Response(t):A(this,J,pe).call(this,t,r,mt(Es,s)));y(this,"json",(t,r,s)=>A(this,J,pe).call(this,JSON.stringify(t),r,mt("application/json",s)));y(this,"html",(t,r,s)=>{const i=a=>A(this,J,pe).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});y(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});y(this,"notFound",()=>(h(this,ye)??E(this,ye,()=>new Response),h(this,ye).call(this,this)));E(this,Pe,t),r&&(E(this,G,r.executionCtx),this.env=r.env,E(this,ye,r.notFoundHandler),E(this,Me,r.path),E(this,Le,r.matchResult))}get req(){return h(this,Oe)??E(this,Oe,new yr(h(this,Pe),h(this,Me),h(this,Le))),h(this,Oe)}get event(){if(h(this,G)&&"respondWith"in h(this,G))return h(this,G);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,G))return h(this,G);throw Error("This context has no ExecutionContext")}get res(){return h(this,F)||E(this,F,new Response(null,{headers:h(this,ne)??E(this,ne,new Headers)}))}set res(t){if(h(this,F)&&t){t=new Response(t.body,t);for(const[r,s]of h(this,F).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=h(this,F).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}E(this,F,t),this.finalized=!0}get var(){return h(this,V)?Object.fromEntries(h(this,V)):{}}},Pe=new WeakMap,Oe=new WeakMap,V=new WeakMap,xe=new WeakMap,G=new WeakMap,F=new WeakMap,Ie=new WeakMap,ve=new WeakMap,ye=new WeakMap,ne=new WeakMap,Le=new WeakMap,Me=new WeakMap,J=new WeakSet,pe=function(t,r,s){const i=h(this,F)?new Headers(h(this,F).headers):h(this,ne)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??h(this,xe);return new Response(t,{status:a,headers:i})},Kt),R="ALL",ks="all",_s=["get","post","put","delete","options","patch"],Tr="Can not add a route since the matcher is already built.",kr=class extends Error{},Cs="__COMPOSED_HANDLER",qs=t=>t.text("404 Not Found",404),Ht=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},L,N,_r,M,ie,Ze,Je,we,As=(we=class{constructor(r={}){k(this,N);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");k(this,L,"/");y(this,"routes",[]);k(this,M,qs);y(this,"errorHandler",Ht);y(this,"onError",r=>(this.errorHandler=r,this));y(this,"notFound",r=>(E(this,M,r),this));y(this,"fetch",(r,...s)=>A(this,N,Je).call(this,r,s[1],s[0],r.method));y(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${fe("/",r)}`,s),i,a)));y(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(A(this,N,Je).call(this,r.request,r,void 0,r.request.method))})});[..._s,ks].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?E(this,L,l):A(this,N,ie).call(this,n,h(this,L),l),o.forEach(c=>{A(this,N,ie).call(this,n,h(this,L),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){E(this,L,c);for(const d of[n].flat())o.map(u=>{A(this,N,ie).call(this,d.toUpperCase(),h(this,L),u)})}return this},this.use=(n,...l)=>(typeof n=="string"?E(this,L,n):(E(this,L,"*"),l.unshift(n)),l.forEach(o=>{A(this,N,ie).call(this,R,h(this,L),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??gr:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===Ht?n=a.handler:(n=async(o,c)=>(await Lt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[Cs]=a.handler),A(l=i,N,ie).call(l,a.method,a.path,n)}),this}basePath(r){const s=A(this,N,_r).call(this);return s._basePath=fe(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=fe(this._basePath,r),d=c==="/"?0:c.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const o=async(c,d)=>{const u=await s(a(c.req.raw),...l(c));if(u)return u;await d()};return A(this,N,ie).call(this,R,fe(r,"*"),o),this}},L=new WeakMap,N=new WeakSet,_r=function(){const r=new we({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,E(r,M,h(this,M)),r.routes=this.routes,r},M=new WeakMap,ie=function(r,s,i){r=r.toUpperCase(),s=fe(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await A(this,N,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new Ts(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:h(this,M)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await h(this,M).call(this,o)})}catch(u){return A(this,N,Ze).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:h(this,M).call(this,o))).catch(u=>A(this,N,Ze).call(this,u,o)):d??h(this,M).call(this,o)}const c=Lt(l[0],this.errorHandler,h(this,M));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return A(this,N,Ze).call(this,d,o)}})()},we),Cr=[];function Ss(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[R],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],Cr];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Re=".*",Ne="(?:|/.*)",ge=Symbol(),Rs=new Set(".\\+*[^]$()");function Ns(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Re||t===Ne?1:r===Re||r===Ne?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var oe,le,H,ue,Ds=(ue=class{constructor(){k(this,oe);k(this,le);k(this,H,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(h(this,oe)!==void 0)throw ge;if(n)return;E(this,oe,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",Re]:["","",it]:l==="/*"?["","",Ne]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let m=c[2]||it;if(u&&c[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw ge;if(d=h(this,H)[m],!d){if(Object.keys(h(this,H)).some(f=>f!==Re&&f!==Ne))throw ge;if(n)return;d=h(this,H)[m]=new ue,u!==""&&E(d,le,a.varIndex++)}!n&&u!==""&&i.push([u,h(d,le)])}else if(d=h(this,H)[l],!d){if(Object.keys(h(this,H)).some(u=>u.length>1&&u!==Re&&u!==Ne))throw ge;if(n)return;d=h(this,H)[l]=new ue}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(h(this,H)).sort(Ns).map(i=>{const a=h(this,H)[i];return(typeof h(a,le)=="number"?`(${i})@${h(a,le)}`:Rs.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof h(this,oe)=="number"&&s.unshift(`#${h(this,oe)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},oe=new WeakMap,le=new WeakMap,H=new WeakMap,ue),at,He,er,js=(er=class{constructor(){k(this,at,{varIndex:0});k(this,He,new Ds)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return h(this,He).insert(n,r,i,h(this,at),s),i}buildRegExp(){let t=h(this,He).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,He=new WeakMap,er),Fs=[/^$/,[],Object.create(null)],Ke=Object.create(null);function qr(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ps(){Ke=Object.create(null)}function Os(t){var d;const r=new js,s=[];if(t.length===0)return Fs;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[f,g])=>u?1:f?-1:m.length-g.length),a=Object.create(null);for(let u=0,m=-1,f=i.length;u<f;u++){const[g,b,v]=i[u];g?a[b]=[v.map(([w])=>[w,Object.create(null)]),Cr]:m++;let x;try{x=r.insert(b,m,g)}catch(w){throw w===ge?new kr(b):w}g||(s[m]=v.map(([w,T])=>{const q=Object.create(null);for(T-=1;T>=0;T--){const[_,C]=x[T];q[_]=C}return[w,q]}))}const[n,l,o]=r.buildRegExp();for(let u=0,m=s.length;u<m;u++)for(let f=0,g=s[u].length;f<g;f++){const b=(d=s[u][f])==null?void 0:d[1];if(!b)continue;const v=Object.keys(b);for(let x=0,w=v.length;x<w;x++)b[v[x]]=o[b[v[x]]]}const c=[];for(const u in l)c[u]=s[l[u]];return[n,c,a]}function me(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(qr(s).test(r))return[...t[s]]}}var K,ee,nt,Ar,tr,Is=(tr=class{constructor(){k(this,nt);y(this,"name","RegExpRouter");k(this,K);k(this,ee);y(this,"match",Ss);E(this,K,{[R]:Object.create(null)}),E(this,ee,{[R]:Object.create(null)})}add(t,r,s){var o;const i=h(this,K),a=h(this,ee);if(!i||!a)throw new Error(Tr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[t][d]=[...c[R][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=qr(r);t===R?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=me(i[d],r)||me(i[R],r)||[])}):(o=i[t])[r]||(o[r]=me(i[t],r)||me(i[R],r)||[]),Object.keys(i).forEach(d=>{(t===R||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===R||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const l=br(r)||[r];for(let c=0,d=l.length;c<d;c++){const u=l[c];Object.keys(a).forEach(m=>{var f;(t===R||t===m)&&((f=a[m])[u]||(f[u]=[...me(i[m],u)||me(i[R],u)||[]]),a[m][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(h(this,ee)).concat(Object.keys(h(this,K))).forEach(r=>{t[r]||(t[r]=A(this,nt,Ar).call(this,r))}),E(this,K,E(this,ee,void 0)),Ps(),t}},K=new WeakMap,ee=new WeakMap,nt=new WeakSet,Ar=function(t){const r=[];let s=t===R;return[h(this,K),h(this,ee)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==R&&r.push(...Object.keys(i[R]).map(n=>[n,i[R][n]]))}),s?Os(r):null},tr),te,Q,rr,Ls=(rr=class{constructor(t){y(this,"name","SmartRouter");k(this,te,[]);k(this,Q,[]);E(this,te,t.routers)}add(t,r,s){if(!h(this,Q))throw new Error(Tr);h(this,Q).push([t,r,s])}match(t,r){if(!h(this,Q))throw new Error("Fatal error");const s=h(this,te),i=h(this,Q),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof kr)continue;throw c}this.match=o.match.bind(o),E(this,te,[o]),E(this,Q,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(h(this,Q)||h(this,te).length!==1)throw new Error("No active router has been determined yet.");return h(this,te)[0]}},te=new WeakMap,Q=new WeakMap,rr),Ae=Object.create(null),re,j,ce,Ee,D,W,ae,Te,Ms=(Te=class{constructor(r,s,i){k(this,W);k(this,re);k(this,j);k(this,ce);k(this,Ee,0);k(this,D,Ae);if(E(this,j,i||Object.create(null)),E(this,re,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},E(this,re,[a])}E(this,ce,[])}insert(r,s,i){E(this,Ee,++Dt(this,Ee)._);let a=this;const n=fs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],u=n[o+1],m=bs(d,u),f=Array.isArray(m)?m[0]:d;if(f in h(a,j)){a=h(a,j)[f],m&&l.push(m[1]);continue}h(a,j)[f]=new Te,m&&(h(a,ce).push(m),l.push(m[1])),a=h(a,j)[f]}return h(a,re).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:h(this,Ee)}}),a}search(r,s){var c;const i=[];E(this,D,Ae);let n=[this];const l=pr(s),o=[];for(let d=0,u=l.length;d<u;d++){const m=l[d],f=d===u-1,g=[];for(let b=0,v=n.length;b<v;b++){const x=n[b],w=h(x,j)[m];w&&(E(w,D,h(x,D)),f?(h(w,j)["*"]&&i.push(...A(this,W,ae).call(this,h(w,j)["*"],r,h(x,D))),i.push(...A(this,W,ae).call(this,w,r,h(x,D)))):g.push(w));for(let T=0,q=h(x,ce).length;T<q;T++){const _=h(x,ce)[T],C=h(x,D)===Ae?{}:{...h(x,D)};if(_==="*"){const Y=h(x,j)["*"];Y&&(i.push(...A(this,W,ae).call(this,Y,r,h(x,D))),E(Y,D,C),g.push(Y));continue}const[P,U,qe]=_;if(!m&&!(qe instanceof RegExp))continue;const z=h(x,j)[P],zr=l.slice(d).join("/");if(qe instanceof RegExp){const Y=qe.exec(zr);if(Y){if(C[U]=Y[0],i.push(...A(this,W,ae).call(this,z,r,h(x,D),C)),Object.keys(h(z,j)).length){E(z,D,C);const ot=((c=Y[0].match(/\//))==null?void 0:c.length)??0;(o[ot]||(o[ot]=[])).push(z)}continue}}(qe===!0||qe.test(m))&&(C[U]=m,f?(i.push(...A(this,W,ae).call(this,z,r,C,h(x,D))),h(z,j)["*"]&&i.push(...A(this,W,ae).call(this,h(z,j)["*"],r,C,h(x,D)))):(E(z,D,C),g.push(z)))}}n=g.concat(o.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},re=new WeakMap,j=new WeakMap,ce=new WeakMap,Ee=new WeakMap,D=new WeakMap,W=new WeakSet,ae=function(r,s,i,a){const n=[];for(let l=0,o=h(r,re).length;l<o;l++){const c=h(r,re)[l],d=c[s]||c[R],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==Ae||a&&a!==Ae))for(let m=0,f=d.possibleKeys.length;m<f;m++){const g=d.possibleKeys[m],b=u[d.score];d.params[g]=a!=null&&a[g]&&!b?a[g]:i[g]??(a==null?void 0:a[g]),u[d.score]=!0}}return n},Te),de,sr,Hs=(sr=class{constructor(){y(this,"name","TrieRouter");k(this,de);E(this,de,new Ms)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)h(this,de).insert(t,i[a],s);return}h(this,de).insert(t,r,s)}match(t,r){return h(this,de).search(t,r)}},de=new WeakMap,sr),Sr=class extends As{constructor(t={}){super(t),this.router=t.router??new Ls({routers:[new Is,new Hs]})}},Bs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Bt=(t,r=zs)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Us={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},zs=Us,$s=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Rr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??$s;return async(a,n)=>{var u,m,f,g;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Gs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const b=t.mimes&&Bt(o,t.mimes)||Bt(o);if(a.header("Content-Type",b||"application/octet-stream"),t.precompressed&&(!b||Bs.test(b))){const v=new Set((m=a.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(x=>x.trim()));for(const x of Vs){if(!v.has(x))continue;const w=await c(o+Rr[x],a);if(w){d=w,a.header("Content-Encoding",x),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((g=t.onNotFound)==null?void 0:g.call(t,o,a)),await n()}},Ws=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Xs=t=>async function(s,i){return Qs({...t,getContent:async n=>Ws(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Xs(t),je="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},Fe=[],wt=new WeakMap,_e=void 0,Ks=()=>_e,$=t=>"t"in t,ht={onClick:["click",!1]},Ut=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},zt=(t,r)=>_e&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=Ut(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),wt.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&hr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=zt(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=Ut(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute(zt(t,a))}}},ti=(t,r)=>{r[S][0]=0,Fe.push([t,r]);const s=r.tag[kt]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{Fe.pop()}},Nr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[S][1][Pr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if($(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Nr(o,r,s,i,a),o.s){for(let u=d;u<s.length;u++)s[u].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ri=t=>{for(;;t=t.tag===je||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==je&&t.e)return t.e}},Dr=t=>{var r,s,i,a,n,l;$(t)||((s=(r=t[S])==null?void 0:r[1][Pr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(Dr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Se.delete(t),et.delete(t),delete t[S][3],t.a=!0)},jr=(t,r,s)=>{t.c=r,Fr(t,r,s)},$t=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Vt=Symbol(),Fr=(t,r,s)=>{var d;const i=[],a=[],n=[];Nr(t,r,i,a,n),a.forEach(Dr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const u=$t(l,ri(t.nN));u!==void 0?(c=l[u],o=u):o=$t(l,(d=i.find(m=>m.tag!==je&&m.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let u=0,m=i.length;u<m;u++,o++){const f=i[u];let g;if(f.s&&f.e)g=f.e,f.s=!1;else{const b=s||!f.e;$(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,g=f.e||(f.e=document.createTextNode(f.t))):(g=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(g,f.props,f.pP),Fr(f,g,b))}f.tag===je?o--:s?g.parentNode||r.appendChild(g):l[o]!==g&&l[o-1]!==g&&(l[o+1]===g?r.appendChild(l[o]):r.insertBefore(g,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const u=[],m=[];n.forEach(([,f,,g,b])=>{f&&u.push(f),g&&m.push(g),b==null||b()}),u.forEach(f=>f()),m.length&&requestAnimationFrame(()=>{m.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,l,o,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):Be(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const m=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let g;for(let b=0;b<s.length;b++){Array.isArray(s[b])&&s.splice(b,1,...s[b].flat());let v=ii(s[b]);if(v){typeof v.tag=="function"&&!v.tag[lr]&&(ke.length>0&&(v[S][2]=ke.map(w=>[w,w.values.at(-1)])),(l=t[5])!=null&&l.length&&(v[S][3]=t[5].at(-1)));let x;if(m&&m.length){const w=m.findIndex($(v)?T=>$(T):v.key!==void 0?T=>T.key===v.key&&T.tag===v.tag:T=>T.tag===v.tag);w!==-1&&(x=m[w],m.splice(w,1))}if(x)if($(v))x.t!==v.t&&(x.t=v.t,x.d=!0),v=x;else{const w=x.pP=x.props;if(x.props=v.props,x.f||(x.f=v.f||r.f),typeof v.tag=="function"){const T=x[S][2];x[S][2]=v[S][2]||[],x[S][3]=v[S][3],!x.f&&((x.o||x)===v.o||(c=(o=x.tag)[Wr])!=null&&c.call(o,w,x.props))&&si(T,x[S][2])&&(x.s=!0)}v=x}else if(!$(v)&&_e){const w=Ce(_e);w&&(v.n=w)}if(!$(v)&&!v.s&&(Et(t,v),delete v.f),f.push(v),g&&!g.s&&!v.s)for(let w=g;w&&!$(w);w=(d=w.vC)==null?void 0:d.at(-1))w.nN=v;g=v}}r.vR=i?[...r.vC,...m||[]]:m||[],r.vC=f,i&&delete r.pC}catch(m){if(r.f=!0,m===Vt){if(a)return;throw m}const[f,g,b]=((u=r[S])==null?void 0:u[3])||[];if(g){const v=()=>tt([0,!1,t[2]],b),x=et.get(b)||[];x.push(v),et.set(b,x);const w=g(m,()=>{const T=et.get(b);if(T){const q=T.indexOf(v);if(q!==-1)return T.splice(q,1),v()}});if(w){if(t[0]===1)t[1]=!0;else if(Et(t,b,[w]),(g.length===1||t!==f)&&b.c){jr(b,b.c,!1);return}throw Vt}}throw m}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[S]=[0,[]];else{const r=Js[t.tag];r&&(_e||(_e=dr("")),t.props.children=[{tag:_e,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[S][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[S][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&jr(r,r.c,!1)},Se=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Se.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Se.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Se.get(r);n&&(Se.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:je,props:{children:t},key:s,e:r,p:1}),ft=0,Pr=1,pt=2,gt=3,bt=new WeakMap,Or=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Wt=[],oi=t=>{var l;const r=()=>typeof t=="function"?t():t,s=Fe.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[S][1])[ft]||(l[ft]=[]),n=i[S][0]++;return a[n]||(a[n]=[r(),o=>{const c=ni,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Wt.length){const[u,m]=Wt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),m]).then(([f])=>{if(!f||!(u===2||u===3))return;const g=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{g===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},St=(t,r)=>{var o;const s=Fe.at(-1);if(!s)return t;const[,i]=s,a=(o=i[S][1])[pt]||(o[pt]=[]),n=i[S][0]++,l=a[n];return Or(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},ci=(t,r)=>{var o;const s=Fe.at(-1);if(!s)return t();const[,i]=s,a=(o=i[S][1])[gt]||(o[gt]=[]),n=i[S][0]++,l=a[n];return Or(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},di=dr({pending:!1,data:null,method:null,action:null}),Xt=new Set,ui=t=>{Xt.add(t),t.finally(()=>Xt.delete(t))},Rt=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),he=Object.create(null),Qe=Object.create(null),$e=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...u}=r,m=null,f=!1;const g=We[t];let b;if(g.length>0){const T=n.querySelectorAll(t);e:for(const q of T)for(const _ of We[t])if(q.getAttribute(_)===r[_]){m=q;break e}if(!m){const q=g.reduce((_,C)=>r[C]===void 0?_:`${_}-${C}-${r[C]}`,t);f=!Qe[q],m=Qe[q]||(Qe[q]=(()=>{const _=document.createElement(t);for(const C of g)r[C]!==void 0&&_.setAttribute(C,r[C]),r.rel&&_.setAttribute("rel",r.rel);return _})())}}else b=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[Xe]=c);const v=St(T=>{if(g.length>0){let q=!1;for(const _ of n.querySelectorAll(t)){if(q&&_.getAttribute(Xe)!==c){n.insertBefore(T,_);return}_.getAttribute(Xe)===c&&(q=!0)}n.appendChild(T)}else if(b){let q=!1;for(const _ of b)if(_===T){q=!0;break}q||n.insertBefore(T,n.contains(b[0])?b[0]:n.querySelector(t)),b=void 0}},[c]),x=Rt(r.ref,T=>{var C;const q=g[0];if(s===2&&(T.innerHTML=""),(f||b)&&v(T),!o&&!l)return;let _=he[C=T.getAttribute(q)]||(he[C]=new Promise((P,U)=>{T.addEventListener("load",P),T.addEventListener("error",U)}));l&&(_=_.then(l)),o&&(_=_.catch(o)),_.catch(()=>{})});if(a&&d==="render"){const T=We[t][0];if(r[T]){const q=r[T],_=he[q]||(he[q]=new Promise((C,P)=>{v(m),m.addEventListener("load",C),m.addEventListener("error",P)}));li(_)}}const w={tag:t,type:t,props:{...u,ref:x},ref:x};return w.p=s,m&&(w.e=m),ai(w,n)},mi=t=>{const r=Ks(),s=r&&Ce(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:$e("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:$e("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,$e("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:$e("link",t,1,"precedence"in t,!0),gi=t=>$e("meta",t,void 0,!1,!1),Ir=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=St(async d=>{const u=d.isTrusted?r:d.detail[Ir];if(typeof u!="function")return;d.preventDefault();const m=new FormData(d.target);a([m,!0]);const f=u(m);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),l=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Lr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=St(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ir]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Lr("input",t),vi=t=>Lr("button",t);Object.assign(vt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});_t(null);new TextEncoder;var yi=_t(null),wi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Ot(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${I(l)}${Ot(yi.Provider,{value:t},o)}`;return t.html(c)},Mr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Mr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
    ...
    `).bind(n,i,s).run(),console.log(`✅ Quai ${s} passé en fin de contrôle - Timer figé à ${n}s - Contrôleur: ${i}`);try{console.log(`🔄 Début synchronisation KPI pour Quai ${s}`);const l=await t.env.DB.prepare(`
      ...
      `).bind(s).first();if(u)await t.env.DB.prepare(`
          ...
          SET duree_controle_secondes = ?,
              ...
              statut = 'traitee'
          WHERE id = ?
        `).bind(n,i,u.id).run(),console.log(`✅✅✅ ALERTE #${u.id} MISE À JOUR - Contrôle: ${n}s`);else{console.log(`🆕 Création nouvelle alerte - Quai: ${s}, ID: ${o}, Fournisseur: ${c}`);const m=await t.env.DB.prepare(`
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
...
</html>`));p.get("/chauffeur/consignes",t=>{const r=t.req.query("lang")||"fr";return t.redirect(`/consignes/${r}`)});p.get("/chauffeur/video",t=>t.redirect("/chauffeur/consignes?lang="+(t.req.query("lang")||"fr")));p.get("/chauffeur/inscription",t=>{const r=t.req.query("lang")||"fr";return t.html(Mi({lang:r}))});p.get("/chauffeur/taches",Ve,t=>t.render(e(Hi,{})));p.post("/api/chauffeur/inscription",async t=>{try{const{pseudo:r,entreprise:s,numero_quai:i,langue:a,video_completed:n}=await t.req.json(),l=await t.env.DB.prepare(`
    ...
    `).bind(r.quai_numero,r.nom_agent,r.palettes_attendues,r.palettes_recues,r.palettes_a_rendre,a,r.autres_commentaire||null,i).run();console.log("✅ Fin de déchargement enregistrée - ID:",n.meta.last_row_id);try{const o=await t.env.DB.prepare(`
      ...
      `).bind(`✅ Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id} - Timer: voir historique`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme disponible (fallback) - Timer conservé dans commentaire")}let l=!1;try{console.log("🔍 Vérification alerte - Données reçues:",{palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,problemes:r.problemes});const o=parseInt(r.palettes_attendues)!==parseInt(r.palettes_recues);console.log("📊 Écart palettes:",o,`(${r.palettes_attendues} vs ${r.palettes_recues})`);const c=r.problemes||[],d=c.length>0;console.log("⚠️ Non-conformités:",d,"Nombre:",c.length),console.log("📊 CRÉATION ALERTE KPI - Tous les camions sont enregistrés"),console.log("   Quai:",r.quai_numero),console.log("   ID:",r.numero_id),console.log("   Fournisseur:",r.fournisseur);{const u=new Date().toISOString().slice(0,19).replace("T"," ");console.log("⏰ Utilisation timer_start sauvegardé:",timerStartSauvegarde),console.log("⏰ timer_fin_timestamp (NOW):",u),await t.env.DB.prepare(`
        ...
        `).run(),console.log("✅ Table controleur_alertes vérifiée");let m="";o&&(m=`Écart palettes: Attendues ${r.palettes_attendues}, Reçues ${r.palettes_recues}`);const f=JSON.stringify(c);console.log("📝 Non-conformités (problèmes):",f);const g=JSON.stringify(r.verification_points||{});console.log("📝 Points de vérification:",g);const b=o||d?"en_attente":"traitee";console.log("📊 Statut alerte:",b,"(Problèmes:",o||d,")"),console.log("⏱️ Durée déchargement:",timerDuration,"secondes");const v=await t.env.DB.prepare(`
          INSERT INTO controleur_alertes (
    ...
    `).bind(r).all();return t.json({success:!0,improductivites:s})}catch(r){return console.error("❌ Erreur récupération improductivités utilisateur:",r),t.json({success:!0,improductivites:[]})}});p.get("/api/chef-equipe/kpi/reception-camion",async t=>{try{const s=t.req.query("date")||new Date().toISOString().split("T")[0];console.log("📊 Récupération KPI pour date:",s);const{results:i}=await t.env.DB.prepare(`
      ...
      LIMIT 100
    `).bind(s).all();console.log(`📊 ${i.length} camions trouvés pour ${s}`);const a=i.map(o=>{const c=o.heure_premier_scan?new Date(o.heure_premier_scan.replace(" ","T")):null,d=o.heure_fin_dechargement?new Date(o.heure_fin_dechargement.replace(" ","T")):null,u=o.traite_le?new Date(o.traite_le.replace(" ","T")):null;let m=null,f="grey",g="—";if(c&&d){const C=d.getTime()-c.getTime();m=Math.round(C/6e4);const P=Math.floor(m/60),U=m%60;g=`${String(P).padStart(2,"0")}:${String(U).padStart(2,"0")}:00`,m<=20?f="green":m<=25?f="orange":f="red"}let b=null,v="grey",x="—";if(d&&u){const C=u.getTime()-d.getTime();b=Math.round(C/6e4);const P=Math.floor(b/60),U=b%60;x=`${String(P).padStart(2,"0")}:${String(U).padStart(2,"0")}:00`,b<=30?v="green":b<=40?v="orange":v="red"}let w=null,T="grey",q="—";if(c&&u){const C=u.getTime()-c.getTime();w=Math.round(C/6e4);const P=Math.floor(w/60),U=w%60;q=`${String(P).padStart(2,"0")}:${String(U).padStart(2,"0")}:00`,w<=60?T="green":w<=70?T="orange":T="red"}const _=C=>{if(!C)return"—";const P=new Date(C.replace(" ","T"));return`${String(P.getHours()).padStart(2,"0")}:${String(P.getMinutes()).padStart(2,"0")}`};return{id:o.id,quai_numero:o.quai_numero,numero_camion:o.numero_id||`C${String(o.id).padStart(3,"0")}e`,fournisseur:o.fournisseur,heure_debut:_(o.heure_premier_scan),heure_fin:_(o.heure_fin_dechargement),heure_validation:_(o.traite_le),duree_dechargement:g,duree_dechargement_minutes:m,duree_dechargement_status:f,duree_controle:x,duree_controle_minutes:b,duree_controle_status:v,duree_totale:q,duree_totale_minutes:w,duree_totale_status:T}}),n=a.filter(o=>o.duree_dechargement_minutes!==null&&o.duree_controle_minutes!==null&&o.duree_totale_minutes!==null),l={dechargement_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_dechargement_minutes,0)/n.length):0,controle_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_controle_minutes,0)/n.length):0,total_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_totale_minutes,0)/n.length):0,total_camions:a.length,camions_complets:n.length};return t.json({success:!0,date:s,kpi:a,moyennes:l})}catch(r){return console.error("❌ Erreur récupération KPI:",r),t.json({success:!1,error:r.message},500)}});const Zt=new Sr,ea=Object.assign({"/src/index.tsx":p});let Ur=!1;for(const[,t]of Object.entries(ea))t&&(Zt.route("/",t),Zt.notFound(t.notFoundHandler),Ur=!0);if(!Ur)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Zt as default};
