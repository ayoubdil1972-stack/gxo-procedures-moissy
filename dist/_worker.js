...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `):t.html(`
    ...
    `).bind(s).first();let n=null;if(a!=null&&a.controle_debut_timestamp){const l=await t.env.DB.prepare(`
      ...
      `).bind(a.controle_debut_timestamp).first();n=l==null?void 0:l.duration,console.log(`⏱️ CONTRÔLE: debut=${a.controle_debut_timestamp}, Durée=${n}s (${Math.floor(n/60)}min ${n%60}s)`)}await t.env.DB.prepare(`
      UPDATE quai_status 
