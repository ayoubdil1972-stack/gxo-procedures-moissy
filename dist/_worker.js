var zr=Object.defineProperty;var Nt=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?zr(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var w=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Nt("Cannot "+s);var h=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),C=(t,r,s)=>r.has(t)?Nt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),T=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),S=(t,r,s)=>(lt(t,r,"access private method"),s);var Dt=(t,r,s,i)=>({set _(a){T(t,r,a,s)},get _(){return h(t,r,i)}});var ir={Stringify:1},O=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];re(n,o),s=o[0]}}return O(s,r)},re=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")re(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):re(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?O(nr(O(s[0],s.callbacks))):O(s[0]):ar(s,s.callbacks)},kt=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),A=Symbol("STASH"),lr=Symbol("INTERNAL"),Wr=Symbol("MEMO"),rt=Symbol("PERMALINK"),jt=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:jt(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:jt(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,Te.push(s),s},Te=[],_t=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>O(n,n.callbacks)):O(a)};return s.values=r,s.Provider=s,s[kt]=cr(r),Te.push(s),s},_e=t=>t.values.at(-1),We={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},Xe="data-precedence",He=t=>Array.isArray(t)?t:[t],Ft=new WeakMap,Pt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=Ft.get(n)||{};Ft.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=We[t];if(d.length>0){e:for(const[,u]of o)for(const m of d)if(((u==null?void 0:u[m])??null)===(s==null?void 0:s[m])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=o.map(([m])=>m);else{const m=[];u=o.map(([f,,b])=>{let g=m.indexOf(b);return g===-1&&(m.push(b),g=m.length-1),[f,g]}).sort((f,b)=>f[1]-b[1]).map(([f])=>f)}u.forEach(m=>{a[0]=a[0].replaceAll(m,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Be=(t,r,s)=>O(new B(t,s,He(r??[])).toString()),Ue=(t,r,s,i)=>{if("itemProp"in s)return Be(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[Xe]=a);const o=new B(t,l,He(r||[])).toString();return o instanceof Promise?o.then(c=>O(o,[...c.callbacks||[],Pt(t,c,l,a)])):O(o,[Pt(t,o,l,a)])},Xr=({children:t,...r})=>{const s=Ct();if(s){const i=_e(s);if(i==="svg"||i==="head")return new B("title",r,He(t??[]))}return Ue("title",t,r,!1)},Yr=({children:t,...r})=>{const s=Ct();return["src","async"].some(i=>!r[i])||s&&_e(s)==="head"?Be("script",t,r):Ue("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,Ue("style",t,r,!0)):Be("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Be("link",t,r):Ue("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=Ct();return s&&_e(s)==="head"?Be("meta",t,r):Ue("meta",t,r,!1)},ur=(t,{children:r,...s})=>new B(t,s,He(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),ts=t=>mr("input",t),rs=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Xr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Ne=void 0,Ct=()=>Ne,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],qt=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")re(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof B?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):qt(a,r)}}},B=class{constructor(t,r,s){w(this,"tag");w(this,"props");w(this,"key");w(this,"children");w(this,"isEscaped",!0);w(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(O(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=Ne&&_e(Ne)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";hr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',re(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,re(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&ns.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[O(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,re(l.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",qt(i,t),t[0]+=`</${r}>`}},dt=class extends B{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Te.length===0)t.unshift("",i);else{const a=Te.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof B&&(n.localContexts=a),n)))}else i instanceof B?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):re(i,t)}},fr=class extends B{toStringToBuffer(t){qt(this.children,t)}},Ot=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},It=!1,Ye=(t,r,s)=>{if(!It){for(const i in vt)ct[i][kt]=vt[i];It=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(Ne||(Ne=_t("")),new B(t,r,[new dt(Ne,{value:t},s)])):new B(t,r,s)},os=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Lt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,u;if(t[o]?(u=t[o][0][0],i.req.routeIndex=o):u=o===t.length&&a||void 0,u)try{c=await u(i,()=>l(o+1))}catch(m){if(m instanceof Error&&r)i.error=m,c=await r(m,i),d=!0;else throw m}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},pr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=pr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},St=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>St(t,decodeURI),gr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return xs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=gr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},he=(t,r,...s)=>(s.length&&(r=he(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?St(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=ut(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=xr,ws=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,Mt=t=>St(t,vr),ge,P,W,wr,Er,yt,Y,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){C(this,W);w(this,"raw");C(this,ge);C(this,P);w(this,"routeIndex",0);w(this,"path");w(this,"bodyCache",{});C(this,Y,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,T(this,P,s),T(this,ge,{})}param(t){return t?S(this,W,wr).call(this,t):S(this,W,Er).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return h(this,Y).call(this,"text").then(t=>JSON.parse(t))}text(){return h(this,Y).call(this,"text")}arrayBuffer(){return h(this,Y).call(this,"arrayBuffer")}blob(){return h(this,Y).call(this,"blob")}formData(){return h(this,Y).call(this,"formData")}addValidatedData(t,r){h(this,ge)[t]=r}valid(t){return h(this,ge)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return h(this,P)}get matchedRoutes(){return h(this,P)[0].map(([[,t]])=>t)}get routePath(){return h(this,P)[0].map(([[,t]])=>t)[this.routeIndex].path}},ge=new WeakMap,P=new WeakMap,W=new WeakSet,wr=function(t){const r=h(this,P)[0][this.routeIndex][1][t],s=S(this,W,yt).call(this,r);return s&&/\%/.test(s)?Mt(s):s},Er=function(){const t={},r=Object.keys(h(this,P)[0][this.routeIndex][1]);for(const s of r){const i=S(this,W,yt).call(this,h(this,P)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Mt(i):i)}return t},yt=function(t){return h(this,P)[1]?h(this,P)[1][t]:t},Y=new WeakMap,Jt),Es="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),Fe,Pe,z,be,V,F,Oe,xe,ve,ae,Ie,Le,Z,fe,Kt,Ts=(Kt=class{constructor(t,r){C(this,Z);C(this,Fe);C(this,Pe);w(this,"env",{});C(this,z);w(this,"finalized",!1);w(this,"error");C(this,be);C(this,V);C(this,F);C(this,Oe);C(this,xe);C(this,ve);C(this,ae);C(this,Ie);C(this,Le);w(this,"render",(...t)=>(h(this,xe)??T(this,xe,r=>this.html(r)),h(this,xe).call(this,...t)));w(this,"setLayout",t=>T(this,Oe,t));w(this,"getLayout",()=>h(this,Oe));w(this,"setRenderer",t=>{T(this,xe,t)});w(this,"header",(t,r,s)=>{this.finalized&&T(this,F,new Response(h(this,F).body,h(this,F)));const i=h(this,F)?h(this,F).headers:h(this,ae)??T(this,ae,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});w(this,"status",t=>{T(this,be,t)});w(this,"set",(t,r)=>{h(this,z)??T(this,z,new Map),h(this,z).set(t,r)});w(this,"get",t=>h(this,z)?h(this,z).get(t):void 0);w(this,"newResponse",(...t)=>S(this,Z,fe).call(this,...t));w(this,"body",(t,r,s)=>S(this,Z,fe).call(this,t,r,s));w(this,"text",(t,r,s)=>!h(this,ae)&&!h(this,be)&&!r&&!s&&!this.finalized?new Response(t):S(this,Z,fe).call(this,t,r,mt(Es,s)));w(this,"json",(t,r,s)=>S(this,Z,fe).call(this,JSON.stringify(t),r,mt("application/json",s)));w(this,"html",(t,r,s)=>{const i=a=>S(this,Z,fe).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});w(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});w(this,"notFound",()=>(h(this,ve)??T(this,ve,()=>new Response),h(this,ve).call(this,this)));T(this,Fe,t),r&&(T(this,V,r.executionCtx),this.env=r.env,T(this,ve,r.notFoundHandler),T(this,Le,r.path),T(this,Ie,r.matchResult))}get req(){return h(this,Pe)??T(this,Pe,new yr(h(this,Fe),h(this,Le),h(this,Ie))),h(this,Pe)}get event(){if(h(this,V)&&"respondWith"in h(this,V))return h(this,V);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,V))return h(this,V);throw Error("This context has no ExecutionContext")}get res(){return h(this,F)||T(this,F,new Response(null,{headers:h(this,ae)??T(this,ae,new Headers)}))}set res(t){if(h(this,F)&&t){t=new Response(t.body,t);for(const[r,s]of h(this,F).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=h(this,F).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}T(this,F,t),this.finalized=!0}get var(){return h(this,z)?Object.fromEntries(h(this,z)):{}}},Fe=new WeakMap,Pe=new WeakMap,z=new WeakMap,be=new WeakMap,V=new WeakMap,F=new WeakMap,Oe=new WeakMap,xe=new WeakMap,ve=new WeakMap,ae=new WeakMap,Ie=new WeakMap,Le=new WeakMap,Z=new WeakSet,fe=function(t,r,s){const i=h(this,F)?new Headers(h(this,F).headers):h(this,ae)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??h(this,be);return new Response(t,{status:a,headers:i})},Kt),R="ALL",ks="all",_s=["get","post","put","delete","options","patch"],Tr="Can not add a route since the matcher is already built.",kr=class extends Error{},Cs="__COMPOSED_HANDLER",qs=t=>t.text("404 Not Found",404),Ht=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},L,N,_r,M,se,Ze,Je,ye,Ss=(ye=class{constructor(r={}){C(this,N);w(this,"get");w(this,"post");w(this,"put");w(this,"delete");w(this,"options");w(this,"patch");w(this,"all");w(this,"on");w(this,"use");w(this,"router");w(this,"getPath");w(this,"_basePath","/");C(this,L,"/");w(this,"routes",[]);C(this,M,qs);w(this,"errorHandler",Ht);w(this,"onError",r=>(this.errorHandler=r,this));w(this,"notFound",r=>(T(this,M,r),this));w(this,"fetch",(r,...s)=>S(this,N,Je).call(this,r,s[1],s[0],r.method));w(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${he("/",r)}`,s),i,a)));w(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(S(this,N,Je).call(this,r.request,r,void 0,r.request.method))})});[..._s,ks].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?T(this,L,l):S(this,N,se).call(this,n,h(this,L),l),o.forEach(c=>{S(this,N,se).call(this,n,h(this,L),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){T(this,L,c);for(const d of[n].flat())o.map(u=>{S(this,N,se).call(this,d.toUpperCase(),h(this,L),u)})}return this},this.use=(n,...l)=>(typeof n=="string"?T(this,L,n):(T(this,L,"*"),l.unshift(n)),l.forEach(o=>{S(this,N,se).call(this,R,h(this,L),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??gr:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===Ht?n=a.handler:(n=async(o,c)=>(await Lt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[Cs]=a.handler),S(l=i,N,se).call(l,a.method,a.path,n)}),this}basePath(r){const s=S(this,N,_r).call(this);return s._basePath=he(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=he(this._basePath,r),d=c==="/"?0:c.length;return u=>{const m=new URL(u.url);return m.pathname=m.pathname.slice(d)||"/",new Request(m,u)}})());const o=async(c,d)=>{const u=await s(a(c.req.raw),...l(c));if(u)return u;await d()};return S(this,N,se).call(this,R,he(r,"*"),o),this}},L=new WeakMap,N=new WeakSet,_r=function(){const r=new ye({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,T(r,M,h(this,M)),r.routes=this.routes,r},M=new WeakMap,se=function(r,s,i){r=r.toUpperCase(),s=he(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await S(this,N,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new Ts(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:h(this,M)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await h(this,M).call(this,o)})}catch(u){return S(this,N,Ze).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:h(this,M).call(this,o))).catch(u=>S(this,N,Ze).call(this,u,o)):d??h(this,M).call(this,o)}const c=Lt(l[0],this.errorHandler,h(this,M));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return S(this,N,Ze).call(this,d,o)}})()},ye),Cr=[];function As(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[R],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],Cr];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Ae=".*",Re="(?:|/.*)",pe=Symbol(),Rs=new Set(".\\+*[^]$()");function Ns(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Ae||t===Re?1:r===Ae||r===Re?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ne,oe,H,de,Ds=(de=class{constructor(){C(this,ne);C(this,oe);C(this,H,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(h(this,ne)!==void 0)throw pe;if(n)return;T(this,ne,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",Ae]:["","",it]:l==="/*"?["","",Re]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let m=c[2]||it;if(u&&c[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw pe;if(d=h(this,H)[m],!d){if(Object.keys(h(this,H)).some(f=>f!==Ae&&f!==Re))throw pe;if(n)return;d=h(this,H)[m]=new de,u!==""&&T(d,oe,a.varIndex++)}!n&&u!==""&&i.push([u,h(d,oe)])}else if(d=h(this,H)[l],!d){if(Object.keys(h(this,H)).some(u=>u.length>1&&u!==Ae&&u!==Re))throw pe;if(n)return;d=h(this,H)[l]=new de}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(h(this,H)).sort(Ns).map(i=>{const a=h(this,H)[i];return(typeof h(a,oe)=="number"?`(${i})@${h(a,oe)}`:Rs.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof h(this,ne)=="number"&&s.unshift(`#${h(this,ne)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ne=new WeakMap,oe=new WeakMap,H=new WeakMap,de),at,Me,er,js=(er=class{constructor(){C(this,at,{varIndex:0});C(this,Me,new Ds)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return h(this,Me).insert(n,r,i,h(this,at),s),i}buildRegExp(){let t=h(this,Me).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,Me=new WeakMap,er),Fs=[/^$/,[],Object.create(null)],Ke=Object.create(null);function qr(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ps(){Ke=Object.create(null)}function Os(t){var d;const r=new js,s=[];if(t.length===0)return Fs;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,m],[f,b])=>u?1:f?-1:m.length-b.length),a=Object.create(null);for(let u=0,m=-1,f=i.length;u<f;u++){const[b,g,v]=i[u];b?a[g]=[v.map(([E])=>[E,Object.create(null)]),Cr]:m++;let x;try{x=r.insert(g,m,b)}catch(E){throw E===pe?new kr(g):E}b||(s[m]=v.map(([E,y])=>{const _=Object.create(null);for(y-=1;y>=0;y--){const[k,q]=x[y];_[k]=q}return[E,_]}))}const[n,l,o]=r.buildRegExp();for(let u=0,m=s.length;u<m;u++)for(let f=0,b=s[u].length;f<b;f++){const g=(d=s[u][f])==null?void 0:d[1];if(!g)continue;const v=Object.keys(g);for(let x=0,E=v.length;x<E;x++)g[v[x]]=o[g[v[x]]]}const c=[];for(const u in l)c[u]=s[l[u]];return[n,c,a]}function ue(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(qr(s).test(r))return[...t[s]]}}var J,K,nt,Sr,tr,Is=(tr=class{constructor(){C(this,nt);w(this,"name","RegExpRouter");C(this,J);C(this,K);w(this,"match",As);T(this,J,{[R]:Object.create(null)}),T(this,K,{[R]:Object.create(null)})}add(t,r,s){var o;const i=h(this,J),a=h(this,K);if(!i||!a)throw new Error(Tr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[t][d]=[...c[R][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=qr(r);t===R?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=ue(i[d],r)||ue(i[R],r)||[])}):(o=i[t])[r]||(o[r]=ue(i[t],r)||ue(i[R],r)||[]),Object.keys(i).forEach(d=>{(t===R||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===R||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const l=br(r)||[r];for(let c=0,d=l.length;c<d;c++){const u=l[c];Object.keys(a).forEach(m=>{var f;(t===R||t===m)&&((f=a[m])[u]||(f[u]=[...ue(i[m],u)||ue(i[R],u)||[]]),a[m][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(h(this,K)).concat(Object.keys(h(this,J))).forEach(r=>{t[r]||(t[r]=S(this,nt,Sr).call(this,r))}),T(this,J,T(this,K,void 0)),Ps(),t}},J=new WeakMap,K=new WeakMap,nt=new WeakSet,Sr=function(t){const r=[];let s=t===R;return[h(this,J),h(this,K)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==R&&r.push(...Object.keys(i[R]).map(n=>[n,i[R][n]]))}),s?Os(r):null},tr),ee,G,rr,Ls=(rr=class{constructor(t){w(this,"name","SmartRouter");C(this,ee,[]);C(this,G,[]);T(this,ee,t.routers)}add(t,r,s){if(!h(this,G))throw new Error(Tr);h(this,G).push([t,r,s])}match(t,r){if(!h(this,G))throw new Error("Fatal error");const s=h(this,ee),i=h(this,G),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof kr)continue;throw c}this.match=o.match.bind(o),T(this,ee,[o]),T(this,G,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(h(this,G)||h(this,ee).length!==1)throw new Error("No active router has been determined yet.");return h(this,ee)[0]}},ee=new WeakMap,G=new WeakMap,rr),qe=Object.create(null),te,j,le,we,D,Q,ie,Ee,Ms=(Ee=class{constructor(r,s,i){C(this,Q);C(this,te);C(this,j);C(this,le);C(this,we,0);C(this,D,qe);if(T(this,j,i||Object.create(null)),T(this,te,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},T(this,te,[a])}T(this,le,[])}insert(r,s,i){T(this,we,++Dt(this,we)._);let a=this;const n=fs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],u=n[o+1],m=bs(d,u),f=Array.isArray(m)?m[0]:d;if(f in h(a,j)){a=h(a,j)[f],m&&l.push(m[1]);continue}h(a,j)[f]=new Ee,m&&(h(a,le).push(m),l.push(m[1])),a=h(a,j)[f]}return h(a,te).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:h(this,we)}}),a}search(r,s){var c;const i=[];T(this,D,qe);let n=[this];const l=pr(s),o=[];for(let d=0,u=l.length;d<u;d++){const m=l[d],f=d===u-1,b=[];for(let g=0,v=n.length;g<v;g++){const x=n[g],E=h(x,j)[m];E&&(T(E,D,h(x,D)),f?(h(E,j)["*"]&&i.push(...S(this,Q,ie).call(this,h(E,j)["*"],r,h(x,D))),i.push(...S(this,Q,ie).call(this,E,r,h(x,D)))):b.push(E));for(let y=0,_=h(x,le).length;y<_;y++){const k=h(x,le)[y],q=h(x,D)===qe?{}:{...h(x,D)};if(k==="*"){const X=h(x,j)["*"];X&&(i.push(...S(this,Q,ie).call(this,X,r,h(x,D))),T(X,D,q),b.push(X));continue}const[I,Ve,Ce]=k;if(!m&&!(Ce instanceof RegExp))continue;const U=h(x,j)[I],$r=l.slice(d).join("/");if(Ce instanceof RegExp){const X=Ce.exec($r);if(X){if(q[Ve]=X[0],i.push(...S(this,Q,ie).call(this,U,r,h(x,D),q)),Object.keys(h(U,j)).length){T(U,D,q);const ot=((c=X[0].match(/\//))==null?void 0:c.length)??0;(o[ot]||(o[ot]=[])).push(U)}continue}}(Ce===!0||Ce.test(m))&&(q[Ve]=m,f?(i.push(...S(this,Q,ie).call(this,U,r,q,h(x,D))),h(U,j)["*"]&&i.push(...S(this,Q,ie).call(this,h(U,j)["*"],r,q,h(x,D)))):(T(U,D,q),b.push(U)))}}n=b.concat(o.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},te=new WeakMap,j=new WeakMap,le=new WeakMap,we=new WeakMap,D=new WeakMap,Q=new WeakSet,ie=function(r,s,i,a){const n=[];for(let l=0,o=h(r,te).length;l<o;l++){const c=h(r,te)[l],d=c[s]||c[R],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==qe||a&&a!==qe))for(let m=0,f=d.possibleKeys.length;m<f;m++){const b=d.possibleKeys[m],g=u[d.score];d.params[b]=a!=null&&a[b]&&!g?a[b]:i[b]??(a==null?void 0:a[b]),u[d.score]=!0}}return n},Ee),ce,sr,Hs=(sr=class{constructor(){w(this,"name","TrieRouter");C(this,ce);T(this,ce,new Ms)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)h(this,ce).insert(t,i[a],s);return}h(this,ce).insert(t,r,s)}match(t,r){return h(this,ce).search(t,r)}},ce=new WeakMap,sr),Ar=class extends Ss{constructor(t={}){super(t),this.router=t.router??new Ls({routers:[new Is,new Hs]})}},Bs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Bt=(t,r=$s)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Us={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},$s=Us,zs=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Rr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??zs;return async(a,n)=>{var u,m,f,b;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Gs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const g=t.mimes&&Bt(o,t.mimes)||Bt(o);if(a.header("Content-Type",g||"application/octet-stream"),t.precompressed&&(!g||Bs.test(g))){const v=new Set((m=a.req.header("Accept-Encoding"))==null?void 0:m.split(",").map(x=>x.trim()));for(const x of Vs){if(!v.has(x))continue;const E=await c(o+Rr[x],a);if(E){d=E,a.header("Content-Encoding",x),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((b=t.onNotFound)==null?void 0:b.call(t,o,a)),await n()}},Ws=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Xs=t=>async function(s,i){return Qs({...t,getContent:async n=>Ws(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Xs(t),De="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},je=[],wt=new WeakMap,ke=void 0,Ks=()=>ke,$=t=>"t"in t,ht={onClick:["click",!1]},Ut=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},$t=(t,r)=>ke&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=Ut(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),wt.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&hr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=$t(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=Ut(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute($t(t,a))}}},ti=(t,r)=>{r[A][0]=0,je.push([t,r]);const s=r.tag[kt]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{je.pop()}},Nr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[A][1][Pr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if($(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Nr(o,r,s,i,a),o.s){for(let u=d;u<s.length;u++)s[u].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ri=t=>{for(;;t=t.tag===De||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==De&&t.e)return t.e}},Dr=t=>{var r,s,i,a,n,l;$(t)||((s=(r=t[A])==null?void 0:r[1][Pr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(Dr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Se.delete(t),et.delete(t),delete t[A][3],t.a=!0)},jr=(t,r,s)=>{t.c=r,Fr(t,r,s)},zt=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Vt=Symbol(),Fr=(t,r,s)=>{var d;const i=[],a=[],n=[];Nr(t,r,i,a,n),a.forEach(Dr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const u=zt(l,ri(t.nN));u!==void 0?(c=l[u],o=u):o=zt(l,(d=i.find(m=>m.tag!==De&&m.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let u=0,m=i.length;u<m;u++,o++){const f=i[u];let b;if(f.s&&f.e)b=f.e,f.s=!1;else{const g=s||!f.e;$(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,b=f.e||(f.e=document.createTextNode(f.t))):(b=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(b,f.props,f.pP),Fr(f,b,g))}f.tag===De?o--:s?b.parentNode||r.appendChild(b):l[o]!==b&&l[o-1]!==b&&(l[o+1]===b?r.appendChild(l[o]):r.insertBefore(b,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const u=[],m=[];n.forEach(([,f,,b,g])=>{f&&u.push(f),b&&m.push(b),g==null||g()}),u.forEach(f=>f()),m.length&&requestAnimationFrame(()=>{m.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,l,o,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):He(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const m=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let b;for(let g=0;g<s.length;g++){Array.isArray(s[g])&&s.splice(g,1,...s[g].flat());let v=ii(s[g]);if(v){typeof v.tag=="function"&&!v.tag[lr]&&(Te.length>0&&(v[A][2]=Te.map(E=>[E,E.values.at(-1)])),(l=t[5])!=null&&l.length&&(v[A][3]=t[5].at(-1)));let x;if(m&&m.length){const E=m.findIndex($(v)?y=>$(y):v.key!==void 0?y=>y.key===v.key&&y.tag===v.tag:y=>y.tag===v.tag);E!==-1&&(x=m[E],m.splice(E,1))}if(x)if($(v))x.t!==v.t&&(x.t=v.t,x.d=!0),v=x;else{const E=x.pP=x.props;if(x.props=v.props,x.f||(x.f=v.f||r.f),typeof v.tag=="function"){const y=x[A][2];x[A][2]=v[A][2]||[],x[A][3]=v[A][3],!x.f&&((x.o||x)===v.o||(c=(o=x.tag)[Wr])!=null&&c.call(o,E,x.props))&&si(y,x[A][2])&&(x.s=!0)}v=x}else if(!$(v)&&ke){const E=_e(ke);E&&(v.n=E)}if(!$(v)&&!v.s&&(Et(t,v),delete v.f),f.push(v),b&&!b.s&&!v.s)for(let E=b;E&&!$(E);E=(d=E.vC)==null?void 0:d.at(-1))E.nN=v;b=v}}r.vR=i?[...r.vC,...m||[]]:m||[],r.vC=f,i&&delete r.pC}catch(m){if(r.f=!0,m===Vt){if(a)return;throw m}const[f,b,g]=((u=r[A])==null?void 0:u[3])||[];if(b){const v=()=>tt([0,!1,t[2]],g),x=et.get(g)||[];x.push(v),et.set(g,x);const E=b(m,()=>{const y=et.get(g);if(y){const _=y.indexOf(v);if(_!==-1)return y.splice(_,1),v()}});if(E){if(t[0]===1)t[1]=!0;else if(Et(t,g,[E]),(b.length===1||t!==f)&&g.c){jr(g,g.c,!1);return}throw Vt}}throw m}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[A]=[0,[]];else{const r=Js[t.tag];r&&(ke||(ke=dr("")),t.props.children=[{tag:ke,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[A][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[A][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&jr(r,r.c,!1)},Se=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Se.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Se.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Se.get(r);n&&(Se.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:De,props:{children:t},key:s,e:r,p:1}),ft=0,Pr=1,pt=2,gt=3,bt=new WeakMap,Or=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Wt=[],oi=t=>{var l;const r=()=>typeof t=="function"?t():t,s=je.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[A][1])[ft]||(l[ft]=[]),n=i[A][0]++;return a[n]||(a[n]=[r(),o=>{const c=ni,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Wt.length){const[u,m]=Wt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),m]).then(([f])=>{if(!f||!(u===2||u===3))return;const b=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{b===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},At=(t,r)=>{var o;const s=je.at(-1);if(!s)return t;const[,i]=s,a=(o=i[A][1])[pt]||(o[pt]=[]),n=i[A][0]++,l=a[n];return Or(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},ci=(t,r)=>{var o;const s=je.at(-1);if(!s)return t();const[,i]=s,a=(o=i[A][1])[gt]||(o[gt]=[]),n=i[A][0]++,l=a[n];return Or(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},di=dr({pending:!1,data:null,method:null,action:null}),Xt=new Set,ui=t=>{Xt.add(t),t.finally(()=>Xt.delete(t))},Rt=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),me=Object.create(null),Qe=Object.create(null),$e=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...u}=r,m=null,f=!1;const b=We[t];let g;if(b.length>0){const y=n.querySelectorAll(t);e:for(const _ of y)for(const k of We[t])if(_.getAttribute(k)===r[k]){m=_;break e}if(!m){const _=b.reduce((k,q)=>r[q]===void 0?k:`${k}-${q}-${r[q]}`,t);f=!Qe[_],m=Qe[_]||(Qe[_]=(()=>{const k=document.createElement(t);for(const q of b)r[q]!==void 0&&k.setAttribute(q,r[q]),r.rel&&k.setAttribute("rel",r.rel);return k})())}}else g=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[Xe]=c);const v=At(y=>{if(b.length>0){let _=!1;for(const k of n.querySelectorAll(t)){if(_&&k.getAttribute(Xe)!==c){n.insertBefore(y,k);return}k.getAttribute(Xe)===c&&(_=!0)}n.appendChild(y)}else if(g){let _=!1;for(const k of g)if(k===y){_=!0;break}_||n.insertBefore(y,n.contains(g[0])?g[0]:n.querySelector(t)),g=void 0}},[c]),x=Rt(r.ref,y=>{var q;const _=b[0];if(s===2&&(y.innerHTML=""),(f||g)&&v(y),!o&&!l)return;let k=me[q=y.getAttribute(_)]||(me[q]=new Promise((I,Ve)=>{y.addEventListener("load",I),y.addEventListener("error",Ve)}));l&&(k=k.then(l)),o&&(k=k.catch(o)),k.catch(()=>{})});if(a&&d==="render"){const y=We[t][0];if(r[y]){const _=r[y],k=me[_]||(me[_]=new Promise((q,I)=>{v(m),m.addEventListener("load",q),m.addEventListener("error",I)}));li(k)}}const E={tag:t,type:t,props:{...u,ref:x},ref:x};return E.p=s,m&&(E.e=m),ai(E,n)},mi=t=>{const r=Ks(),s=r&&_e(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:$e("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:$e("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,$e("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:$e("link",t,1,"precedence"in t,!0),gi=t=>$e("meta",t,void 0,!1,!1),Ir=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=At(async d=>{const u=d.isTrusted?r:d.detail[Ir];if(typeof u!="function")return;d.preventDefault();const m=new FormData(d.target);a([m,!0]);const f=u(m);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),l=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Lr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=At(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ir]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Lr("input",t),vi=t=>Lr("button",t);Object.assign(vt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});_t(null);new TextEncoder;var yi=_t(null),wi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Ot(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${O(l)}${Ot(yi.Provider,{value:t},o)}`;return t.html(c)},Mr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Mr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Vi(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:l}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const p=new Ar;function Hr(){const t=new Date;return new Date(t.toLocaleString("en-US",{timeZone:"Europe/Paris"})).toISOString()}p.use("/static/*",Ys({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));p.get("/login",ze,t=>t.render(e(Pi,{})));p.get("/qrcode-chauffeur",ze,t=>t.render(e(Oi,{})));p.get("/chauffeur/langue",ze,t=>t.render(e(Ii,{})));p.get("/gestion-quais",ze,t=>t.render(e(Ui,{})));p.get("/pdf-barcodes",t=>t.html($i()));p.get("/qrcode-generator",t=>t.html(zi()));p.get("/scan-dechargement",t=>{const r=t.req.query("quai");return t.redirect(`/scan?quai=${r}`)});p.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
  ...
  `):t.html(`
    ...
    `).bind(s).first();let n=null;if(a!=null&&a.timer_controle_start){const l=new Date(a.timer_controle_start.replace(" ","T")).getTime(),o=new Date(Hr()).getTime();n=Math.floor((o-l)/1e3),console.log(`⏱️ Durée contrôle calculée: ${n}s`)}await t.env.DB.prepare(`
      ...
      SET statut = 'fin_controle',
          ...
          updated_at = datetime('now', 'localtime')
      WHERE quai_numero = ?
    `).bind(n,i,s).run(),console.log(`✅ Quai ${s} passé en fin de contrôle - Timer figé à ${n}s - Contrôleur: ${i}`);try{console.log(`🔄 Début synchronisation KPI pour Quai ${s}`);const l=await t.env.DB.prepare(`
        SELECT *
        FROM quai_status
        WHERE quai_numero = ?
      `).bind(s).first();console.log("📊 Données quai_status:",JSON.stringify(l));let o=(a==null?void 0:a.controle_id_chauffeur)||"INCONNU",c=(a==null?void 0:a.controle_fournisseur)||"INCONNU";if(l!=null&&l.commentaire&&l.commentaire.includes("ID:")){const m=l.commentaire.split(" - ");console.log("📝 Commentaire parts:",m),m.length>=3&&(c=m[2].trim(),console.log(`✅ Fournisseur extrait: ${c}`));const f=l.commentaire.match(/ID:(\w+)/);f&&(o=f[1],console.log(`✅ Numero ID extrait: ${o}`))}let d=null;if(l!=null&&l.timer_fin_timestamp&&(l!=null&&l.timer_duration)){const m=await t.env.DB.prepare(`
          SELECT datetime(?, '-' || ? || ' seconds') as result
        `).bind(l.timer_fin_timestamp,l.timer_duration).first();d=m==null?void 0:m.result,console.log(`⏱️ Heure premier scan calculée: ${d}`)}const u=await t.env.DB.prepare(`
      ...
      `).bind(s).first();if(u)await t.env.DB.prepare(`
          ...
          SET duree_controle_secondes = ?,
              ...
              statut = 'traitee'
          WHERE id = ?
        `).bind(n,i,u.id).run(),console.log(`✅✅✅ ALERTE #${u.id} MISE À JOUR - Quai ${s} - Contrôle: ${n}s`),console.log(`📊 Détails: ${u.fournisseur} (${u.numero_id}) - Déch: ${u.duree_dechargement_secondes}s + Ctrl: ${n}s`);else{console.log(`🆕 Création nouvelle alerte - Quai: ${s}, ID: ${o}, Fournisseur: ${c}`);const m=await t.env.DB.prepare(`
        ...
        `).bind(s,o,c,d,l==null?void 0:l.timer_fin_timestamp,(l==null?void 0:l.timer_duration)||0,n,i).run();console.log(`✅✅✅ NOUVELLE ALERTE KPI CRÉÉE - ID: ${m.meta.last_row_id}`),console.log(`📊 Détails: Quai ${s}, ${c}, Déch: ${l==null?void 0:l.timer_duration}s, Ctrl: ${n}s`)}}catch(l){console.error("❌❌❌ ERREUR SYNC KPI:",l),console.error("❌ Message:",l.message),console.error("❌ Stack:",l.stack)}return t.json({success:!0,quai:s,dureeControle:n,controleurNom:i,fournisseur:(a==null?void 0:a.controle_fournisseur)||"",idChauffeur:(a==null?void 0:a.controle_id_chauffeur)||"",debutTimestamp:(a==null?void 0:a.controle_debut_timestamp)||""})}catch(r){return console.error("❌ Erreur fin contrôle:",r),t.json({error:"Erreur serveur"},500)}});p.get("/scan-fin-controle-success",t=>{const r=t.req.query("quai"),s=parseInt(t.req.query("duree")||"0"),i=t.req.query("nom")||"",a=t.req.query("fournisseur")||"",n=t.req.query("id")||"",l=t.req.query("debut")||"",o=Math.floor(s/3600),c=Math.floor(s%3600/60),d=s%60;`${String(o).padStart(2,"0")}${String(c).padStart(2,"0")}${String(d).padStart(2,"0")}`;let u="";if(l)try{const m=new Date(l.replace(" ","T")+"Z"),f=String(m.getDate()).padStart(2,"0"),b=String(m.getMonth()+1).padStart(2,"0"),g=m.getFullYear(),v=String(m.getHours()).padStart(2,"0"),x=String(m.getMinutes()).padStart(2,"0");u=`${f}/${b}/${g} à ${v}h${x}`}catch{u=l}return t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
    ...
    `).bind(r).all();console.log(`📊 [CHAT GET] Nombre de messages: ${n.length}`);const l=n.map(o=>{var d,u,m,f;const c={...o,message:o.message,translated_fr:o.translated_fr||o.message,translated_chauffeur:o.translated_chauffeur||o.message,original_lang:o.original_lang||"fr"};return o.id===((d=n[0])==null?void 0:d.id)&&console.log(`📝 [CHAT GET] Premier message - message: "${(u=o.message)==null?void 0:u.substring(0,30)}...", translated_fr: "${(m=o.translated_fr)==null?void 0:m.substring(0,30)}...", translated_chauffeur: "${(f=o.translated_chauffeur)==null?void 0:f.substring(0,30)}..."`),c});return t.json({success:!0,messages:l,chauffeur_langue:a})}catch(r){return console.error("Erreur récupération messages:",r),t.json({success:!1,error:r.message},500)}});p.post("/api/chat/heartbeat",async t=>{try{const{chauffeur_id:r,page_url:s}=await t.req.json();try{await t.env.DB.prepare(`
    ...
    `).bind(r.quai_numero,r.nom_agent,r.palettes_attendues,r.palettes_recues,r.palettes_a_rendre,a,r.autres_commentaire||null,i).run();console.log("✅ Fin de déchargement enregistrée - ID:",n.meta.last_row_id);try{const o=await t.env.DB.prepare(`
      ...
      `).bind(r.quai_numero).first();console.log("📊 Quai data AVANT UPDATE:",o);const c=o==null?void 0:o.timer_start;let d=null;if(o!=null&&o.timer_start){const u=new Date(o.timer_start.replace(" ","T")).getTime(),m=new Date(Hr()).getTime();d=Math.floor((m-u)/1e3),console.log(`⏱️ Durée calculée: ${d}s (${Math.floor(d/3600)}h ${Math.floor(d%3600/60)}m ${d%60}s)`)}console.log("💾 UPDATE avec:",{timerDuration:d,commentaire:`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,commentaire_auteur:r.nom_agent,quai_numero:r.quai_numero}),await t.env.DB.prepare(`
        UPDATE quai_status 
        SET statut = 'fin_dechargement',
            ...
            updated_at = datetime('now', 'localtime')
        WHERE quai_numero = ?
      `).bind(d,`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme fin de déchargement - Timer figé à",d,"secondes (timer_start supprimé)")}catch(o){console.warn("⚠️ Contrainte CHECK - Fallback vers disponible:",o.message),await t.env.DB.prepare(`
        UPDATE quai_status 
      ...
      `).bind(`✅ Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id} - Timer: voir historique`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme disponible (fallback) - Timer conservé dans commentaire")}let l=!1;try{console.log("🔍 Vérification alerte - Données reçues:",{palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,problemes:r.problemes});const o=parseInt(r.palettes_attendues)!==parseInt(r.palettes_recues);console.log("📊 Écart palettes:",o,`(${r.palettes_attendues} vs ${r.palettes_recues})`);const c=r.problemes||[],d=c.length>0;console.log("⚠️ Non-conformités:",d,"Nombre:",c.length),console.log("📊 CRÉATION ALERTE KPI - Tous les camions sont enregistrés"),console.log("   Quai:",r.quai_numero),console.log("   ID:",r.numero_id),console.log("   Fournisseur:",r.fournisseur);{const u=new Date().toISOString().slice(0,19).replace("T"," ");console.log("⏰ Utilisation timer_start sauvegardé:",timerStartSauvegarde),console.log("⏰ timer_fin_timestamp (NOW):",u),await t.env.DB.prepare(`
        ...
        `).run(),console.log("✅ Table controleur_alertes vérifiée");let m="";o&&(m=`Écart palettes: Attendues ${r.palettes_attendues}, Reçues ${r.palettes_recues}`);const f=JSON.stringify(c);console.log("📝 Non-conformités (problèmes):",f);const b=JSON.stringify(r.verification_points||{});console.log("📝 Points de vérification:",b);const g=o||d?"en_attente":"traitee";console.log("📊 Statut alerte:",g,"(Problèmes:",o||d,")"),console.log("⏱️ Durée déchargement:",timerDuration,"secondes");const v=await t.env.DB.prepare(`
          INSERT INTO controleur_alertes (
    ...
    `).bind(i||null,r).run(),console.log(`✅ Improductivité ${r} validée`),t.json({success:!0,message:"Improductivité validée et transmise"})}catch(r){return console.error("❌ Erreur validation improductivité:",r),t.json({success:!1,error:r.message},500)}});p.get("/api/improductivites/utilisateur/:nom",async t=>{try{const r=t.req.param("nom");if(!r)return t.json({success:!1,error:"Nom requis"},400);const{results:s}=await t.env.DB.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 100
    `).bind(r).all();return t.json({success:!0,improductivites:s})}catch(r){return console.error("❌ Erreur récupération improductivités utilisateur:",r),t.json({success:!0,improductivites:[]})}});p.get("/api/chef-equipe/kpi/reception-camion",async t=>{try{const s=t.req.query("date")||new Date().toISOString().split("T")[0];console.log("📊 Récupération KPI pour date:",s);const{results:i}=await t.env.DB.prepare(`
      SELECT 
        ca.id,
        ca.quai_numero,
        ca.numero_id,
      ...
      LIMIT 100
    `).bind(s).all();console.log(`📊 ${i.length} camions trouvés pour ${s}`);const a=i.map(o=>{let c=null,d="grey",u="—";if(o.duree_dechargement_secondes){const y=o.duree_dechargement_secondes,_=Math.floor(y/3600),k=Math.floor(y%3600/60),q=y%60;u=`${String(_).padStart(2,"0")}:${String(k).padStart(2,"0")}:${String(q).padStart(2,"0")}`,c=Math.round(y/60),c<=20?d="green":c<=25?d="orange":d="red"}else if(o.heure_premier_scan&&o.heure_fin_dechargement){const y=new Date(o.heure_premier_scan.replace(" ","T")),k=new Date(o.heure_fin_dechargement.replace(" ","T")).getTime()-y.getTime();c=Math.round(k/6e4);const q=Math.floor(c/60),I=c%60;u=`${String(q).padStart(2,"0")}:${String(I).padStart(2,"0")}:00`,c<=20?d="green":c<=25?d="orange":d="red"}let m=null,f="grey",b="—";if(o.duree_controle_secondes){const y=o.duree_controle_secondes,_=Math.floor(y/3600),k=Math.floor(y%3600/60),q=y%60;b=`${String(_).padStart(2,"0")}:${String(k).padStart(2,"0")}:${String(q).padStart(2,"0")}`,m=Math.round(y/60),m<=30?f="green":m<=40?f="orange":f="red"}else if(o.heure_fin_dechargement&&o.traite_le){const y=new Date(o.heure_fin_dechargement.replace(" ","T")),k=new Date(o.traite_le.replace(" ","T")).getTime()-y.getTime();m=Math.round(k/6e4);const q=Math.floor(m/60),I=m%60;b=`${String(q).padStart(2,"0")}:${String(I).padStart(2,"0")}:00`,m<=30?f="green":m<=40?f="orange":f="red"}let g=null,v="grey",x="—";if(o.duree_dechargement_secondes&&o.duree_controle_secondes){const y=o.duree_dechargement_secondes+o.duree_controle_secondes,_=Math.floor(y/3600),k=Math.floor(y%3600/60),q=y%60;x=`${String(_).padStart(2,"0")}:${String(k).padStart(2,"0")}:${String(q).padStart(2,"0")}`,g=Math.round(y/60),g<=60?v="green":g<=70?v="orange":v="red"}else if(o.heure_premier_scan&&o.traite_le){const y=new Date(o.heure_premier_scan.replace(" ","T")),k=new Date(o.traite_le.replace(" ","T")).getTime()-y.getTime();g=Math.round(k/6e4);const q=Math.floor(g/60),I=g%60;x=`${String(q).padStart(2,"0")}:${String(I).padStart(2,"0")}:00`,g<=60?v="green":g<=70?v="orange":v="red"}const E=y=>{if(!y)return"—";const _=new Date(y.replace(" ","T"));return`${String(_.getHours()).padStart(2,"0")}:${String(_.getMinutes()).padStart(2,"0")}`};return{id:o.id,quai_numero:o.quai_numero,numero_camion:o.numero_id||`C${String(o.id).padStart(3,"0")}e`,fournisseur:o.fournisseur,heure_debut:E(o.heure_premier_scan),heure_fin:E(o.heure_fin_dechargement),heure_validation:E(o.traite_le),duree_dechargement:u,duree_dechargement_minutes:c,duree_dechargement_status:d,duree_controle:b,duree_controle_minutes:m,duree_controle_status:f,duree_totale:x,duree_totale_minutes:g,duree_totale_status:v}}),n=a.filter(o=>o.duree_dechargement_minutes!==null&&o.duree_controle_minutes!==null&&o.duree_totale_minutes!==null),l={dechargement_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_dechargement_minutes,0)/n.length):0,controle_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_controle_minutes,0)/n.length):0,total_minutes:n.length>0?Math.round(n.reduce((o,c)=>o+c.duree_totale_minutes,0)/n.length):0,total_camions:a.length,camions_complets:n.length};return t.json({success:!0,date:s,kpi:a,moyennes:l})}catch(r){return console.error("❌ Erreur récupération KPI:",r),t.json({success:!1,error:r.message},500)}});const Zt=new Ar,ea=Object.assign({"/src/index.tsx":p});let Ur=!1;for(const[,t]of Object.entries(ea))t&&(Zt.route("/",t),Zt.notFound(t.notFoundHandler),Ur=!0);if(!Ur)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Zt as default};
