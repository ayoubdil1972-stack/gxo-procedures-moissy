var $r=Object.defineProperty;var Nt=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?$r(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var y=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Nt("Cannot "+s);var m=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),k=(t,r,s)=>r.has(t)?Nt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),E=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),_=(t,r,s)=>(lt(t,r,"access private method"),s);var Dt=(t,r,s,i)=>({set _(a){E(t,r,a,s)},get _(){return m(t,r,i)}});var ir={Stringify:1},O=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const o=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??o)s+=n;else{const l=[s];te(n,l),s=l[0]}}return O(s,r)},te=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(l=>l({phase:r,buffer:a,context:i}))).then(l=>Promise.all(l.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let o=0,l=n.length;o<l;o++){const c=n[o];if(typeof c=="string")te(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):te(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?O(nr(O(s[0],s.callbacks))):O(s[0]):ar(s,s.callbacks)},kt=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),S=Symbol("STASH"),lr=Symbol("INTERNAL"),Wr=Symbol("MEMO"),rt=Symbol("PERMALINK"),jt=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:jt(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:jt(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,Ee.push(s),s},Ee=[],_t=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>O(n,n.callbacks)):O(a)};return s.values=r,s.Provider=s,s[kt]=cr(r),Ee.push(s),s},ke=t=>t.values.at(-1),We={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},Xe="data-precedence",He=t=>Array.isArray(t)?t:[t],Ft=new WeakMap,Pt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const o=Ft.get(n)||{};Ft.set(n,o);const l=o[t]||(o[t]=[]);let c=!1;const d=We[t];if(d.length>0){e:for(const[,u]of l)for(const h of d)if(((u==null?void 0:u[h])??null)===(s==null?void 0:s[h])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?l.push([r,s,i]):l.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=l.map(([h])=>h);else{const h=[];u=l.map(([f,,g])=>{let v=h.indexOf(g);return v===-1&&(h.push(g),v=h.length-1),[f,v]}).sort((f,g)=>f[1]-g[1]).map(([f])=>f)}u.forEach(h=>{a[0]=a[0].replaceAll(h,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Be=(t,r,s)=>O(new H(t,s,He(r??[])).toString()),Ue=(t,r,s,i)=>{if("itemProp"in s)return Be(t,r,s);let{precedence:a,blocking:n,...o}=s;a=i?a??"":void 0,i&&(o[Xe]=a);const l=new H(t,o,He(r||[])).toString();return l instanceof Promise?l.then(c=>O(l,[...c.callbacks||[],Pt(t,c,o,a)])):O(l,[Pt(t,l,o,a)])},Xr=({children:t,...r})=>{const s=Ct();if(s){const i=ke(s);if(i==="svg"||i==="head")return new H("title",r,He(t??[]))}return Ue("title",t,r,!1)},Yr=({children:t,...r})=>{const s=Ct();return["src","async"].some(i=>!r[i])||s&&ke(s)==="head"?Be("script",t,r):Ue("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,Ue("style",t,r,!0)):Be("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Be("link",t,r):Ue("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=Ct();return s&&ke(s)==="head"?Be("meta",t,r):Ue("meta",t,r,!1)},ur=(t,{children:r,...s})=>new H(t,s,He(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),ts=t=>mr("input",t),rs=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Xr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Ne=void 0,Ct=()=>Ne,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],qt=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")te(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof H?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):qt(a,r)}}},H=class{constructor(t,r,s){y(this,"tag");y(this,"props");y(this,"key");y(this,"children");y(this,"isEscaped",!0);y(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(O(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=Ne&&ke(Ne)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,o]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof o=="object"){let l="";hr(o,(c,d)=>{d!=null&&(l+=`${l?";":""}${c}:${d}`)}),t[0]+=' style="',te(l,t),t[0]+='"'}else if(typeof o=="string")t[0]+=` ${n}="`,te(o,t),t[0]+='"';else if(o!=null)if(typeof o=="number"||o.isEscaped)t[0]+=` ${n}="${o}"`;else if(typeof o=="boolean"&&ns.includes(n))o&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[O(o.__html)]}else if(o instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',o);else if(typeof o=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,te(o.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",qt(i,t),t[0]+=`</${r}>`}},dt=class extends H{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ee.length===0)t.unshift("",i);else{const a=Ee.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof H&&(n.localContexts=a),n)))}else i instanceof H?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},fr=class extends H{toStringToBuffer(t){qt(this.children,t)}},Ot=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},It=!1,Ye=(t,r,s)=>{if(!It){for(const i in vt)ct[i][kt]=vt[i];It=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(Ne||(Ne=_t("")),new H(t,r,[new dt(Ne,{value:t},s)])):new H(t,r,s)},os=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Lt=(t,r,s)=>(i,a)=>{let n=-1;return o(0);async function o(l){if(l<=n)throw new Error("next() called multiple times");n=l;let c,d=!1,u;if(t[l]?(u=t[l][0][0],i.req.routeIndex=l):u=l===t.length&&a||void 0,u)try{c=await u(i,()=>o(l+1))}catch(h){if(h instanceof Error&&r)i.error=h,c=await r(h,i),d=!0;else throw h}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,o)=>{o===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},pr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=pr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},At=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>At(t,decodeURI),gr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),o=r.slice(s,n===-1?void 0:n);return xs(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=gr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},me=(t,r,...s)=>(s.length&&(r=me(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,o)=>o.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?At(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let o=t.indexOf("?",8);if(o===-1)return;for(t.startsWith(r,o+1)||(o=t.indexOf(`&${r}`,o+1));o!==-1;){const l=t.charCodeAt(o+r.length+1);if(l===61){const c=o+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";o=t.indexOf(`&${r}`,o+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const o=t.indexOf("&",n+1);let l=t.indexOf("=",n);l>o&&o!==-1&&(l=-1);let c=t.slice(n+1,l===-1?o===-1?void 0:o:l);if(i&&(c=ut(c)),n=o,c==="")continue;let d;l===-1?d="":(d=t.slice(l+1,o===-1?void 0:o),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=xr,ws=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,Mt=t=>At(t,vr),pe,P,Q,wr,Er,yt,X,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){k(this,Q);y(this,"raw");k(this,pe);k(this,P);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});k(this,X,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,E(this,P,s),E(this,pe,{})}param(t){return t?_(this,Q,wr).call(this,t):_(this,Q,Er).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return m(this,X).call(this,"text").then(t=>JSON.parse(t))}text(){return m(this,X).call(this,"text")}arrayBuffer(){return m(this,X).call(this,"arrayBuffer")}blob(){return m(this,X).call(this,"blob")}formData(){return m(this,X).call(this,"formData")}addValidatedData(t,r){m(this,pe)[t]=r}valid(t){return m(this,pe)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return m(this,P)}get matchedRoutes(){return m(this,P)[0].map(([[,t]])=>t)}get routePath(){return m(this,P)[0].map(([[,t]])=>t)[this.routeIndex].path}},pe=new WeakMap,P=new WeakMap,Q=new WeakSet,wr=function(t){const r=m(this,P)[0][this.routeIndex][1][t],s=_(this,Q,yt).call(this,r);return s&&/\%/.test(s)?Mt(s):s},Er=function(){const t={},r=Object.keys(m(this,P)[0][this.routeIndex][1]);for(const s of r){const i=_(this,Q,yt).call(this,m(this,P)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Mt(i):i)}return t},yt=function(t){return m(this,P)[1]?m(this,P)[1][t]:t},X=new WeakMap,Jt),Es="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),Fe,Pe,z,ge,$,F,Oe,be,xe,ie,Ie,Le,Y,he,Kt,Ts=(Kt=class{constructor(t,r){k(this,Y);k(this,Fe);k(this,Pe);y(this,"env",{});k(this,z);y(this,"finalized",!1);y(this,"error");k(this,ge);k(this,$);k(this,F);k(this,Oe);k(this,be);k(this,xe);k(this,ie);k(this,Ie);k(this,Le);y(this,"render",(...t)=>(m(this,be)??E(this,be,r=>this.html(r)),m(this,be).call(this,...t)));y(this,"setLayout",t=>E(this,Oe,t));y(this,"getLayout",()=>m(this,Oe));y(this,"setRenderer",t=>{E(this,be,t)});y(this,"header",(t,r,s)=>{this.finalized&&E(this,F,new Response(m(this,F).body,m(this,F)));const i=m(this,F)?m(this,F).headers:m(this,ie)??E(this,ie,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});y(this,"status",t=>{E(this,ge,t)});y(this,"set",(t,r)=>{m(this,z)??E(this,z,new Map),m(this,z).set(t,r)});y(this,"get",t=>m(this,z)?m(this,z).get(t):void 0);y(this,"newResponse",(...t)=>_(this,Y,he).call(this,...t));y(this,"body",(t,r,s)=>_(this,Y,he).call(this,t,r,s));y(this,"text",(t,r,s)=>!m(this,ie)&&!m(this,ge)&&!r&&!s&&!this.finalized?new Response(t):_(this,Y,he).call(this,t,r,mt(Es,s)));y(this,"json",(t,r,s)=>_(this,Y,he).call(this,JSON.stringify(t),r,mt("application/json",s)));y(this,"html",(t,r,s)=>{const i=a=>_(this,Y,he).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});y(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});y(this,"notFound",()=>(m(this,xe)??E(this,xe,()=>new Response),m(this,xe).call(this,this)));E(this,Fe,t),r&&(E(this,$,r.executionCtx),this.env=r.env,E(this,xe,r.notFoundHandler),E(this,Le,r.path),E(this,Ie,r.matchResult))}get req(){return m(this,Pe)??E(this,Pe,new yr(m(this,Fe),m(this,Le),m(this,Ie))),m(this,Pe)}get event(){if(m(this,$)&&"respondWith"in m(this,$))return m(this,$);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,$))return m(this,$);throw Error("This context has no ExecutionContext")}get res(){return m(this,F)||E(this,F,new Response(null,{headers:m(this,ie)??E(this,ie,new Headers)}))}set res(t){if(m(this,F)&&t){t=new Response(t.body,t);for(const[r,s]of m(this,F).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=m(this,F).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}E(this,F,t),this.finalized=!0}get var(){return m(this,z)?Object.fromEntries(m(this,z)):{}}},Fe=new WeakMap,Pe=new WeakMap,z=new WeakMap,ge=new WeakMap,$=new WeakMap,F=new WeakMap,Oe=new WeakMap,be=new WeakMap,xe=new WeakMap,ie=new WeakMap,Ie=new WeakMap,Le=new WeakMap,Y=new WeakSet,he=function(t,r,s){const i=m(this,F)?new Headers(m(this,F).headers):m(this,ie)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,l]of n)o.toLowerCase()==="set-cookie"?i.append(o,l):i.set(o,l)}if(s)for(const[n,o]of Object.entries(s))if(typeof o=="string")i.set(n,o);else{i.delete(n);for(const l of o)i.append(n,l)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,ge);return new Response(t,{status:a,headers:i})},Kt),R="ALL",ks="all",_s=["get","post","put","delete","options","patch"],Tr="Can not add a route since the matcher is already built.",kr=class extends Error{},Cs="__COMPOSED_HANDLER",qs=t=>t.text("404 Not Found",404),Ht=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},I,N,_r,L,re,Ze,Je,ve,As=(ve=class{constructor(r={}){k(this,N);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");k(this,I,"/");y(this,"routes",[]);k(this,L,qs);y(this,"errorHandler",Ht);y(this,"onError",r=>(this.errorHandler=r,this));y(this,"notFound",r=>(E(this,L,r),this));y(this,"fetch",(r,...s)=>_(this,N,Je).call(this,r,s[1],s[0],r.method));y(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${me("/",r)}`,s),i,a)));y(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(_(this,N,Je).call(this,r.request,r,void 0,r.request.method))})});[..._s,ks].forEach(n=>{this[n]=(o,...l)=>(typeof o=="string"?E(this,I,o):_(this,N,re).call(this,n,m(this,I),o),l.forEach(c=>{_(this,N,re).call(this,n,m(this,I),c)}),this)}),this.on=(n,o,...l)=>{for(const c of[o].flat()){E(this,I,c);for(const d of[n].flat())l.map(u=>{_(this,N,re).call(this,d.toUpperCase(),m(this,I),u)})}return this},this.use=(n,...o)=>(typeof n=="string"?E(this,I,n):(E(this,I,"*"),o.unshift(n)),o.forEach(l=>{_(this,N,re).call(this,R,m(this,I),l)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??gr:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var o;let n;s.errorHandler===Ht?n=a.handler:(n=async(l,c)=>(await Lt([],s.errorHandler)(l,()=>a.handler(l,c))).res,n[Cs]=a.handler),_(o=i,N,re).call(o,a.method,a.path,n)}),this}basePath(r){const s=_(this,N,_r).call(this);return s._basePath=me(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const o=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=me(this._basePath,r),d=c==="/"?0:c.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const l=async(c,d)=>{const u=await s(a(c.req.raw),...o(c));if(u)return u;await d()};return _(this,N,re).call(this,R,me(r,"*"),l),this}},I=new WeakMap,N=new WeakSet,_r=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,E(r,L,m(this,L)),r.routes=this.routes,r},L=new WeakMap,re=function(r,s,i){r=r.toUpperCase(),s=me(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await _(this,N,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),o=this.router.match(a,n),l=new Ts(r,{path:n,matchResult:o,env:i,executionCtx:s,notFoundHandler:m(this,L)});if(o[0].length===1){let d;try{d=o[0][0][0][0](l,async()=>{l.res=await m(this,L).call(this,l)})}catch(u){return _(this,N,Ze).call(this,u,l)}return d instanceof Promise?d.then(u=>u||(l.finalized?l.res:m(this,L).call(this,l))).catch(u=>_(this,N,Ze).call(this,u,l)):d??m(this,L).call(this,l)}const c=Lt(o[0],this.errorHandler,m(this,L));return(async()=>{try{const d=await c(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return _(this,N,Ze).call(this,d,l)}})()},ve),Cr=[];function Ss(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const o=s[a]||s[R],l=o[2][n];if(l)return l;const c=n.match(o[0]);if(!c)return[[],Cr];const d=c.indexOf("",1);return[o[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Se=".*",Re="(?:|/.*)",fe=Symbol(),Rs=new Set(".\\+*[^]$()");function Ns(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Se||t===Re?1:r===Se||r===Re?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ae,ne,M,ce,Ds=(ce=class{constructor(){k(this,ae);k(this,ne);k(this,M,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(m(this,ae)!==void 0)throw fe;if(n)return;E(this,ae,s);return}const[o,...l]=r,c=o==="*"?l.length===0?["","",Se]:["","",it]:o==="/*"?["","",Re]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let h=c[2]||it;if(u&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw fe;if(d=m(this,M)[h],!d){if(Object.keys(m(this,M)).some(f=>f!==Se&&f!==Re))throw fe;if(n)return;d=m(this,M)[h]=new ce,u!==""&&E(d,ne,a.varIndex++)}!n&&u!==""&&i.push([u,m(d,ne)])}else if(d=m(this,M)[o],!d){if(Object.keys(m(this,M)).some(u=>u.length>1&&u!==Se&&u!==Re))throw fe;if(n)return;d=m(this,M)[o]=new ce}d.insert(l,s,i,a,n)}buildRegExpStr(){const s=Object.keys(m(this,M)).sort(Ns).map(i=>{const a=m(this,M)[i];return(typeof m(a,ne)=="number"?`(${i})@${m(a,ne)}`:Rs.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof m(this,ae)=="number"&&s.unshift(`#${m(this,ae)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ae=new WeakMap,ne=new WeakMap,M=new WeakMap,ce),at,Me,er,js=(er=class{constructor(){k(this,at,{varIndex:0});k(this,Me,new Ds)}insert(t,r,s){const i=[],a=[];for(let o=0;;){let l=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${o}`;return a[o]=[d,c],o++,l=!0,d}),!l)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[l]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(l)!==-1){n[c]=n[c].replace(l,a[o][1]);break}}return m(this,Me).insert(n,r,i,m(this,at),s),i}buildRegExp(){let t=m(this,Me).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(s[++r]=Number(n),"$()"):(o!==void 0&&(i[Number(o)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,Me=new WeakMap,er),Fs=[/^$/,[],Object.create(null)],Ke=Object.create(null);function qr(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ps(){Ke=Object.create(null)}function Os(t){var d;const r=new js,s=[];if(t.length===0)return Fs;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,g])=>u?1:f?-1:h.length-g.length),a=Object.create(null);for(let u=0,h=-1,f=i.length;u<f;u++){const[g,v,x]=i[u];g?a[v]=[x.map(([w])=>[w,Object.create(null)]),Cr]:h++;let b;try{b=r.insert(v,h,g)}catch(w){throw w===fe?new kr(v):w}g||(s[h]=x.map(([w,T])=>{const q=Object.create(null);for(T-=1;T>=0;T--){const[C,A]=b[T];q[C]=A}return[w,q]}))}const[n,o,l]=r.buildRegExp();for(let u=0,h=s.length;u<h;u++)for(let f=0,g=s[u].length;f<g;f++){const v=(d=s[u][f])==null?void 0:d[1];if(!v)continue;const x=Object.keys(v);for(let b=0,w=x.length;b<w;b++)v[x[b]]=l[v[x[b]]]}const c=[];for(const u in o)c[u]=s[o[u]];return[n,c,a]}function de(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(qr(s).test(r))return[...t[s]]}}var Z,J,nt,Ar,tr,Is=(tr=class{constructor(){k(this,nt);y(this,"name","RegExpRouter");k(this,Z);k(this,J);y(this,"match",Ss);E(this,Z,{[R]:Object.create(null)}),E(this,J,{[R]:Object.create(null)})}add(t,r,s){var l;const i=m(this,Z),a=m(this,J);if(!i||!a)throw new Error(Tr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[t][d]=[...c[R][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=qr(r);t===R?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=de(i[d],r)||de(i[R],r)||[])}):(l=i[t])[r]||(l[r]=de(i[t],r)||de(i[R],r)||[]),Object.keys(i).forEach(d=>{(t===R||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===R||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const o=br(r)||[r];for(let c=0,d=o.length;c<d;c++){const u=o[c];Object.keys(a).forEach(h=>{var f;(t===R||t===h)&&((f=a[h])[u]||(f[u]=[...de(i[h],u)||de(i[R],u)||[]]),a[h][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(m(this,J)).concat(Object.keys(m(this,Z))).forEach(r=>{t[r]||(t[r]=_(this,nt,Ar).call(this,r))}),E(this,Z,E(this,J,void 0)),Ps(),t}},Z=new WeakMap,J=new WeakMap,nt=new WeakSet,Ar=function(t){const r=[];let s=t===R;return[m(this,Z),m(this,J)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==R&&r.push(...Object.keys(i[R]).map(n=>[n,i[R][n]]))}),s?Os(r):null},tr),K,V,rr,Ls=(rr=class{constructor(t){y(this,"name","SmartRouter");k(this,K,[]);k(this,V,[]);E(this,K,t.routers)}add(t,r,s){if(!m(this,V))throw new Error(Tr);m(this,V).push([t,r,s])}match(t,r){if(!m(this,V))throw new Error("Fatal error");const s=m(this,K),i=m(this,V),a=s.length;let n=0,o;for(;n<a;n++){const l=s[n];try{for(let c=0,d=i.length;c<d;c++)l.add(...i[c]);o=l.match(t,r)}catch(c){if(c instanceof kr)continue;throw c}this.match=l.match.bind(l),E(this,K,[l]),E(this,V,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(m(this,V)||m(this,K).length!==1)throw new Error("No active router has been determined yet.");return m(this,K)[0]}},K=new WeakMap,V=new WeakMap,rr),qe=Object.create(null),ee,j,oe,ye,D,G,se,we,Ms=(we=class{constructor(r,s,i){k(this,G);k(this,ee);k(this,j);k(this,oe);k(this,ye,0);k(this,D,qe);if(E(this,j,i||Object.create(null)),E(this,ee,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},E(this,ee,[a])}E(this,oe,[])}insert(r,s,i){E(this,ye,++Dt(this,ye)._);let a=this;const n=fs(s),o=[];for(let l=0,c=n.length;l<c;l++){const d=n[l],u=n[l+1],h=bs(d,u),f=Array.isArray(h)?h[0]:d;if(f in m(a,j)){a=m(a,j)[f],h&&o.push(h[1]);continue}m(a,j)[f]=new we,h&&(m(a,oe).push(h),o.push(h[1])),a=m(a,j)[f]}return m(a,ee).push({[r]:{handler:i,possibleKeys:o.filter((l,c,d)=>d.indexOf(l)===c),score:m(this,ye)}}),a}search(r,s){var c;const i=[];E(this,D,qe);let n=[this];const o=pr(s),l=[];for(let d=0,u=o.length;d<u;d++){const h=o[d],f=d===u-1,g=[];for(let v=0,x=n.length;v<x;v++){const b=n[v],w=m(b,j)[h];w&&(E(w,D,m(b,D)),f?(m(w,j)["*"]&&i.push(..._(this,G,se).call(this,m(w,j)["*"],r,m(b,D))),i.push(..._(this,G,se).call(this,w,r,m(b,D)))):g.push(w));for(let T=0,q=m(b,oe).length;T<q;T++){const C=m(b,oe)[T],A=m(b,D)===qe?{}:{...m(b,D)};if(C==="*"){const W=m(b,j)["*"];W&&(i.push(..._(this,G,se).call(this,W,r,m(b,D))),E(W,D,A),g.push(W));continue}const[_e,Ve,Ce]=C;if(!h&&!(Ce instanceof RegExp))continue;const B=m(b,j)[_e],zr=o.slice(d).join("/");if(Ce instanceof RegExp){const W=Ce.exec(zr);if(W){if(A[Ve]=W[0],i.push(..._(this,G,se).call(this,B,r,m(b,D),A)),Object.keys(m(B,j)).length){E(B,D,A);const ot=((c=W[0].match(/\//))==null?void 0:c.length)??0;(l[ot]||(l[ot]=[])).push(B)}continue}}(Ce===!0||Ce.test(h))&&(A[Ve]=h,f?(i.push(..._(this,G,se).call(this,B,r,A,m(b,D))),m(B,j)["*"]&&i.push(..._(this,G,se).call(this,m(B,j)["*"],r,A,m(b,D)))):(E(B,D,A),g.push(B)))}}n=g.concat(l.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},ee=new WeakMap,j=new WeakMap,oe=new WeakMap,ye=new WeakMap,D=new WeakMap,G=new WeakSet,se=function(r,s,i,a){const n=[];for(let o=0,l=m(r,ee).length;o<l;o++){const c=m(r,ee)[o],d=c[s]||c[R],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==qe||a&&a!==qe))for(let h=0,f=d.possibleKeys.length;h<f;h++){const g=d.possibleKeys[h],v=u[d.score];d.params[g]=a!=null&&a[g]&&!v?a[g]:i[g]??(a==null?void 0:a[g]),u[d.score]=!0}}return n},we),le,sr,Hs=(sr=class{constructor(){y(this,"name","TrieRouter");k(this,le);E(this,le,new Ms)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)m(this,le).insert(t,i[a],s);return}m(this,le).insert(t,r,s)}match(t,r){return m(this,le).search(t,r)}},le=new WeakMap,sr),Sr=class extends As{constructor(t={}){super(t),this.router=t.router??new Ls({routers:[new Is,new Hs]})}},Bs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Bt=(t,r=zs)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Us={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},zs=Us,$s=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Rr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??$s;return async(a,n)=>{var u,h,f,g;if(a.finalized)return n();let o;if(t.path)o=t.path;else try{if(o=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(o))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let l=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(o):o);t.isDir&&await t.isDir(l)&&(l=i(l,Gs));const c=t.getContent;let d=await c(l,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const v=t.mimes&&Bt(l,t.mimes)||Bt(l);if(a.header("Content-Type",v||"application/octet-stream"),t.precompressed&&(!v||Bs.test(v))){const x=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(b=>b.trim()));for(const b of Vs){if(!x.has(b))continue;const w=await c(l+Rr[b],a);if(w){d=w,a.header("Content-Encoding",b),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,l,a)),a.body(d)}await((g=t.onNotFound)==null?void 0:g.call(t,l,a)),await n()}},Ws=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Xs=t=>async function(s,i){return Qs({...t,getContent:async n=>Ws(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Xs(t),De="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},je=[],wt=new WeakMap,Te=void 0,Ks=()=>Te,U=t=>"t"in t,ht={onClick:["click",!1]},Ut=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},zt=(t,r)=>Te&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const o=Ut(a);if(o){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(o[0],s[a],o[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(o[0],n,o[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let l;typeof n=="function"?l=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,l=()=>n.current=null),wt.set(t,l)}else if(a==="style"){const l=t.style;typeof n=="string"?l.cssText=n:(l.cssText="",n!=null&&hr(n,l.setProperty.bind(l)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const l=zt(t,a);n==null||n===!1?t.removeAttribute(l):n===!0?t.setAttribute(l,""):typeof n=="string"||typeof n=="number"?t.setAttribute(l,n):t.setAttribute(l,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const o=Ut(a);o?t.removeEventListener(o[0],n,o[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute(zt(t,a))}}},ti=(t,r)=>{r[S][0]=0,je.push([t,r]);const s=r.tag[kt]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{je.pop()}},Nr=(t,r,s,i,a)=>{var n,o;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((o=t[S][1][Pr])==null||o.forEach(l=>a.push(l))),t.vC.forEach(l=>{var c;if(U(l))s.push(l);else if(typeof l.tag=="function"||l.tag===""){l.c=r;const d=s.length;if(Nr(l,r,s,i,a),l.s){for(let u=d;u<s.length;u++)s[u].s=!0;l.s=!1}}else s.push(l),(c=l.vR)!=null&&c.length&&(i.push(...l.vR),delete l.vR)})},ri=t=>{for(;;t=t.tag===De||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==De&&t.e)return t.e}},Dr=t=>{var r,s,i,a,n,o;U(t)||((s=(r=t[S])==null?void 0:r[1][Pr])==null||s.forEach(l=>{var c;return(c=l[2])==null?void 0:c.call(l)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(l=>l.p=2)),(n=t.vC)==null||n.forEach(Dr)),t.p||((o=t.e)==null||o.remove(),delete t.e),typeof t.tag=="function"&&(Ae.delete(t),et.delete(t),delete t[S][3],t.a=!0)},jr=(t,r,s)=>{t.c=r,Fr(t,r,s)},$t=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Vt=Symbol(),Fr=(t,r,s)=>{var d;const i=[],a=[],n=[];Nr(t,r,i,a,n),a.forEach(Dr);const o=s?void 0:r.childNodes;let l,c=null;if(s)l=-1;else if(!o.length)l=0;else{const u=$t(o,ri(t.nN));u!==void 0?(c=o[u],l=u):l=$t(o,(d=i.find(h=>h.tag!==De&&h.e))==null?void 0:d.e)??-1,l===-1&&(s=!0)}for(let u=0,h=i.length;u<h;u++,l++){const f=i[u];let g;if(f.s&&f.e)g=f.e,f.s=!1;else{const v=s||!f.e;U(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,g=f.e||(f.e=document.createTextNode(f.t))):(g=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(g,f.props,f.pP),Fr(f,g,v))}f.tag===De?l--:s?g.parentNode||r.appendChild(g):o[l]!==g&&o[l-1]!==g&&(o[l+1]===g?r.appendChild(o[l]):r.insertBefore(g,c||o[l]||null))}if(t.pP&&delete t.pP,n.length){const u=[],h=[];n.forEach(([,f,,g,v])=>{f&&u.push(f),g&&h.push(g),v==null||v()}),u.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,o,l,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):He(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const h=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let g;for(let v=0;v<s.length;v++){Array.isArray(s[v])&&s.splice(v,1,...s[v].flat());let x=ii(s[v]);if(x){typeof x.tag=="function"&&!x.tag[lr]&&(Ee.length>0&&(x[S][2]=Ee.map(w=>[w,w.values.at(-1)])),(o=t[5])!=null&&o.length&&(x[S][3]=t[5].at(-1)));let b;if(h&&h.length){const w=h.findIndex(U(x)?T=>U(T):x.key!==void 0?T=>T.key===x.key&&T.tag===x.tag:T=>T.tag===x.tag);w!==-1&&(b=h[w],h.splice(w,1))}if(b)if(U(x))b.t!==x.t&&(b.t=x.t,b.d=!0),x=b;else{const w=b.pP=b.props;if(b.props=x.props,b.f||(b.f=x.f||r.f),typeof x.tag=="function"){const T=b[S][2];b[S][2]=x[S][2]||[],b[S][3]=x[S][3],!b.f&&((b.o||b)===x.o||(c=(l=b.tag)[Wr])!=null&&c.call(l,w,b.props))&&si(T,b[S][2])&&(b.s=!0)}x=b}else if(!U(x)&&Te){const w=ke(Te);w&&(x.n=w)}if(!U(x)&&!x.s&&(Et(t,x),delete x.f),f.push(x),g&&!g.s&&!x.s)for(let w=g;w&&!U(w);w=(d=w.vC)==null?void 0:d.at(-1))w.nN=x;g=x}}r.vR=i?[...r.vC,...h||[]]:h||[],r.vC=f,i&&delete r.pC}catch(h){if(r.f=!0,h===Vt){if(a)return;throw h}const[f,g,v]=((u=r[S])==null?void 0:u[3])||[];if(g){const x=()=>tt([0,!1,t[2]],v),b=et.get(v)||[];b.push(x),et.set(v,b);const w=g(h,()=>{const T=et.get(v);if(T){const q=T.indexOf(x);if(q!==-1)return T.splice(q,1),x()}});if(w){if(t[0]===1)t[1]=!0;else if(Et(t,v,[w]),(g.length===1||t!==f)&&v.c){jr(v,v.c,!1);return}throw Vt}}throw h}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[S]=[0,[]];else{const r=Js[t.tag];r&&(Te||(Te=dr("")),t.props.children=[{tag:Te,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[S][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[S][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&jr(r,r.c,!1)},Ae=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Ae.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Ae.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Ae.get(r);n&&(Ae.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:De,props:{children:t},key:s,e:r,p:1}),ft=0,Pr=1,pt=2,gt=3,bt=new WeakMap,Or=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Wt=[],oi=t=>{var o;const r=()=>typeof t=="function"?t():t,s=je.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(o=i[S][1])[ft]||(o[ft]=[]),n=i[S][0]++;return a[n]||(a[n]=[r(),l=>{const c=ni,d=a[n];if(typeof l=="function"&&(l=l(d[0])),!Object.is(l,d[0]))if(d[0]=l,Wt.length){const[u,h]=Wt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),h]).then(([f])=>{if(!f||!(u===2||u===3))return;const g=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{g===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},St=(t,r)=>{var l;const s=je.at(-1);if(!s)return t;const[,i]=s,a=(l=i[S][1])[pt]||(l[pt]=[]),n=i[S][0]++,o=a[n];return Or(o==null?void 0:o[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},ci=(t,r)=>{var l;const s=je.at(-1);if(!s)return t();const[,i]=s,a=(l=i[S][1])[gt]||(l[gt]=[]),n=i[S][0]++,o=a[n];return Or(o==null?void 0:o[1],r)&&(a[n]=[t(),r]),a[n][0]},di=dr({pending:!1,data:null,method:null,action:null}),Xt=new Set,ui=t=>{Xt.add(t),t.finally(()=>Xt.delete(t))},Rt=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),ue=Object.create(null),Qe=Object.create(null),ze=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:o,onError:l,precedence:c,blocking:d,...u}=r,h=null,f=!1;const g=We[t];let v;if(g.length>0){const T=n.querySelectorAll(t);e:for(const q of T)for(const C of We[t])if(q.getAttribute(C)===r[C]){h=q;break e}if(!h){const q=g.reduce((C,A)=>r[A]===void 0?C:`${C}-${A}-${r[A]}`,t);f=!Qe[q],h=Qe[q]||(Qe[q]=(()=>{const C=document.createElement(t);for(const A of g)r[A]!==void 0&&C.setAttribute(A,r[A]),r.rel&&C.setAttribute("rel",r.rel);return C})())}}else v=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[Xe]=c);const x=St(T=>{if(g.length>0){let q=!1;for(const C of n.querySelectorAll(t)){if(q&&C.getAttribute(Xe)!==c){n.insertBefore(T,C);return}C.getAttribute(Xe)===c&&(q=!0)}n.appendChild(T)}else if(v){let q=!1;for(const C of v)if(C===T){q=!0;break}q||n.insertBefore(T,n.contains(v[0])?v[0]:n.querySelector(t)),v=void 0}},[c]),b=Rt(r.ref,T=>{var A;const q=g[0];if(s===2&&(T.innerHTML=""),(f||v)&&x(T),!l&&!o)return;let C=ue[A=T.getAttribute(q)]||(ue[A]=new Promise((_e,Ve)=>{T.addEventListener("load",_e),T.addEventListener("error",Ve)}));o&&(C=C.then(o)),l&&(C=C.catch(l)),C.catch(()=>{})});if(a&&d==="render"){const T=We[t][0];if(r[T]){const q=r[T],C=ue[q]||(ue[q]=new Promise((A,_e)=>{x(h),h.addEventListener("load",A),h.addEventListener("error",_e)}));li(C)}}const w={tag:t,type:t,props:{...u,ref:b},ref:b};return w.p=s,h&&(w.e=h),ai(w,n)},mi=t=>{const r=Ks(),s=r&&ke(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:ze("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:ze("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,ze("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:ze("link",t,1,"precedence"in t,!0),gi=t=>ze("meta",t,void 0,!1,!1),Ir=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=St(async d=>{const u=d.isTrusted?r:d.detail[Ir];if(typeof u!="function")return;d.preventDefault();const h=new FormData(d.target);a([h,!0]);const f=u(h);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),o=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[l,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:l!==null,data:l,method:l?"post":null,action:l?r:null},children:{tag:"form",props:{...s,ref:o},type:"form",ref:o}},f:c}},Lr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=St(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ir]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Lr("input",t),vi=t=>Lr("button",t);Object.assign(vt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});_t(null);new TextEncoder;var yi=_t(null),wi=(t,r,s,i)=>(a,n)=>{const o="<!DOCTYPE html>",l=s?Ot(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${O(o)}${Ot(yi.Provider,{value:t},l)}`;return t.html(c)},Mr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(o=>t({...o,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Mr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Vi(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:o}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const p=new Sr;function Hr(){const t=new Date;return new Date(t.toLocaleString("en-US",{timeZone:"Europe/Paris"})).toISOString()}p.use("/static/*",Ys({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));p.get("/login",$e,t=>t.render(e(Pi,{})));p.get("/qrcode-chauffeur",$e,t=>t.render(e(Oi,{})));p.get("/chauffeur/langue",$e,t=>t.render(e(Ii,{})));p.get("/gestion-quais",$e,t=>t.render(e(Ui,{})));p.get("/pdf-barcodes",t=>t.html(zi()));p.get("/qrcode-generator",t=>t.html($i()));p.get("/scan-dechargement",t=>{const r=t.req.query("quai");return t.redirect(`/scan?quai=${r}`)});p.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
...
</html>`));p.get("/chauffeur/consignes",t=>{const r=t.req.query("lang")||"fr";return t.redirect(`/consignes/${r}`)});p.get("/chauffeur/video",t=>t.redirect("/chauffeur/consignes?lang="+(t.req.query("lang")||"fr")));p.get("/chauffeur/inscription",t=>{const r=t.req.query("lang")||"fr";return t.html(Mi({lang:r}))});p.get("/chauffeur/taches",$e,t=>t.render(e(Hi,{})));p.post("/api/chauffeur/inscription",async t=>{try{const{pseudo:r,entreprise:s,numero_quai:i,langue:a,video_completed:n}=await t.req.json(),o=await t.env.DB.prepare(`
    ...
    `).run();let s="SELECT * FROM controleur_alertes",i=[];r?(s+=" WHERE DATE(created_at) = ?",i.push(r)):s+=' WHERE DATE(created_at) = DATE("now")',s+=" ORDER BY created_at DESC LIMIT 200";const{results:a}=await t.env.DB.prepare(s).bind(...i).all();console.log(`📊✅ KPI: ${a.length} alertes trouvées pour ${r||"aujourd'hui"}`);const n=a.map(c=>{const d=x=>{if(!x)return"—";const b=Math.floor(x/3600),w=Math.floor(x%3600/60),T=x%60;return`${String(b).padStart(2,"0")}:${String(w).padStart(2,"0")}:${String(T).padStart(2,"0")}`},u=x=>{if(!x)return"—";try{const b=new Date(x.replace(" ","T"));return`${String(b.getHours()).padStart(2,"0")}:${String(b.getMinutes()).padStart(2,"0")}`}catch{return"—"}},h=(x,b,w)=>{if(!x)return"grey";const T=Math.round(x/60);return T<=b?"green":T<=w?"orange":"red"},f=c.duree_dechargement_secondes||0,g=c.duree_controle_secondes||0,v=f+g;return{id:c.id,quai_numero:c.quai_numero,numero_camion:c.numero_id||`C${String(c.id).padStart(3,"0")}`,fournisseur:c.fournisseur||"—",heure_debut:u(c.heure_premier_scan),heure_fin:u(c.heure_fin_dechargement),heure_validation:u(c.traite_le),duree_dechargement:d(f),duree_dechargement_minutes:Math.round(f/60),duree_dechargement_status:h(f,20,25),duree_controle:d(g),duree_controle_minutes:Math.round(g/60),duree_controle_status:h(g,30,40),duree_totale:d(v),duree_totale_minutes:Math.round(v/60),duree_totale_status:h(v,60,70),statut:c.statut||"en_attente",traite_par:c.traite_par||"—",created_at:c.created_at}}),o=n.filter(c=>c.duree_controle_minutes>0),l={total_camions:n.length,camions_complets:o.length,dechargement_minutes:o.length>0?Math.round(o.reduce((c,d)=>c+d.duree_dechargement_minutes,0)/o.length):0,controle_minutes:o.length>0?Math.round(o.reduce((c,d)=>c+d.duree_controle_minutes,0)/o.length):0,total_minutes:o.length>0?Math.round(o.reduce((c,d)=>c+d.duree_totale_minutes,0)/o.length):0};return console.log("📊✅ Moyennes calculées:",l),t.json({success:!0,kpi:n,moyennes:l,date:r||new Date().toISOString().split("T")[0]})}catch(r){return console.error("❌ Erreur chargement KPI:",r),t.json({success:!1,error:r.message},500)}});const Zt=new Sr,ea=Object.assign({"/src/index.tsx":p});let Ur=!1;for(const[,t]of Object.entries(ea))t&&(Zt.route("/",t),Zt.notFound(t.notFoundHandler),Ur=!0);if(!Ur)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Zt as default};
