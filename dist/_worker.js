var $r=Object.defineProperty;var Rt=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?$r(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var y=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Rt("Cannot "+s);var m=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),_=(t,r,s)=>r.has(t)?Rt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),E=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),q=(t,r,s)=>(lt(t,r,"access private method"),s);var Dt=(t,r,s,i)=>({set _(a){E(t,r,a,s)},get _(){return m(t,r,i)}});var ir={Stringify:1},L=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];te(n,o),s=o[0]}}return L(s,r)},te=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")te(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):te(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?L(nr(L(s[0],s.callbacks))):L(s[0]):ar(s,s.callbacks)},_t=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),N=Symbol("STASH"),lr=Symbol("INTERNAL"),Wr=Symbol("MEMO"),rt=Symbol("PERMALINK"),It=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:It(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:It(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,Te.push(s),s},Te=[],kt=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>L(n,n.callbacks)):L(a)};return s.values=r,s.Provider=s,s[_t]=cr(r),Te.push(s),s},ke=t=>t.values.at(-1),We={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},Xe="data-precedence",He=t=>Array.isArray(t)?t:[t],Ot=new WeakMap,jt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=Ot.get(n)||{};Ot.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=We[t];if(d.length>0){e:for(const[,u]of o)for(const h of d)if(((u==null?void 0:u[h])??null)===(s==null?void 0:s[h])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=o.map(([h])=>h);else{const h=[];u=o.map(([f,,b])=>{let x=h.indexOf(b);return x===-1&&(h.push(b),x=h.length-1),[f,x]}).sort((f,b)=>f[1]-b[1]).map(([f])=>f)}u.forEach(h=>{a[0]=a[0].replaceAll(h,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Be=(t,r,s)=>L(new U(t,s,He(r??[])).toString()),ze=(t,r,s,i)=>{if("itemProp"in s)return Be(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[Xe]=a);const o=new U(t,l,He(r||[])).toString();return o instanceof Promise?o.then(c=>L(o,[...c.callbacks||[],jt(t,c,l,a)])):L(o,[jt(t,o,l,a)])},Xr=({children:t,...r})=>{const s=Ct();if(s){const i=ke(s);if(i==="svg"||i==="head")return new U("title",r,He(t??[]))}return ze("title",t,r,!1)},Yr=({children:t,...r})=>{const s=Ct();return["src","async"].some(i=>!r[i])||s&&ke(s)==="head"?Be("script",t,r):ze("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,ze("style",t,r,!0)):Be("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Be("link",t,r):ze("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=Ct();return s&&ke(s)==="head"?Be("meta",t,r):ze("meta",t,r,!1)},ur=(t,{children:r,...s})=>new U(t,s,He(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),ts=t=>mr("input",t),rs=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Xr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},De=void 0,Ct=()=>De,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],qt=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")te(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof U?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):qt(a,r)}}},U=class{constructor(t,r,s){y(this,"tag");y(this,"props");y(this,"key");y(this,"children");y(this,"isEscaped",!0);y(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(L(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=De&&ke(De)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";hr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',te(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,te(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&ns.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[L(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,te(l.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",qt(i,t),t[0]+=`</${r}>`}},dt=class extends U{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Te.length===0)t.unshift("",i);else{const a=Te.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof U&&(n.localContexts=a),n)))}else i instanceof U?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},fr=class extends U{toStringToBuffer(t){qt(this.children,t)}},Lt=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},Ft=!1,Ye=(t,r,s)=>{if(!Ft){for(const i in vt)ct[i][_t]=vt[i];Ft=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(De||(De=kt("")),new U(t,r,[new dt(De,{value:t},s)])):new U(t,r,s)},os=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Pt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,u;if(t[o]?(u=t[o][0][0],i.req.routeIndex=o):u=o===t.length&&a||void 0,u)try{c=await u(i,()=>l(o+1))}catch(h){if(h instanceof Error&&r)i.error=h,c=await r(h,i),d=!0;else throw h}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},pr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=pr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},At=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>At(t,decodeURI),gr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return xs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=gr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},he=(t,r,...s)=>(s.length&&(r=he(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?At(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=ut(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=xr,ws=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,Mt=t=>At(t,vr),ge,j,Q,wr,Er,yt,X,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){_(this,Q);y(this,"raw");_(this,ge);_(this,j);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});_(this,X,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,E(this,j,s),E(this,ge,{})}param(t){return t?q(this,Q,wr).call(this,t):q(this,Q,Er).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return m(this,X).call(this,"text").then(t=>JSON.parse(t))}text(){return m(this,X).call(this,"text")}arrayBuffer(){return m(this,X).call(this,"arrayBuffer")}blob(){return m(this,X).call(this,"blob")}formData(){return m(this,X).call(this,"formData")}addValidatedData(t,r){m(this,ge)[t]=r}valid(t){return m(this,ge)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return m(this,j)}get matchedRoutes(){return m(this,j)[0].map(([[,t]])=>t)}get routePath(){return m(this,j)[0].map(([[,t]])=>t)[this.routeIndex].path}},ge=new WeakMap,j=new WeakMap,Q=new WeakSet,wr=function(t){const r=m(this,j)[0][this.routeIndex][1][t],s=q(this,Q,yt).call(this,r);return s&&/\%/.test(s)?Mt(s):s},Er=function(){const t={},r=Object.keys(m(this,j)[0][this.routeIndex][1]);for(const s of r){const i=q(this,Q,yt).call(this,m(this,j)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Mt(i):i)}return t},yt=function(t){return m(this,j)[1]?m(this,j)[1][t]:t},X=new WeakMap,Jt),Es="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),je,Le,z,be,$,O,Fe,xe,ve,ae,Pe,Me,Y,fe,Kt,Ts=(Kt=class{constructor(t,r){_(this,Y);_(this,je);_(this,Le);y(this,"env",{});_(this,z);y(this,"finalized",!1);y(this,"error");_(this,be);_(this,$);_(this,O);_(this,Fe);_(this,xe);_(this,ve);_(this,ae);_(this,Pe);_(this,Me);y(this,"render",(...t)=>(m(this,xe)??E(this,xe,r=>this.html(r)),m(this,xe).call(this,...t)));y(this,"setLayout",t=>E(this,Fe,t));y(this,"getLayout",()=>m(this,Fe));y(this,"setRenderer",t=>{E(this,xe,t)});y(this,"header",(t,r,s)=>{this.finalized&&E(this,O,new Response(m(this,O).body,m(this,O)));const i=m(this,O)?m(this,O).headers:m(this,ae)??E(this,ae,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});y(this,"status",t=>{E(this,be,t)});y(this,"set",(t,r)=>{m(this,z)??E(this,z,new Map),m(this,z).set(t,r)});y(this,"get",t=>m(this,z)?m(this,z).get(t):void 0);y(this,"newResponse",(...t)=>q(this,Y,fe).call(this,...t));y(this,"body",(t,r,s)=>q(this,Y,fe).call(this,t,r,s));y(this,"text",(t,r,s)=>!m(this,ae)&&!m(this,be)&&!r&&!s&&!this.finalized?new Response(t):q(this,Y,fe).call(this,t,r,mt(Es,s)));y(this,"json",(t,r,s)=>q(this,Y,fe).call(this,JSON.stringify(t),r,mt("application/json",s)));y(this,"html",(t,r,s)=>{const i=a=>q(this,Y,fe).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});y(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});y(this,"notFound",()=>(m(this,ve)??E(this,ve,()=>new Response),m(this,ve).call(this,this)));E(this,je,t),r&&(E(this,$,r.executionCtx),this.env=r.env,E(this,ve,r.notFoundHandler),E(this,Me,r.path),E(this,Pe,r.matchResult))}get req(){return m(this,Le)??E(this,Le,new yr(m(this,je),m(this,Me),m(this,Pe))),m(this,Le)}get event(){if(m(this,$)&&"respondWith"in m(this,$))return m(this,$);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,$))return m(this,$);throw Error("This context has no ExecutionContext")}get res(){return m(this,O)||E(this,O,new Response(null,{headers:m(this,ae)??E(this,ae,new Headers)}))}set res(t){if(m(this,O)&&t){t=new Response(t.body,t);for(const[r,s]of m(this,O).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=m(this,O).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}E(this,O,t),this.finalized=!0}get var(){return m(this,z)?Object.fromEntries(m(this,z)):{}}},je=new WeakMap,Le=new WeakMap,z=new WeakMap,be=new WeakMap,$=new WeakMap,O=new WeakMap,Fe=new WeakMap,xe=new WeakMap,ve=new WeakMap,ae=new WeakMap,Pe=new WeakMap,Me=new WeakMap,Y=new WeakSet,fe=function(t,r,s){const i=m(this,O)?new Headers(m(this,O).headers):m(this,ae)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,be);return new Response(t,{status:a,headers:i})},Kt),S="ALL",_s="all",ks=["get","post","put","delete","options","patch"],Tr="Can not add a route since the matcher is already built.",_r=class extends Error{},Cs="__COMPOSED_HANDLER",qs=t=>t.text("404 Not Found",404),Ut=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},F,R,kr,P,se,Ze,Je,ye,As=(ye=class{constructor(r={}){_(this,R);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");_(this,F,"/");y(this,"routes",[]);_(this,P,qs);y(this,"errorHandler",Ut);y(this,"onError",r=>(this.errorHandler=r,this));y(this,"notFound",r=>(E(this,P,r),this));y(this,"fetch",(r,...s)=>q(this,R,Je).call(this,r,s[1],s[0],r.method));y(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${he("/",r)}`,s),i,a)));y(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(q(this,R,Je).call(this,r.request,r,void 0,r.request.method))})});[...ks,_s].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?E(this,F,l):q(this,R,se).call(this,n,m(this,F),l),o.forEach(c=>{q(this,R,se).call(this,n,m(this,F),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){E(this,F,c);for(const d of[n].flat())o.map(u=>{q(this,R,se).call(this,d.toUpperCase(),m(this,F),u)})}return this},this.use=(n,...l)=>(typeof n=="string"?E(this,F,n):(E(this,F,"*"),l.unshift(n)),l.forEach(o=>{q(this,R,se).call(this,S,m(this,F),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??gr:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===Ut?n=a.handler:(n=async(o,c)=>(await Pt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[Cs]=a.handler),q(l=i,R,se).call(l,a.method,a.path,n)}),this}basePath(r){const s=q(this,R,kr).call(this);return s._basePath=he(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=he(this._basePath,r),d=c==="/"?0:c.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const o=async(c,d)=>{const u=await s(a(c.req.raw),...l(c));if(u)return u;await d()};return q(this,R,se).call(this,S,he(r,"*"),o),this}},F=new WeakMap,R=new WeakSet,kr=function(){const r=new ye({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,E(r,P,m(this,P)),r.routes=this.routes,r},P=new WeakMap,se=function(r,s,i){r=r.toUpperCase(),s=he(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await q(this,R,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new Ts(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:m(this,P)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await m(this,P).call(this,o)})}catch(u){return q(this,R,Ze).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:m(this,P).call(this,o))).catch(u=>q(this,R,Ze).call(this,u,o)):d??m(this,P).call(this,o)}const c=Pt(l[0],this.errorHandler,m(this,P));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return q(this,R,Ze).call(this,d,o)}})()},ye),Cr=[];function Ns(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[S],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],Cr];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Se=".*",Re="(?:|/.*)",pe=Symbol(),Ss=new Set(".\\+*[^]$()");function Rs(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Se||t===Re?1:r===Se||r===Re?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ne,oe,M,de,Ds=(de=class{constructor(){_(this,ne);_(this,oe);_(this,M,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(m(this,ne)!==void 0)throw pe;if(n)return;E(this,ne,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",Se]:["","",it]:l==="/*"?["","",Re]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let h=c[2]||it;if(u&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw pe;if(d=m(this,M)[h],!d){if(Object.keys(m(this,M)).some(f=>f!==Se&&f!==Re))throw pe;if(n)return;d=m(this,M)[h]=new de,u!==""&&E(d,oe,a.varIndex++)}!n&&u!==""&&i.push([u,m(d,oe)])}else if(d=m(this,M)[l],!d){if(Object.keys(m(this,M)).some(u=>u.length>1&&u!==Se&&u!==Re))throw pe;if(n)return;d=m(this,M)[l]=new de}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(m(this,M)).sort(Rs).map(i=>{const a=m(this,M)[i];return(typeof m(a,oe)=="number"?`(${i})@${m(a,oe)}`:Ss.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof m(this,ne)=="number"&&s.unshift(`#${m(this,ne)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ne=new WeakMap,oe=new WeakMap,M=new WeakMap,de),at,Ue,er,Is=(er=class{constructor(){_(this,at,{varIndex:0});_(this,Ue,new Ds)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return m(this,Ue).insert(n,r,i,m(this,at),s),i}buildRegExp(){let t=m(this,Ue).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,Ue=new WeakMap,er),Os=[/^$/,[],Object.create(null)],Ke=Object.create(null);function qr(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function js(){Ke=Object.create(null)}function Ls(t){var d;const r=new Is,s=[];if(t.length===0)return Os;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,b])=>u?1:f?-1:h.length-b.length),a=Object.create(null);for(let u=0,h=-1,f=i.length;u<f;u++){const[b,x,v]=i[u];b?a[x]=[v.map(([w])=>[w,Object.create(null)]),Cr]:h++;let g;try{g=r.insert(x,h,b)}catch(w){throw w===pe?new _r(x):w}b||(s[h]=v.map(([w,T])=>{const C=Object.create(null);for(T-=1;T>=0;T--){const[k,A]=g[T];C[k]=A}return[w,C]}))}const[n,l,o]=r.buildRegExp();for(let u=0,h=s.length;u<h;u++)for(let f=0,b=s[u].length;f<b;f++){const x=(d=s[u][f])==null?void 0:d[1];if(!x)continue;const v=Object.keys(x);for(let g=0,w=v.length;g<w;g++)x[v[g]]=o[x[v[g]]]}const c=[];for(const u in l)c[u]=s[l[u]];return[n,c,a]}function ue(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(qr(s).test(r))return[...t[s]]}}var Z,J,nt,Ar,tr,Fs=(tr=class{constructor(){_(this,nt);y(this,"name","RegExpRouter");_(this,Z);_(this,J);y(this,"match",Ns);E(this,Z,{[S]:Object.create(null)}),E(this,J,{[S]:Object.create(null)})}add(t,r,s){var o;const i=m(this,Z),a=m(this,J);if(!i||!a)throw new Error(Tr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[S]).forEach(d=>{c[t][d]=[...c[S][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=qr(r);t===S?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=ue(i[d],r)||ue(i[S],r)||[])}):(o=i[t])[r]||(o[r]=ue(i[t],r)||ue(i[S],r)||[]),Object.keys(i).forEach(d=>{(t===S||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===S||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const l=br(r)||[r];for(let c=0,d=l.length;c<d;c++){const u=l[c];Object.keys(a).forEach(h=>{var f;(t===S||t===h)&&((f=a[h])[u]||(f[u]=[...ue(i[h],u)||ue(i[S],u)||[]]),a[h][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(m(this,J)).concat(Object.keys(m(this,Z))).forEach(r=>{t[r]||(t[r]=q(this,nt,Ar).call(this,r))}),E(this,Z,E(this,J,void 0)),js(),t}},Z=new WeakMap,J=new WeakMap,nt=new WeakSet,Ar=function(t){const r=[];let s=t===S;return[m(this,Z),m(this,J)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==S&&r.push(...Object.keys(i[S]).map(n=>[n,i[S][n]]))}),s?Ls(r):null},tr),K,V,rr,Ps=(rr=class{constructor(t){y(this,"name","SmartRouter");_(this,K,[]);_(this,V,[]);E(this,K,t.routers)}add(t,r,s){if(!m(this,V))throw new Error(Tr);m(this,V).push([t,r,s])}match(t,r){if(!m(this,V))throw new Error("Fatal error");const s=m(this,K),i=m(this,V),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof _r)continue;throw c}this.match=o.match.bind(o),E(this,K,[o]),E(this,V,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(m(this,V)||m(this,K).length!==1)throw new Error("No active router has been determined yet.");return m(this,K)[0]}},K=new WeakMap,V=new WeakMap,rr),Ae=Object.create(null),ee,I,le,we,D,G,ie,Ee,Ms=(Ee=class{constructor(r,s,i){_(this,G);_(this,ee);_(this,I);_(this,le);_(this,we,0);_(this,D,Ae);if(E(this,I,i||Object.create(null)),E(this,ee,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},E(this,ee,[a])}E(this,le,[])}insert(r,s,i){E(this,we,++Dt(this,we)._);let a=this;const n=fs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],u=n[o+1],h=bs(d,u),f=Array.isArray(h)?h[0]:d;if(f in m(a,I)){a=m(a,I)[f],h&&l.push(h[1]);continue}m(a,I)[f]=new Ee,h&&(m(a,le).push(h),l.push(h[1])),a=m(a,I)[f]}return m(a,ee).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:m(this,we)}}),a}search(r,s){var c;const i=[];E(this,D,Ae);let n=[this];const l=pr(s),o=[];for(let d=0,u=l.length;d<u;d++){const h=l[d],f=d===u-1,b=[];for(let x=0,v=n.length;x<v;x++){const g=n[x],w=m(g,I)[h];w&&(E(w,D,m(g,D)),f?(m(w,I)["*"]&&i.push(...q(this,G,ie).call(this,m(w,I)["*"],r,m(g,D))),i.push(...q(this,G,ie).call(this,w,r,m(g,D)))):b.push(w));for(let T=0,C=m(g,le).length;T<C;T++){const k=m(g,le)[T],A=m(g,D)===Ae?{}:{...m(g,D)};if(k==="*"){const W=m(g,I)["*"];W&&(i.push(...q(this,G,ie).call(this,W,r,m(g,D))),E(W,D,A),b.push(W));continue}const[re,Ce,qe]=k;if(!h&&!(qe instanceof RegExp))continue;const H=m(g,I)[re],zr=l.slice(d).join("/");if(qe instanceof RegExp){const W=qe.exec(zr);if(W){if(A[Ce]=W[0],i.push(...q(this,G,ie).call(this,H,r,m(g,D),A)),Object.keys(m(H,I)).length){E(H,D,A);const ot=((c=W[0].match(/\//))==null?void 0:c.length)??0;(o[ot]||(o[ot]=[])).push(H)}continue}}(qe===!0||qe.test(h))&&(A[Ce]=h,f?(i.push(...q(this,G,ie).call(this,H,r,A,m(g,D))),m(H,I)["*"]&&i.push(...q(this,G,ie).call(this,m(H,I)["*"],r,A,m(g,D)))):(E(H,D,A),b.push(H)))}}n=b.concat(o.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},ee=new WeakMap,I=new WeakMap,le=new WeakMap,we=new WeakMap,D=new WeakMap,G=new WeakSet,ie=function(r,s,i,a){const n=[];for(let l=0,o=m(r,ee).length;l<o;l++){const c=m(r,ee)[l],d=c[s]||c[S],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==Ae||a&&a!==Ae))for(let h=0,f=d.possibleKeys.length;h<f;h++){const b=d.possibleKeys[h],x=u[d.score];d.params[b]=a!=null&&a[b]&&!x?a[b]:i[b]??(a==null?void 0:a[b]),u[d.score]=!0}}return n},Ee),ce,sr,Us=(sr=class{constructor(){y(this,"name","TrieRouter");_(this,ce);E(this,ce,new Ms)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)m(this,ce).insert(t,i[a],s);return}m(this,ce).insert(t,r,s)}match(t,r){return m(this,ce).search(t,r)}},ce=new WeakMap,sr),Nr=class extends As{constructor(t={}){super(t),this.router=t.router??new Ps({routers:[new Fs,new Us]})}},Hs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Ht=(t,r=zs)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Bs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},zs=Bs,$s=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Sr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Sr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??$s;return async(a,n)=>{var u,h,f,b;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Gs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const x=t.mimes&&Ht(o,t.mimes)||Ht(o);if(a.header("Content-Type",x||"application/octet-stream"),t.precompressed&&(!x||Hs.test(x))){const v=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(g=>g.trim()));for(const g of Vs){if(!v.has(g))continue;const w=await c(o+Sr[g],a);if(w){d=w,a.header("Content-Encoding",g),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((b=t.onNotFound)==null?void 0:b.call(t,o,a)),await n()}},Ws=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Xs=t=>async function(s,i){return Qs({...t,getContent:async n=>Ws(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Xs(t),Ie="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},Oe=[],wt=new WeakMap,_e=void 0,Ks=()=>_e,B=t=>"t"in t,ht={onClick:["click",!1]},Bt=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},zt=(t,r)=>_e&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=Bt(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),wt.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&hr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=zt(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=Bt(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute(zt(t,a))}}},ti=(t,r)=>{r[N][0]=0,Oe.push([t,r]);const s=r.tag[_t]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{Oe.pop()}},Rr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[N][1][jr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if(B(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Rr(o,r,s,i,a),o.s){for(let u=d;u<s.length;u++)s[u].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ri=t=>{for(;;t=t.tag===Ie||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==Ie&&t.e)return t.e}},Dr=t=>{var r,s,i,a,n,l;B(t)||((s=(r=t[N])==null?void 0:r[1][jr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(Dr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Ne.delete(t),et.delete(t),delete t[N][3],t.a=!0)},Ir=(t,r,s)=>{t.c=r,Or(t,r,s)},$t=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Vt=Symbol(),Or=(t,r,s)=>{var d;const i=[],a=[],n=[];Rr(t,r,i,a,n),a.forEach(Dr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const u=$t(l,ri(t.nN));u!==void 0?(c=l[u],o=u):o=$t(l,(d=i.find(h=>h.tag!==Ie&&h.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let u=0,h=i.length;u<h;u++,o++){const f=i[u];let b;if(f.s&&f.e)b=f.e,f.s=!1;else{const x=s||!f.e;B(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,b=f.e||(f.e=document.createTextNode(f.t))):(b=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(b,f.props,f.pP),Or(f,b,x))}f.tag===Ie?o--:s?b.parentNode||r.appendChild(b):l[o]!==b&&l[o-1]!==b&&(l[o+1]===b?r.appendChild(l[o]):r.insertBefore(b,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const u=[],h=[];n.forEach(([,f,,b,x])=>{f&&u.push(f),b&&h.push(b),x==null||x()}),u.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,l,o,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):He(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const h=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let b;for(let x=0;x<s.length;x++){Array.isArray(s[x])&&s.splice(x,1,...s[x].flat());let v=ii(s[x]);if(v){typeof v.tag=="function"&&!v.tag[lr]&&(Te.length>0&&(v[N][2]=Te.map(w=>[w,w.values.at(-1)])),(l=t[5])!=null&&l.length&&(v[N][3]=t[5].at(-1)));let g;if(h&&h.length){const w=h.findIndex(B(v)?T=>B(T):v.key!==void 0?T=>T.key===v.key&&T.tag===v.tag:T=>T.tag===v.tag);w!==-1&&(g=h[w],h.splice(w,1))}if(g)if(B(v))g.t!==v.t&&(g.t=v.t,g.d=!0),v=g;else{const w=g.pP=g.props;if(g.props=v.props,g.f||(g.f=v.f||r.f),typeof v.tag=="function"){const T=g[N][2];g[N][2]=v[N][2]||[],g[N][3]=v[N][3],!g.f&&((g.o||g)===v.o||(c=(o=g.tag)[Wr])!=null&&c.call(o,w,g.props))&&si(T,g[N][2])&&(g.s=!0)}v=g}else if(!B(v)&&_e){const w=ke(_e);w&&(v.n=w)}if(!B(v)&&!v.s&&(Et(t,v),delete v.f),f.push(v),b&&!b.s&&!v.s)for(let w=b;w&&!B(w);w=(d=w.vC)==null?void 0:d.at(-1))w.nN=v;b=v}}r.vR=i?[...r.vC,...h||[]]:h||[],r.vC=f,i&&delete r.pC}catch(h){if(r.f=!0,h===Vt){if(a)return;throw h}const[f,b,x]=((u=r[N])==null?void 0:u[3])||[];if(b){const v=()=>tt([0,!1,t[2]],x),g=et.get(x)||[];g.push(v),et.set(x,g);const w=b(h,()=>{const T=et.get(x);if(T){const C=T.indexOf(v);if(C!==-1)return T.splice(C,1),v()}});if(w){if(t[0]===1)t[1]=!0;else if(Et(t,x,[w]),(b.length===1||t!==f)&&x.c){Ir(x,x.c,!1);return}throw Vt}}throw h}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[N]=[0,[]];else{const r=Js[t.tag];r&&(_e||(_e=dr("")),t.props.children=[{tag:_e,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[N][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[N][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&Ir(r,r.c,!1)},Ne=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Ne.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Ne.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Ne.get(r);n&&(Ne.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:Ie,props:{children:t},key:s,e:r,p:1}),ft=0,jr=1,pt=2,gt=3,bt=new WeakMap,Lr=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Wt=[],oi=t=>{var l;const r=()=>typeof t=="function"?t():t,s=Oe.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[N][1])[ft]||(l[ft]=[]),n=i[N][0]++;return a[n]||(a[n]=[r(),o=>{const c=ni,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Wt.length){const[u,h]=Wt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),h]).then(([f])=>{if(!f||!(u===2||u===3))return;const b=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{b===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},Nt=(t,r)=>{var o;const s=Oe.at(-1);if(!s)return t;const[,i]=s,a=(o=i[N][1])[pt]||(o[pt]=[]),n=i[N][0]++,l=a[n];return Lr(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},ci=(t,r)=>{var o;const s=Oe.at(-1);if(!s)return t();const[,i]=s,a=(o=i[N][1])[gt]||(o[gt]=[]),n=i[N][0]++,l=a[n];return Lr(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},di=dr({pending:!1,data:null,method:null,action:null}),Xt=new Set,ui=t=>{Xt.add(t),t.finally(()=>Xt.delete(t))},St=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),me=Object.create(null),Qe=Object.create(null),$e=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...u}=r,h=null,f=!1;const b=We[t];let x;if(b.length>0){const T=n.querySelectorAll(t);e:for(const C of T)for(const k of We[t])if(C.getAttribute(k)===r[k]){h=C;break e}if(!h){const C=b.reduce((k,A)=>r[A]===void 0?k:`${k}-${A}-${r[A]}`,t);f=!Qe[C],h=Qe[C]||(Qe[C]=(()=>{const k=document.createElement(t);for(const A of b)r[A]!==void 0&&k.setAttribute(A,r[A]),r.rel&&k.setAttribute("rel",r.rel);return k})())}}else x=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[Xe]=c);const v=Nt(T=>{if(b.length>0){let C=!1;for(const k of n.querySelectorAll(t)){if(C&&k.getAttribute(Xe)!==c){n.insertBefore(T,k);return}k.getAttribute(Xe)===c&&(C=!0)}n.appendChild(T)}else if(x){let C=!1;for(const k of x)if(k===T){C=!0;break}C||n.insertBefore(T,n.contains(x[0])?x[0]:n.querySelector(t)),x=void 0}},[c]),g=St(r.ref,T=>{var A;const C=b[0];if(s===2&&(T.innerHTML=""),(f||x)&&v(T),!o&&!l)return;let k=me[A=T.getAttribute(C)]||(me[A]=new Promise((re,Ce)=>{T.addEventListener("load",re),T.addEventListener("error",Ce)}));l&&(k=k.then(l)),o&&(k=k.catch(o)),k.catch(()=>{})});if(a&&d==="render"){const T=We[t][0];if(r[T]){const C=r[T],k=me[C]||(me[C]=new Promise((A,re)=>{v(h),h.addEventListener("load",A),h.addEventListener("error",re)}));li(k)}}const w={tag:t,type:t,props:{...u,ref:g},ref:g};return w.p=s,h&&(w.e=h),ai(w,n)},mi=t=>{const r=Ks(),s=r&&ke(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:$e("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:$e("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,$e("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:$e("link",t,1,"precedence"in t,!0),gi=t=>$e("meta",t,void 0,!1,!1),Fr=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=Nt(async d=>{const u=d.isTrusted?r:d.detail[Fr];if(typeof u!="function")return;d.preventDefault();const h=new FormData(d.target);a([h,!0]);const f=u(h);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),l=St(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Pr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=Nt(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Fr]:r}}))},[]);s.ref=St(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Pr("input",t),vi=t=>Pr("button",t);Object.assign(vt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});kt(null);new TextEncoder;var yi=kt(null),wi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Lt(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${L(l)}${Lt(yi.Provider,{value:t},o)}`;return t.html(c)},Mr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Mr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Vi(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:l}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const p=new Nr;p.use("*",async(t,r)=>{const s=new URL(t.req.url),i=s.hostname.toLowerCase();if(i==="gxomoissyprocedures.com"||i==="www.gxomoissyprocedures.com"){const a=`https://gxomoissyprocedures.pages.dev${s.pathname}${s.search}${s.hash}`;return console.log(`🔄 REDIRECTION AUTOMATIQUE: ${s.hostname} → gxomoissyprocedures.pages.dev`),t.redirect(a,301)}await r()});function Ur(){const t=new Date;return new Date(t.toLocaleString("en-US",{timeZone:"Europe/Paris"})).toISOString()}p.use("/static/*",Ys({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));p.get("/login",Ve,t=>t.render(e(ji,{})));p.get("/qrcode-chauffeur",Ve,t=>t.render(e(Li,{})));p.get("/chauffeur/langue",Ve,t=>t.render(e(Fi,{})));p.get("/gestion-quais",Ve,t=>t.render(e(Bi,{})));p.get("/pdf-barcodes",t=>t.html(zi()));p.get("/qrcode-generator",t=>t.html($i()));p.get("/scan-dechargement",t=>{const r=t.req.query("quai");return t.redirect(`/scan?quai=${r}`)});p.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
  ...
  `):t.html(`
    ...
    `)});p.post("/api/fin-controle",async t=>{try{const r=await t.req.json(),{quai:s,controleurNom:i}=r;if(!s||!i)return t.json({error:"Données manquantes"},400);const a=await t.env.DB.prepare(`
      ...
      FROM quai_status 
      WHERE quai_numero = ?
    `).bind(s).first();let n=null;if(a!=null&&a.timer_controle_start){const l=new Date(a.timer_controle_start.replace(" ","T")+"Z").getTime(),o=new Date(Ur()).getTime();n=Math.floor((o-l)/1e3),console.log(`⏱️ Durée contrôle calculée: ${n}s`)}await t.env.DB.prepare(`
      UPDATE quai_status 
    ...
    `).bind(n,i,s).run(),console.log(`✅ Quai ${s} passé en fin de contrôle - Timer figé à ${n}s - Contrôleur: ${i}`);try{console.log(`📊 Archivage KPI pour Quai ${s}`);const l=await t.env.DB.prepare(`
        ...
        FROM quai_status
        WHERE quai_numero = ?
      `).bind(s).first();if(!l)return console.error(`❌ Pas de données quai_status pour Quai ${s}`),t.json({success:!0,quai:s,dureeControle:n,controleurNom:i,warning:"Pas de données quai pour archivage KPI"});let o=(a==null?void 0:a.controle_id_chauffeur)||"INCONNU",c=(a==null?void 0:a.controle_fournisseur)||"INCONNU";if(l.commentaire&&l.commentaire.includes("ID:")){const f=l.commentaire.split(" - ");f.length>=3&&(c=f[2].trim());const b=l.commentaire.match(/ID:(\S+)/);b&&(o=b[1])}const d=l.timer_duration||0,u=n||0;console.log(`📊 Archive: Quai ${s}, ${o}, ${c}, Déch: ${d}s, Ctrl: ${u}s`),await t.env.DB.prepare(`
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
...
</html>`));p.get("/chauffeur/consignes",t=>{const r=t.req.query("lang")||"fr";return t.redirect(`/consignes/${r}`)});p.get("/chauffeur/video",t=>t.redirect("/chauffeur/consignes?lang="+(t.req.query("lang")||"fr")));p.get("/chauffeur/inscription",t=>{const r=t.req.query("lang")||"fr";return t.html(Mi({lang:r}))});p.get("/chauffeur/taches",Ve,t=>t.render(e(Ui,{})));p.post("/api/chauffeur/inscription",async t=>{try{const{pseudo:r,entreprise:s,numero_quai:i,langue:a,video_completed:n}=await t.req.json(),l=await t.env.DB.prepare(`
    ...
    `).bind(r).first();return t.json({success:!0,...s})}catch(r){return console.error("Erreur progression:",r),t.json({success:!1,error:r.message},500)}});async function Hr(t){try{await t.prepare(`
    ...
    `).run(),await t.prepare("CREATE INDEX IF NOT EXISTS idx_chat_messages_chauffeur_id ON chat_messages(chauffeur_id)").run(),await t.prepare("CREATE INDEX IF NOT EXISTS idx_chat_messages_timestamp ON chat_messages(timestamp)").run(),console.log("✅ Table chat_messages prête avec colonnes de traduction")}catch(r){console.error("⚠️ Erreur auto-migration chat_messages:",r.message)}}p.post("/api/chauffeur/chat",async t=>{try{await Hr(t.env.DB);const{chauffeur_id:r,message:s,sender:i,lang:a}=await t.req.json();if(!r||!s)return t.json({success:!1,error:"Données manquantes"},400);let n=a||"fr";if(!a){const u=await t.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(r,l,s,d,o,c,l==="chauffeur"?0:1,l==="admin"?0:1).run(),console.log(`✅ [CHAT] Message enregistré avec succès - ID chauffeur: ${r}`),t.json({success:!0,translated_fr:o,translated_chauffeur:c})}catch(r){return console.error("Erreur envoi message:",r),t.json({success:!1,error:r.message},500)}});p.get("/api/chauffeur/chat",async t=>{try{await Hr(t.env.DB);const r=t.req.query("id")||t.req.query("chauffeur_id"),s=t.req.query("viewer")||"chauffeur";console.log(`📥 [CHAT GET] Récupération messages - Chauffeur: ${r}, Viewer: ${s}`);const i=await t.env.DB.prepare(`
      SELECT langue FROM chauffeur_arrivals WHERE id = ?
    ...
    `).all();return console.log(`📅 Alertes semaine récupérées: ${((r=i.results)==null?void 0:r.length)||0}`),t.json({success:!0,semaine:{lundi:s==null?void 0:s.lundi,vendredi:s==null?void 0:s.vendredi,lundi_formate:s==null?void 0:s.lundi_formate,vendredi_formate:s==null?void 0:s.vendredi_formate,titre:`${s==null?void 0:s.lundi_formate} à ${s==null?void 0:s.vendredi_formate}`},alertes:i.results||[]})}catch(s){return console.error("❌ Erreur récupération alertes semaine:",s),t.json({success:!1,error:s.message,alertes:[]})}});p.get("/api/controleur/alertes/archives",async t=>{var r,s;try{const i=await t.env.DB.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 5000
    `).all();return console.log(`📚 Archives récupérées: ${((r=i.results)==null?void 0:r.length)||0}`),t.json({success:!0,count:((s=i.results)==null?void 0:s.length)||0,alertes:i.results||[]})}catch(i){return console.error("❌ Erreur récupération archives:",i),t.json({success:!1,error:i.message,count:null,alertes:[]})}});p.post("/api/controleur/alertes/sync",async t=>{var r,s;try{console.log("🔄 SYNCHRONISATION ALERTES MANQUANTES DÉMARRÉE");const i=await t.env.DB.prepare(`
      SELECT 
        fd.id,
        fd.quai_numero,
    ...
    `).all();console.log(`📊 Déchargements sans alerte: ${((r=i.results)==null?void 0:r.length)||0}`);let a=0;const n=[];for(const l of i.results||[])try{let o="INCONNU",c="INCONNU";try{const u=JSON.parse(l.remarques||"{}");o=u.numero_id||"INCONNU",c=u.fournisseur||"INCONNU"}catch{console.warn("⚠️ Impossible de parser remarques pour déchargement",l.id)}const d=await t.env.DB.prepare(`
        ...
        `).bind(l.quai_numero,o,c,l.timestamp,parseInt(l.palettes_attendues),parseInt(l.palettes_recues),l.problemes||"[]").run();a++,n.push(d.meta.last_row_id),console.log(`✅ Alerte créée - ID: ${d.meta.last_row_id}, Quai: ${l.quai_numero}, Déchargement: ${l.id}`)}catch(o){console.error(`❌ Erreur création alerte pour déchargement ${l.id}:`,o.message)}return console.log(`✅ SYNCHRONISATION TERMINÉE - ${a} alerte(s) créée(s)`),t.json({success:!0,message:`Synchronisation réussie - ${a} alerte(s) créée(s)`,dechargements_analyses:((s=i.results)==null?void 0:s.length)||0,alertes_creees:a,alertes_ids:n})}catch(i){return console.error("❌ Erreur synchronisation alertes:",i),t.json({success:!1,error:i.message},500)}});p.put("/api/controleur/alertes/:id",async t=>{try{const r=t.req.param("id"),s=await t.req.json();if(console.log("📝 Traitement alerte:",r,s),!s.traite_par||!s.consignes)return t.json({success:!1,error:"Contrôleur et consignes requis"},400);const i=await t.env.DB.prepare(`
    ...
    `).bind(r).first();let a=null;if(i!=null&&i.quai_numero){const n=await t.env.DB.prepare(`
      ...
      WHERE id = ?
    `).bind(s.consignes,s.traite_par,a,r).run(),console.log("✅ Alerte",r,"traitée par",s.traite_par,"avec durée contrôle:",a,"s"),t.json({success:!0,message:"Alerte traitée avec succès"})}catch(r){return console.error("❌ Erreur traitement alerte:",r),t.json({success:!1,error:r.message},500)}});p.post("/api/fix-timers-db",async t=>{try{console.log("🔧 Correction des timers dans la base de données...");const r=await t.env.DB.prepare(`
      UPDATE quai_status 
    ...
    `).run();console.log(`✅ timer_duration corrigés: ${r.meta.changes} lignes`);const s=await t.env.DB.prepare(`
      UPDATE quai_status 
    ...
    `).run();console.log(`✅ timer_controle_duration corrigés: ${s.meta.changes} lignes`);const{results:i}=await t.env.DB.prepare(`
    ...
    `).all();return t.json({success:!0,message:"Correction terminée",corrections:{timer_duration:r.meta.changes,timer_controle_duration:s.meta.changes},quais_corriges:i})}catch(r){return console.error("❌ Erreur correction timers:",r),t.json({success:!1,error:r.message},500)}});p.get("/api/quais",async t=>{try{const{results:r}=await t.env.DB.prepare(`
    ...
    `).bind(r.quai_numero,r.nom_agent,r.palettes_attendues,r.palettes_recues,r.palettes_a_rendre,a,r.autres_commentaire||null,i).run();console.log("✅ Fin de déchargement enregistrée - ID:",n.meta.last_row_id);let l=null,o=null;try{const u=await t.env.DB.prepare(`
        SELECT timer_start, timer_fin_timestamp FROM quai_status WHERE quai_numero = ?
      `).bind(r.quai_numero).first();if(console.log("📊 Quai data AVANT UPDATE:",u),l=u==null?void 0:u.timer_start,u!=null&&u.timer_start){const h=new Date(u.timer_start.replace(" ","T")+"Z").getTime(),f=new Date(Ur()).getTime();o=Math.floor((f-h)/1e3),console.log(`⏱️ Durée déchargement calculée: ${o}s`)}console.log("💾 UPDATE avec:",{timerDuration:o,commentaire:`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,commentaire_auteur:r.nom_agent,quai_numero:r.quai_numero}),await t.env.DB.prepare(`
        UPDATE quai_status 
        SET statut = 'fin_dechargement',
            ...
            updated_at = datetime('now', 'localtime')
        WHERE quai_numero = ?
      `).bind(o,`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme fin de déchargement - Timer figé à",o,"secondes (timer_start supprimé)")}catch(u){console.warn("⚠️ Contrainte CHECK - Fallback vers disponible:",u.message),await t.env.DB.prepare(`
        UPDATE quai_status 
        SET statut = 'disponible',
            ...
            updated_at = datetime('now', 'localtime')
        WHERE quai_numero = ?
      `).bind(`✅ Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id} - Timer: voir historique`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme disponible (fallback) - Timer conservé dans commentaire")}let c=!1,d=null;try{console.log("🔍 Vérification alerte - Données reçues:",{palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,problemes:r.problemes});const u=parseInt(r.palettes_attendues)!==parseInt(r.palettes_recues);console.log("📊 Écart palettes:",u,`(${r.palettes_attendues} vs ${r.palettes_recues})`);const h=r.problemes||[],f=h.length>0;console.log("⚠️ Problèmes cochés:",f,"Nombre:",h.length);const b=r.verification_points||{},x=Object.values(b).filter(w=>w==="non_conforme"),v=x.length>0;console.log("❌ Points non conformes:",v,"Nombre:",x.length);const g=f||v;console.log("🚨 Nécessite attention contrôleur:",g),console.log("📊 CRÉATION ALERTE KPI - Tous les camions sont enregistrés"),console.log("   Quai:",r.quai_numero),console.log("   ID:",r.numero_id),console.log("   Fournisseur:",r.fournisseur);{const w=new Date().toISOString().slice(0,19).replace("T"," ");console.log("⏰ Utilisation timer_start sauvegardé:",l),console.log("⏰ timer_fin_timestamp (NOW):",w),await t.env.DB.prepare(`
        ...
        `).run(),console.log("✅ Table controleur_alertes vérifiée");let T="";u&&(T=`Écart palettes: Attendues ${r.palettes_attendues}, Reçues ${r.palettes_recues}`);const C=JSON.stringify(h);console.log("📝 Non-conformités (problèmes):",C);const k=JSON.stringify(r.verification_points||{});console.log("📝 Points de vérification:",k);const A=u||g?"en_attente":"traitee";console.log("📊 Statut alerte:",A,"(Problèmes:",u||g,")"),console.log("⏱️ Durée déchargement:",o,"secondes"),console.log("🚀 INSERTION ALERTE EN COURS - Données finales:",{quai_numero:r.quai_numero,numero_id:r.numero_id,fournisseur:r.fournisseur,timer_start:l||"NULL",timer_duration:o||0,palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,statut:A,ecartPalettes:u,aDesNonConformites:g});const re=await t.env.DB.prepare(`
          INSERT INTO controleur_alertes (
        ...
        SET statut = ?, 
            ...
            updated_at = datetime('now', 'localtime')
        WHERE quai_numero = ?
      `).bind(s,r).run();else if(s==="disponible"){const o=await t.env.DB.prepare(`
        SELECT * FROM quai_status WHERE quai_numero = ?
      `).bind(r).first();o&&o.statut==="fin_controle"&&(console.log(`📦 Archivage historique Quai ${r} avant remise en disponible`),await t.env.DB.prepare(`
        ...
        `).bind(o.quai_numero,o.statut,o.timer_start,o.timer_duration,o.timer_controle_start,o.timer_controle_duration,o.controle_debut_timestamp,o.controle_fin_timestamp,o.controle_fournisseur,o.controle_id_chauffeur,o.controleur_nom,o.commentaire,o.commentaire_auteur,o.updated_at).run(),console.log(`✅ Quai ${r} archivé dans quai_historique`)),await t.env.DB.prepare(`
        UPDATE quai_status 
        SET statut = ?, 
            timer_start = NULL,
            timer_duration = NULL,
            ...
            updated_at = datetime('now', 'localtime')
        WHERE quai_numero = ?
      `).bind(s,r).run()}else await t.env.DB.prepare(`
        UPDATE quai_status 
        SET statut = ?, 
            timer_start = NULL,
            commentaire = ?, 
    ...
    `).bind(i||null,r).run(),console.log(`✅ Improductivité ${r} validée`),t.json({success:!0,message:"Improductivité validée et transmise"})}catch(r){return console.error("❌ Erreur validation improductivité:",r),t.json({success:!1,error:r.message},500)}});p.get("/api/improductivites/utilisateur/:nom",async t=>{try{const r=t.req.param("nom");if(!r)return t.json({success:!1,error:"Nom requis"},400);const{results:s}=await t.env.DB.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 100
    `).bind(r).all();return t.json({success:!0,improductivites:s})}catch(r){return console.error("❌ Erreur récupération improductivités utilisateur:",r),t.json({success:!0,improductivites:[]})}});p.get("/api/chef-equipe/kpi/reception-camion",async t=>{var r,s;try{const i=t.req.query("date");await t.env.DB.prepare(`
      CREATE TABLE IF NOT EXISTS quai_historique (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        quai_numero INTEGER NOT NULL,
        statut TEXT NOT NULL,
    ...
    `;const n=[];i?(a+=" AND DATE(updated_at) = ?",n.push(i)):a+=' AND DATE(updated_at) = DATE("now")';const l=await t.env.DB.prepare(a).bind(...n).all();let o=`
      SELECT 
        id,
        quai_numero,
        statut,
      ...
      WHERE statut = 'fin_controle'
    `;const c=[];i?(o+=" AND DATE(archived_at) = ?",c.push(i)):o+=' AND DATE(archived_at) = DATE("now")',o+=" ORDER BY archived_at DESC LIMIT 200";const d=await t.env.DB.prepare(o).bind(...c).all(),u=[...l.results||[],...d.results||[]];console.log(`📊✅ KPI: ${((r=l.results)==null?void 0:r.length)||0} quais actuels + ${((s=d.results)==null?void 0:s.length)||0} quais archivés = ${u.length} total pour ${i||"aujourd'hui"}`);const h=u.map(g=>({...g,quai_numero:g.quai_numero})),f=h.length;let b=0,x=0;h.forEach(g=>{g.timer_duration&&(b+=g.timer_duration),g.timer_controle_duration&&(x+=g.timer_controle_duration)});const v={total_camions:f,dechargement_minutes:f>0?Math.round(b/f/60):0,controle_minutes:f>0?Math.round(x/f/60):0};return console.log("📊✅ Moyennes:",v),t.json({success:!0,quais:h,moyennes:v,date:i||new Date().toISOString().split("T")[0]})}catch(i){return console.error("❌ Erreur chargement KPI:",i),t.json({success:!1,error:i.message},500)}});const Zt=new Nr,ea=Object.assign({"/src/index.tsx":p});let Br=!1;for(const[,t]of Object.entries(ea))t&&(Zt.route("/",t),Zt.notFound(t.notFoundHandler),Br=!0);if(!Br)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Zt as default};
