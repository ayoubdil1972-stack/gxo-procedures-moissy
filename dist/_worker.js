var $r=Object.defineProperty;var Ft=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?$r(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var v=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),lt=(t,r,s)=>r.has(t)||Ft("Cannot "+s);var u=(t,r,s)=>(lt(t,r,"read from private field"),s?s.call(t):r.get(t)),k=(t,r,s)=>r.has(t)?Ft("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),w=(t,r,s,i)=>(lt(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),T=(t,r,s)=>(lt(t,r,"access private method"),s);var jt=(t,r,s,i)=>({set _(a){w(t,r,a,s)},get _(){return u(t,r,i)}});var ir={Stringify:1},O=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Hr=/[&<>'"]/,ar=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];te(n,o),s=o[0]}}return O(s,r)},te=(t,r)=>{const s=t.search(Hr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},nr=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ir.Stringify,buffer:s,context:i})),s[0]},or=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>or(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Gr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")te(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):te(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?O(nr(O(s[0],s.callbacks))):O(s[0]):ar(s,s.callbacks)},Ct=Symbol("RENDERER"),xt=Symbol("ERROR_HANDLER"),_=Symbol("STASH"),lr=Symbol("INTERNAL"),Qr=Symbol("MEMO"),rt=Symbol("PERMALINK"),Dt=t=>(t[lr]=!0,t),cr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:Dt(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:Dt(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[xt]=n=>{throw t.pop(),n},a},dr=t=>{const r=[t],s=cr(r);return s.values=r,s.Provider=s,Ee.push(s),s},Ee=[],Tt=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new fr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>O(n,n.callbacks)):O(a)};return s.values=r,s.Provider=s,s[Ct]=cr(r),Ee.push(s),s},Ce=t=>t.values.at(-1),We={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},vt={},Xe="data-precedence",Be=t=>Array.isArray(t)?t:[t],Pt=new WeakMap,Nt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=Pt.get(n)||{};Pt.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=We[t];if(d.length>0){e:for(const[,m]of o)for(const h of d)if(((m==null?void 0:m[h])??null)===(s==null?void 0:s[h])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let m;if(i===void 0)m=o.map(([h])=>h);else{const h=[];m=o.map(([f,,p])=>{let x=h.indexOf(p);return x===-1&&(h.push(p),x=h.length-1),[f,x]}).sort((f,p)=>f[1]-p[1]).map(([f])=>f)}m.forEach(h=>{a[0]=a[0].replaceAll(h,"")}),a[0]=a[0].replace(/(?=<\/head>)/,m.join(""))}},ze=(t,r,s)=>O(new B(t,s,Be(r??[])).toString()),Ue=(t,r,s,i)=>{if("itemProp"in s)return ze(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[Xe]=a);const o=new B(t,l,Be(r||[])).toString();return o instanceof Promise?o.then(c=>O(o,[...c.callbacks||[],Nt(t,c,l,a)])):O(o,[Nt(t,o,l,a)])},Wr=({children:t,...r})=>{const s=At();if(s){const i=Ce(s);if(i==="svg"||i==="head")return new B("title",r,Be(t??[]))}return Ue("title",t,r,!1)},Xr=({children:t,...r})=>{const s=At();return["src","async"].some(i=>!r[i])||s&&Ce(s)==="head"?ze("script",t,r):Ue("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,Ue("style",t,r,!0)):ze("style",t,r),Yr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?ze("link",t,r):Ue("link",t,r,"precedence"in r),Jr=({children:t,...r})=>{const s=At();return s&&Ce(s)==="head"?ze("meta",t,r):Ue("meta",t,r,!1)},ur=(t,{children:r,...s})=>new B(t,s,Be(r??[])),Kr=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),ur("form",t)),mr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),ur(t,r)),es=t=>mr("input",t),ts=t=>mr("button",t);const ct=Object.freeze(Object.defineProperty({__proto__:null,button:ts,form:Kr,input:es,link:Yr,meta:Jr,script:Xr,style:Zr,title:Wr},Symbol.toStringTag,{value:"Module"}));var rs=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>rs.get(t)||t,hr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Fe=void 0,At=()=>Fe,ss=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,is=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],as=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],qt=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")te(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof B?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):qt(a,r)}}},B=class{constructor(t,r,s){v(this,"tag");v(this,"props");v(this,"key");v(this,"children");v(this,"isEscaped",!0);v(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?nr(O(t[0],t.callbacks)).toString():t[0]:ar(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=Fe&&Ce(Fe)==="svg"?n=>ss(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";hr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',te(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,te(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&as.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[O(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,te(l.toString(),t),t[0]+='"'}if(is.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",qt(i,t),t[0]+=`</${r}>`}},dt=class extends B{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ee.length===0)t.unshift("",i);else{const a=Ee.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof B&&(n.localContexts=a),n)))}else i instanceof B?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},fr=class extends B{toStringToBuffer(t){qt(this.children,t)}},Ot=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ze(t,r,s);return a.key=i,a},Mt=!1,Ze=(t,r,s)=>{if(!Mt){for(const i in vt)ct[i][Ct]=vt[i];Mt=!0}return typeof t=="function"?new dt(t,r,s):ct[t]?new dt(ct[t],r,s):t==="svg"||t==="head"?(Fe||(Fe=Tt("")),new B(t,r,[new dt(Fe,{value:t},s)])):new B(t,r,s)},ns=({children:t})=>new fr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ze(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ze(t,r,a):Ze(t,r,[a])}return i.key=s,i}var Lt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,m;if(t[o]?(m=t[o][0][0],i.req.routeIndex=o):m=o===t.length&&a||void 0,m)try{c=await m(i,()=>l(o+1))}catch(h){if(h instanceof Error&&r)i.error=h,c=await r(h,i),d=!0;else throw h}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},os=Symbol(),ls=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof yr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?cs(t,{all:s,dot:i}):{}};async function cs(t,r){const s=await t.formData();return s?ds(s,r):{}}function ds(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?us(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(ms(s,i,a),delete s[i])}),s}var us=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},ms=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},gr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},hs=t=>{const{groups:r,path:s}=fs(t),i=gr(s);return gs(i,r)},fs=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},ps=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},St=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},bs=t=>St(t,decodeURI),pr=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return bs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},xs=t=>{const r=pr(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},me=(t,r,...s)=>(s.length&&(r=me(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),br=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},ut=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?St(t,vr):t):t,xr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return ut(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=ut(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=ut(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},vs=xr,ys=(t,r)=>xr(t,r,!0),vr=decodeURIComponent,It=t=>St(t,vr),ge,N,Q,wr,Er,yt,X,Jt,yr=(Jt=class{constructor(t,r="/",s=[[]]){k(this,Q);v(this,"raw");k(this,ge);k(this,N);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});k(this,X,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,w(this,N,s),w(this,ge,{})}param(t){return t?T(this,Q,wr).call(this,t):T(this,Q,Er).call(this)}query(t){return vs(this.url,t)}queries(t){return ys(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await ls(this,t))}json(){return u(this,X).call(this,"text").then(t=>JSON.parse(t))}text(){return u(this,X).call(this,"text")}arrayBuffer(){return u(this,X).call(this,"arrayBuffer")}blob(){return u(this,X).call(this,"blob")}formData(){return u(this,X).call(this,"formData")}addValidatedData(t,r){u(this,ge)[t]=r}valid(t){return u(this,ge)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[os](){return u(this,N)}get matchedRoutes(){return u(this,N)[0].map(([[,t]])=>t)}get routePath(){return u(this,N)[0].map(([[,t]])=>t)[this.routeIndex].path}},ge=new WeakMap,N=new WeakMap,Q=new WeakSet,wr=function(t){const r=u(this,N)[0][this.routeIndex][1][t],s=T(this,Q,yt).call(this,r);return s&&/\%/.test(s)?It(s):s},Er=function(){const t={},r=Object.keys(u(this,N)[0][this.routeIndex][1]);for(const s of r){const i=T(this,Q,yt).call(this,u(this,N)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?It(i):i)}return t},yt=function(t){return u(this,N)[1]?u(this,N)[1][t]:t},X=new WeakMap,Jt),ws="text/plain; charset=UTF-8",mt=(t,r)=>({"Content-Type":t,...r}),Pe,Ne,$,pe,V,P,Oe,be,xe,ie,Me,Le,Z,he,Kt,Es=(Kt=class{constructor(t,r){k(this,Z);k(this,Pe);k(this,Ne);v(this,"env",{});k(this,$);v(this,"finalized",!1);v(this,"error");k(this,pe);k(this,V);k(this,P);k(this,Oe);k(this,be);k(this,xe);k(this,ie);k(this,Me);k(this,Le);v(this,"render",(...t)=>(u(this,be)??w(this,be,r=>this.html(r)),u(this,be).call(this,...t)));v(this,"setLayout",t=>w(this,Oe,t));v(this,"getLayout",()=>u(this,Oe));v(this,"setRenderer",t=>{w(this,be,t)});v(this,"header",(t,r,s)=>{this.finalized&&w(this,P,new Response(u(this,P).body,u(this,P)));const i=u(this,P)?u(this,P).headers:u(this,ie)??w(this,ie,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});v(this,"status",t=>{w(this,pe,t)});v(this,"set",(t,r)=>{u(this,$)??w(this,$,new Map),u(this,$).set(t,r)});v(this,"get",t=>u(this,$)?u(this,$).get(t):void 0);v(this,"newResponse",(...t)=>T(this,Z,he).call(this,...t));v(this,"body",(t,r,s)=>T(this,Z,he).call(this,t,r,s));v(this,"text",(t,r,s)=>!u(this,ie)&&!u(this,pe)&&!r&&!s&&!this.finalized?new Response(t):T(this,Z,he).call(this,t,r,mt(ws,s)));v(this,"json",(t,r,s)=>T(this,Z,he).call(this,JSON.stringify(t),r,mt("application/json",s)));v(this,"html",(t,r,s)=>{const i=a=>T(this,Z,he).call(this,a,r,mt("text/html; charset=UTF-8",s));return typeof t=="object"?or(t,ir.Stringify,!1,{}).then(i):i(t)});v(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});v(this,"notFound",()=>(u(this,xe)??w(this,xe,()=>new Response),u(this,xe).call(this,this)));w(this,Pe,t),r&&(w(this,V,r.executionCtx),this.env=r.env,w(this,xe,r.notFoundHandler),w(this,Le,r.path),w(this,Me,r.matchResult))}get req(){return u(this,Ne)??w(this,Ne,new yr(u(this,Pe),u(this,Le),u(this,Me))),u(this,Ne)}get event(){if(u(this,V)&&"respondWith"in u(this,V))return u(this,V);throw Error("This context has no FetchEvent")}get executionCtx(){if(u(this,V))return u(this,V);throw Error("This context has no ExecutionContext")}get res(){return u(this,P)||w(this,P,new Response(null,{headers:u(this,ie)??w(this,ie,new Headers)}))}set res(t){if(u(this,P)&&t){t=new Response(t.body,t);for(const[r,s]of u(this,P).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=u(this,P).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}w(this,P,t),this.finalized=!0}get var(){return u(this,$)?Object.fromEntries(u(this,$)):{}}},Pe=new WeakMap,Ne=new WeakMap,$=new WeakMap,pe=new WeakMap,V=new WeakMap,P=new WeakMap,Oe=new WeakMap,be=new WeakMap,xe=new WeakMap,ie=new WeakMap,Me=new WeakMap,Le=new WeakMap,Z=new WeakSet,he=function(t,r,s){const i=u(this,P)?new Headers(u(this,P).headers):u(this,ie)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??u(this,pe);return new Response(t,{status:a,headers:i})},Kt),R="ALL",ks="all",Cs=["get","post","put","delete","options","patch"],kr="Can not add a route since the matcher is already built.",Cr=class extends Error{},Ts="__COMPOSED_HANDLER",As=t=>t.text("404 Not Found",404),Bt=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},M,F,Tr,L,re,Ye,Je,ve,qs=(ve=class{constructor(r={}){k(this,F);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");k(this,M,"/");v(this,"routes",[]);k(this,L,As);v(this,"errorHandler",Bt);v(this,"onError",r=>(this.errorHandler=r,this));v(this,"notFound",r=>(w(this,L,r),this));v(this,"fetch",(r,...s)=>T(this,F,Je).call(this,r,s[1],s[0],r.method));v(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${me("/",r)}`,s),i,a)));v(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(T(this,F,Je).call(this,r.request,r,void 0,r.request.method))})});[...Cs,ks].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?w(this,M,l):T(this,F,re).call(this,n,u(this,M),l),o.forEach(c=>{T(this,F,re).call(this,n,u(this,M),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){w(this,M,c);for(const d of[n].flat())o.map(m=>{T(this,F,re).call(this,d.toUpperCase(),u(this,M),m)})}return this},this.use=(n,...l)=>(typeof n=="string"?w(this,M,n):(w(this,M,"*"),l.unshift(n)),l.forEach(o=>{T(this,F,re).call(this,R,u(this,M),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??pr:xs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===Bt?n=a.handler:(n=async(o,c)=>(await Lt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[Ts]=a.handler),T(l=i,F,re).call(l,a.method,a.path,n)}),this}basePath(r){const s=T(this,F,Tr).call(this);return s._basePath=me(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=me(this._basePath,r),d=c==="/"?0:c.length;return m=>{const h=new URL(m.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,m)}})());const o=async(c,d)=>{const m=await s(a(c.req.raw),...l(c));if(m)return m;await d()};return T(this,F,re).call(this,R,me(r,"*"),o),this}},M=new WeakMap,F=new WeakSet,Tr=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,w(r,L,u(this,L)),r.routes=this.routes,r},L=new WeakMap,re=function(r,s,i){r=r.toUpperCase(),s=me(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ye=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await T(this,F,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new Es(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:u(this,L)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await u(this,L).call(this,o)})}catch(m){return T(this,F,Ye).call(this,m,o)}return d instanceof Promise?d.then(m=>m||(o.finalized?o.res:u(this,L).call(this,o))).catch(m=>T(this,F,Ye).call(this,m,o)):d??u(this,L).call(this,o)}const c=Lt(l[0],this.errorHandler,u(this,L));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return T(this,F,Ye).call(this,d,o)}})()},ve),Ar=[];function Ss(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[R],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],Ar];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",_e=".*",Re="(?:|/.*)",fe=Symbol(),_s=new Set(".\\+*[^]$()");function Rs(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===_e||t===Re?1:r===_e||r===Re?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ae,ne,I,ce,Fs=(ce=class{constructor(){k(this,ae);k(this,ne);k(this,I,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(u(this,ae)!==void 0)throw fe;if(n)return;w(this,ae,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",_e]:["","",it]:l==="/*"?["","",Re]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const m=c[1];let h=c[2]||it;if(m&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw fe;if(d=u(this,I)[h],!d){if(Object.keys(u(this,I)).some(f=>f!==_e&&f!==Re))throw fe;if(n)return;d=u(this,I)[h]=new ce,m!==""&&w(d,ne,a.varIndex++)}!n&&m!==""&&i.push([m,u(d,ne)])}else if(d=u(this,I)[l],!d){if(Object.keys(u(this,I)).some(m=>m.length>1&&m!==_e&&m!==Re))throw fe;if(n)return;d=u(this,I)[l]=new ce}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(u(this,I)).sort(Rs).map(i=>{const a=u(this,I)[i];return(typeof u(a,ne)=="number"?`(${i})@${u(a,ne)}`:_s.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof u(this,ae)=="number"&&s.unshift(`#${u(this,ae)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ae=new WeakMap,ne=new WeakMap,I=new WeakMap,ce),at,Ie,er,js=(er=class{constructor(){k(this,at,{varIndex:0});k(this,Ie,new Fs)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return u(this,Ie).insert(n,r,i,u(this,at),s),i}buildRegExp(){let t=u(this,Ie).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},at=new WeakMap,Ie=new WeakMap,er),Ds=[/^$/,[],Object.create(null)],Ke=Object.create(null);function qr(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ps(){Ke=Object.create(null)}function Ns(t){var d;const r=new js,s=[];if(t.length===0)return Ds;const i=t.map(m=>[!/\*|\/:/.test(m[0]),...m]).sort(([m,h],[f,p])=>m?1:f?-1:h.length-p.length),a=Object.create(null);for(let m=0,h=-1,f=i.length;m<f;m++){const[p,x,y]=i[m];p?a[x]=[y.map(([E])=>[E,Object.create(null)]),Ar]:h++;let b;try{b=r.insert(x,h,p)}catch(E){throw E===fe?new Cr(x):E}p||(s[h]=y.map(([E,C])=>{const q=Object.create(null);for(C-=1;C>=0;C--){const[A,S]=b[C];q[A]=S}return[E,q]}))}const[n,l,o]=r.buildRegExp();for(let m=0,h=s.length;m<h;m++)for(let f=0,p=s[m].length;f<p;f++){const x=(d=s[m][f])==null?void 0:d[1];if(!x)continue;const y=Object.keys(x);for(let b=0,E=y.length;b<E;b++)x[y[b]]=o[x[y[b]]]}const c=[];for(const m in l)c[m]=s[l[m]];return[n,c,a]}function de(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(qr(s).test(r))return[...t[s]]}}var Y,J,nt,Sr,tr,Os=(tr=class{constructor(){k(this,nt);v(this,"name","RegExpRouter");k(this,Y);k(this,J);v(this,"match",Ss);w(this,Y,{[R]:Object.create(null)}),w(this,J,{[R]:Object.create(null)})}add(t,r,s){var o;const i=u(this,Y),a=u(this,J);if(!i||!a)throw new Error(kr);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[t][d]=[...c[R][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=qr(r);t===R?Object.keys(i).forEach(d=>{var m;(m=i[d])[r]||(m[r]=de(i[d],r)||de(i[R],r)||[])}):(o=i[t])[r]||(o[r]=de(i[t],r)||de(i[R],r)||[]),Object.keys(i).forEach(d=>{(t===R||t===d)&&Object.keys(i[d]).forEach(m=>{c.test(m)&&i[d][m].push([s,n])})}),Object.keys(a).forEach(d=>{(t===R||t===d)&&Object.keys(a[d]).forEach(m=>c.test(m)&&a[d][m].push([s,n]))});return}const l=br(r)||[r];for(let c=0,d=l.length;c<d;c++){const m=l[c];Object.keys(a).forEach(h=>{var f;(t===R||t===h)&&((f=a[h])[m]||(f[m]=[...de(i[h],m)||de(i[R],m)||[]]),a[h][m].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(u(this,J)).concat(Object.keys(u(this,Y))).forEach(r=>{t[r]||(t[r]=T(this,nt,Sr).call(this,r))}),w(this,Y,w(this,J,void 0)),Ps(),t}},Y=new WeakMap,J=new WeakMap,nt=new WeakSet,Sr=function(t){const r=[];let s=t===R;return[u(this,Y),u(this,J)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==R&&r.push(...Object.keys(i[R]).map(n=>[n,i[R][n]]))}),s?Ns(r):null},tr),K,H,rr,Ms=(rr=class{constructor(t){v(this,"name","SmartRouter");k(this,K,[]);k(this,H,[]);w(this,K,t.routers)}add(t,r,s){if(!u(this,H))throw new Error(kr);u(this,H).push([t,r,s])}match(t,r){if(!u(this,H))throw new Error("Fatal error");const s=u(this,K),i=u(this,H),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof Cr)continue;throw c}this.match=o.match.bind(o),w(this,K,[o]),w(this,H,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(u(this,H)||u(this,K).length!==1)throw new Error("No active router has been determined yet.");return u(this,K)[0]}},K=new WeakMap,H=new WeakMap,rr),qe=Object.create(null),ee,D,oe,ye,j,G,se,we,Ls=(we=class{constructor(r,s,i){k(this,G);k(this,ee);k(this,D);k(this,oe);k(this,ye,0);k(this,j,qe);if(w(this,D,i||Object.create(null)),w(this,ee,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},w(this,ee,[a])}w(this,oe,[])}insert(r,s,i){w(this,ye,++jt(this,ye)._);let a=this;const n=hs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],m=n[o+1],h=ps(d,m),f=Array.isArray(h)?h[0]:d;if(f in u(a,D)){a=u(a,D)[f],h&&l.push(h[1]);continue}u(a,D)[f]=new we,h&&(u(a,oe).push(h),l.push(h[1])),a=u(a,D)[f]}return u(a,ee).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:u(this,ye)}}),a}search(r,s){var c;const i=[];w(this,j,qe);let n=[this];const l=gr(s),o=[];for(let d=0,m=l.length;d<m;d++){const h=l[d],f=d===m-1,p=[];for(let x=0,y=n.length;x<y;x++){const b=n[x],E=u(b,D)[h];E&&(w(E,j,u(b,j)),f?(u(E,D)["*"]&&i.push(...T(this,G,se).call(this,u(E,D)["*"],r,u(b,j))),i.push(...T(this,G,se).call(this,E,r,u(b,j)))):p.push(E));for(let C=0,q=u(b,oe).length;C<q;C++){const A=u(b,oe)[C],S=u(b,j)===qe?{}:{...u(b,j)};if(A==="*"){const W=u(b,D)["*"];W&&(i.push(...T(this,G,se).call(this,W,r,u(b,j))),w(W,j,S),p.push(W));continue}const[Te,He,Ae]=A;if(!h&&!(Ae instanceof RegExp))continue;const z=u(b,D)[Te],Ur=l.slice(d).join("/");if(Ae instanceof RegExp){const W=Ae.exec(Ur);if(W){if(S[He]=W[0],i.push(...T(this,G,se).call(this,z,r,u(b,j),S)),Object.keys(u(z,D)).length){w(z,j,S);const ot=((c=W[0].match(/\//))==null?void 0:c.length)??0;(o[ot]||(o[ot]=[])).push(z)}continue}}(Ae===!0||Ae.test(h))&&(S[He]=h,f?(i.push(...T(this,G,se).call(this,z,r,S,u(b,j))),u(z,D)["*"]&&i.push(...T(this,G,se).call(this,u(z,D)["*"],r,S,u(b,j)))):(w(z,j,S),p.push(z)))}}n=p.concat(o.shift()??[])}return i.length>1&&i.sort((d,m)=>d.score-m.score),[i.map(({handler:d,params:m})=>[d,m])]}},ee=new WeakMap,D=new WeakMap,oe=new WeakMap,ye=new WeakMap,j=new WeakMap,G=new WeakSet,se=function(r,s,i,a){const n=[];for(let l=0,o=u(r,ee).length;l<o;l++){const c=u(r,ee)[l],d=c[s]||c[R],m={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==qe||a&&a!==qe))for(let h=0,f=d.possibleKeys.length;h<f;h++){const p=d.possibleKeys[h],x=m[d.score];d.params[p]=a!=null&&a[p]&&!x?a[p]:i[p]??(a==null?void 0:a[p]),m[d.score]=!0}}return n},we),le,sr,Is=(sr=class{constructor(){v(this,"name","TrieRouter");k(this,le);w(this,le,new Ls)}add(t,r,s){const i=br(r);if(i){for(let a=0,n=i.length;a<n;a++)u(this,le).insert(t,i[a],s);return}u(this,le).insert(t,r,s)}match(t,r){return u(this,le).search(t,r)}},le=new WeakMap,sr),_r=class extends qs{constructor(t={}){super(t),this.router=t.router??new Ms({routers:[new Os,new Is]})}},Bs=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,zt=(t,r=Us)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},zs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},Us=zs,$s=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Rr),Hs="index.html",Gs=t=>{const r=t.root??"./",s=t.path,i=t.join??$s;return async(a,n)=>{var m,h,f,p;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((m=t.onNotFound)==null?void 0:m.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Hs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const x=t.mimes&&zt(o,t.mimes)||zt(o);if(a.header("Content-Type",x||"application/octet-stream"),t.precompressed&&(!x||Bs.test(x))){const y=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(b=>b.trim()));for(const b of Vs){if(!y.has(b))continue;const E=await c(o+Rr[b],a);if(E){d=E,a.header("Content-Encoding",b),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((p=t.onNotFound)==null?void 0:p.call(t,o,a)),await n()}},Qs=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Ws=t=>async function(s,i){return Gs({...t,getContent:async n=>Qs(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Xs=t=>Ws(t),je="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Ys={svg:"2000/svg",math:"1998/Math/MathML"},De=[],wt=new WeakMap,ke=void 0,Js=()=>ke,U=t=>"t"in t,ht={onClick:["click",!1]},Ut=t=>{if(!t.startsWith("on"))return;if(ht[t])return ht[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ht[t]=[(Zs[s]||s).toLowerCase(),!!i]}},$t=(t,r)=>ke&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,Ks=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=Ut(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),wt.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&hr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=$t(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=Ut(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=wt.get(t))==null||i():t.removeAttribute($t(t,a))}}},ei=(t,r)=>{r[_][0]=0,De.push([t,r]);const s=r.tag[Ct]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{De.pop()}},Fr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[_][1][Nr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if(U(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Fr(o,r,s,i,a),o.s){for(let m=d;m<s.length;m++)s[m].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ti=t=>{for(;;t=t.tag===je||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==je&&t.e)return t.e}},jr=t=>{var r,s,i,a,n,l;U(t)||((s=(r=t[_])==null?void 0:r[1][Nr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=wt.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(jr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Se.delete(t),et.delete(t),delete t[_][3],t.a=!0)},Dr=(t,r,s)=>{t.c=r,Pr(t,r,s)},Vt=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Ht=Symbol(),Pr=(t,r,s)=>{var d;const i=[],a=[],n=[];Fr(t,r,i,a,n),a.forEach(jr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const m=Vt(l,ti(t.nN));m!==void 0?(c=l[m],o=m):o=Vt(l,(d=i.find(h=>h.tag!==je&&h.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let m=0,h=i.length;m<h;m++,o++){const f=i[m];let p;if(f.s&&f.e)p=f.e,f.s=!1;else{const x=s||!f.e;U(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,p=f.e||(f.e=document.createTextNode(f.t))):(p=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),Ks(p,f.props,f.pP),Pr(f,p,x))}f.tag===je?o--:s?p.parentNode||r.appendChild(p):l[o]!==p&&l[o-1]!==p&&(l[o+1]===p?r.appendChild(l[o]):r.insertBefore(p,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const m=[],h=[];n.forEach(([,f,,p,x])=>{f&&m.push(f),p&&h.push(p),x==null||x()}),m.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},ri=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Et=(t,r,s)=>{var n,l,o,c,d,m;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ei(t,r):Be(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][xt]&&(a=s[0][xt],t[5].push([t,a,r]));const h=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let p;for(let x=0;x<s.length;x++){Array.isArray(s[x])&&s.splice(x,1,...s[x].flat());let y=si(s[x]);if(y){typeof y.tag=="function"&&!y.tag[lr]&&(Ee.length>0&&(y[_][2]=Ee.map(E=>[E,E.values.at(-1)])),(l=t[5])!=null&&l.length&&(y[_][3]=t[5].at(-1)));let b;if(h&&h.length){const E=h.findIndex(U(y)?C=>U(C):y.key!==void 0?C=>C.key===y.key&&C.tag===y.tag:C=>C.tag===y.tag);E!==-1&&(b=h[E],h.splice(E,1))}if(b)if(U(y))b.t!==y.t&&(b.t=y.t,b.d=!0),y=b;else{const E=b.pP=b.props;if(b.props=y.props,b.f||(b.f=y.f||r.f),typeof y.tag=="function"){const C=b[_][2];b[_][2]=y[_][2]||[],b[_][3]=y[_][3],!b.f&&((b.o||b)===y.o||(c=(o=b.tag)[Qr])!=null&&c.call(o,E,b.props))&&ri(C,b[_][2])&&(b.s=!0)}y=b}else if(!U(y)&&ke){const E=Ce(ke);E&&(y.n=E)}if(!U(y)&&!y.s&&(Et(t,y),delete y.f),f.push(y),p&&!p.s&&!y.s)for(let E=p;E&&!U(E);E=(d=E.vC)==null?void 0:d.at(-1))E.nN=y;p=y}}r.vR=i?[...r.vC,...h||[]]:h||[],r.vC=f,i&&delete r.pC}catch(h){if(r.f=!0,h===Ht){if(a)return;throw h}const[f,p,x]=((m=r[_])==null?void 0:m[3])||[];if(p){const y=()=>tt([0,!1,t[2]],x),b=et.get(x)||[];b.push(y),et.set(x,b);const E=p(h,()=>{const C=et.get(x);if(C){const q=C.indexOf(y);if(q!==-1)return C.splice(q,1),y()}});if(E){if(t[0]===1)t[1]=!0;else if(Et(t,x,[E]),(p.length===1||t!==f)&&x.c){Dr(x,x.c,!1);return}throw Ht}}throw h}finally{a&&t[5].pop()}},si=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[_]=[0,[]];else{const r=Ys[t.tag];r&&(ke||(ke=dr("")),t.props.children=[{tag:ke,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Gt=(t,r)=>{var s,i;(s=r[_][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Et(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[_][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&Dr(r,r.c,!1)},Se=new WeakMap,Qt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Se.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Se.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Gt(n,r)}).then(()=>i(r)):(Gt(t,r),i(r))}]),Qt.length)Qt.at(-1).add(r);else{await Promise.resolve();const n=Se.get(r);n&&(Se.delete(r),n[1]())}return a},ii=(t,r,s)=>({tag:je,props:{children:t},key:s,e:r,p:1}),ft=0,Nr=1,gt=2,pt=3,bt=new WeakMap,Or=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ai=void 0,Wt=[],ni=t=>{var l;const r=()=>typeof t=="function"?t():t,s=De.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[_][1])[ft]||(l[ft]=[]),n=i[_][0]++;return a[n]||(a[n]=[r(),o=>{const c=ai,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Wt.length){const[m,h]=Wt.at(-1);Promise.all([m===3?i:tt([m,!1,c],i),h]).then(([f])=>{if(!f||!(m===2||m===3))return;const p=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{p===f.vC&&tt([m===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},_t=(t,r)=>{var o;const s=De.at(-1);if(!s)return t;const[,i]=s,a=(o=i[_][1])[gt]||(o[gt]=[]),n=i[_][0]++,l=a[n];return Or(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},oi=t=>{const r=bt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>bt.set(t,[s]),s=>bt.set(t,[void 0,s])),t},li=(t,r)=>{var o;const s=De.at(-1);if(!s)return t();const[,i]=s,a=(o=i[_][1])[pt]||(o[pt]=[]),n=i[_][0]++,l=a[n];return Or(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},ci=dr({pending:!1,data:null,method:null,action:null}),Xt=new Set,di=t=>{Xt.add(t),t.finally(()=>Xt.delete(t))},Rt=(t,r)=>li(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),ue=Object.create(null),Qe=Object.create(null),$e=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...m}=r,h=null,f=!1;const p=We[t];let x;if(p.length>0){const C=n.querySelectorAll(t);e:for(const q of C)for(const A of We[t])if(q.getAttribute(A)===r[A]){h=q;break e}if(!h){const q=p.reduce((A,S)=>r[S]===void 0?A:`${A}-${S}-${r[S]}`,t);f=!Qe[q],h=Qe[q]||(Qe[q]=(()=>{const A=document.createElement(t);for(const S of p)r[S]!==void 0&&A.setAttribute(S,r[S]),r.rel&&A.setAttribute("rel",r.rel);return A})())}}else x=n.querySelectorAll(t);c=i?c??"":void 0,i&&(m[Xe]=c);const y=_t(C=>{if(p.length>0){let q=!1;for(const A of n.querySelectorAll(t)){if(q&&A.getAttribute(Xe)!==c){n.insertBefore(C,A);return}A.getAttribute(Xe)===c&&(q=!0)}n.appendChild(C)}else if(x){let q=!1;for(const A of x)if(A===C){q=!0;break}q||n.insertBefore(C,n.contains(x[0])?x[0]:n.querySelector(t)),x=void 0}},[c]),b=Rt(r.ref,C=>{var S;const q=p[0];if(s===2&&(C.innerHTML=""),(f||x)&&y(C),!o&&!l)return;let A=ue[S=C.getAttribute(q)]||(ue[S]=new Promise((Te,He)=>{C.addEventListener("load",Te),C.addEventListener("error",He)}));l&&(A=A.then(l)),o&&(A=A.catch(o)),A.catch(()=>{})});if(a&&d==="render"){const C=We[t][0];if(r[C]){const q=r[C],A=ue[q]||(ue[q]=new Promise((S,Te)=>{y(h),h.addEventListener("load",S),h.addEventListener("error",Te)}));oi(A)}}const E={tag:t,type:t,props:{...m,ref:b},ref:b};return E.p=s,h&&(E.e=h),ii(E,n)},ui=t=>{const r=Js(),s=r&&Ce(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:$e("title",t,void 0,!1,!1)},mi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:$e("script",t,1,!1,!0),hi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,$e("style",t,2,!0,!0)),fi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:$e("link",t,1,"precedence"in t,!0),gi=t=>$e("meta",t,void 0,!1,!1),Mr=Symbol(),pi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=ni([null,!1]),n=_t(async d=>{const m=d.isTrusted?r:d.detail[Mr];if(typeof m!="function")return;d.preventDefault();const h=new FormData(d.target);a([h,!0]);const f=m(h);f instanceof Promise&&(di(f),await f),a([null,!0])},[]),l=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:ci,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Lr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=_t(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Mr]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},bi=t=>Lr("input",t),xi=t=>Lr("button",t);Object.assign(vt,{title:ui,script:mi,style:hi,link:fi,meta:gi,form:pi,input:bi,button:xi});Tt(null);new TextEncoder;var vi=Tt(null),yi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Ot(d=>s(d,t),{Layout:r,...n},a):a,c=Gr`${O(l)}${Ot(vi.Provider,{value:t},o)}`;return t.html(c)},Ir=(t,r)=>function(i,a){const n=i.getLayout()??ns;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(yi(i,n,t)),a()};const wi=Ir(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
        ...
        `}})]})]})),Ve=Ir(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"Connexion - GXO Logistics Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
          // Désactiver l'avertissement Tailwind CDN
          const originalWarn = console.warn;
          console.warn = function(...args) {
            if (args[0] && args[0].includes && args[0].includes('cdn.tailwindcss.com')) return;
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Ui(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:l}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a,n,l||"fr").run()).meta.last_row_id;return t.json({success:!0,id:c,message:"Inscription réussie"})}catch(r){return console.error("Erreur inscription chauffeur:",r),t.json({error:"Erreur lors de l'inscription"},500)}}async function $i(t){try{const r=t.req.param("id"),s=await t.env.DB.prepare(`
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const g=new _r;g.use("/static/*",Xs({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));g.get("/login",Ve,t=>t.render(e(ji,{})));g.get("/qrcode-chauffeur",Ve,t=>t.render(e(Di,{})));g.get("/chauffeur/langue",Ve,t=>t.render(e(Pi,{})));g.get("/gestion-quais",Ve,t=>t.render(e(Ii,{})));g.get("/pdf-barcodes",t=>t.html(Bi()));g.get("/qrcode-generator",t=>t.html(zi()));g.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
  ...
  `):t.html(`
    ...
    `)});g.get("/scan-fin-dechargement",t=>{const r=t.req.query("quai");if(!r)return t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
  ...
  `)});g.get("/scan-controle",async t=>{const r=t.req.query("quai");if(!r)return t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
    ...
    `);try{return await t.env.DB.prepare(`
      UPDATE quai_status 
      ...
      WHERE quai_numero = ?
    `).bind(r).run(),console.log(`✅ Quai ${r} passé en contrôle - Timer contrôle démarré`),t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
    ...
    `)}});g.get("/scan-fin-controle",async t=>{const r=t.req.query("quai");if(!r)return t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
    ...
    `).bind(r).first();let i=null;if(s!=null&&s.timer_controle_start){const c=new Date(s.timer_controle_start.replace(" ","T")+"Z").getTime(),d=Date.now();i=Math.floor((d-c)/1e3),console.log(`⏱️ Durée contrôle calculée: ${i}s`)}await t.env.DB.prepare(`
      UPDATE quai_status 
      SET statut = 'fin_controle',
          ...
          updated_at = datetime('now')
      WHERE quai_numero = ?
    `).bind(i,r).run(),console.log(`✅ Quai ${r} passé en fin de contrôle - Timer figé à ${i}s`);const a=Math.floor(i/3600),n=Math.floor(i%3600/60),l=i%60,o=`${String(a).padStart(2,"0")}:${String(n).padStart(2,"0")}:${String(l).padStart(2,"0")}`;return t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
      ...
      <body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md text-center transform hover:scale-105 transition-transform">
          ...
          <div class="bg-purple-50 border-l-4 border-purple-500 p-4 mb-6">
            ...
            <p class="text-3xl font-mono font-bold text-purple-900">${o}</p>
          </div>
    ...
    `)}catch(s){return console.error(`❌ Erreur scan fin contrôle quai ${r}:`,s),t.html(`
      <!DOCTYPE html>
      <html lang="fr">
      <head>
        <meta charset="UTF-8">
    ...
    `).run(),await t.prepare("CREATE INDEX IF NOT EXISTS idx_chat_messages_chauffeur_id ON chat_messages(chauffeur_id)").run(),await t.prepare("CREATE INDEX IF NOT EXISTS idx_chat_messages_timestamp ON chat_messages(timestamp)").run(),console.log("✅ Table chat_messages prête avec colonnes de traduction")}catch(r){console.error("⚠️ Erreur auto-migration chat_messages:",r.message)}}g.post("/api/chauffeur/chat",async t=>{try{await Br(t.env.DB);const{chauffeur_id:r,message:s,sender:i,lang:a}=await t.req.json();if(!r||!s)return t.json({success:!1,error:"Données manquantes"},400);let n=a||"fr";if(!a){const m=await t.env.DB.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(r,l,s,d,o,c,l==="chauffeur"?0:1,l==="admin"?0:1).run(),console.log(`✅ [CHAT] Message enregistré avec succès - ID chauffeur: ${r}`),t.json({success:!0,translated_fr:o,translated_chauffeur:c})}catch(r){return console.error("Erreur envoi message:",r),t.json({success:!1,error:r.message},500)}});g.get("/api/chauffeur/chat",async t=>{try{await Br(t.env.DB);const r=t.req.query("id")||t.req.query("chauffeur_id"),s=t.req.query("viewer")||"chauffeur";console.log(`📥 [CHAT GET] Récupération messages - Chauffeur: ${r}, Viewer: ${s}`);const i=await t.env.DB.prepare(`
      SELECT langue FROM chauffeur_arrivals WHERE id = ?
    ...
    `;try{const{results:s}=await t.env.DB.prepare(`
        ...
        WHERE ca.status = 'in_progress' 
        ORDER BY ca.arrival_time DESC
      `).all();return t.json({success:!0,chauffeurs:s})}catch{console.log("Table chauffeur_sessions not found, using simple query");const{results:i}=await t.env.DB.prepare(r).all();return t.json({success:!0,chauffeurs:i})}}catch(r){return console.error("Erreur liste chauffeurs:",r),t.json({success:!1,error:r.message},500)}});g.use("*",async(t,r)=>{const s=t.req.path;if(["/login","/test-questionnaire","/qrcode-chauffeur","/chauffeur/langue","/chauffeur/video","/chauffeur/inscription","/chauffeur/taches"].includes(s)||s.startsWith("/static/")||s.startsWith("/api/chauffeur/")){await r();return}await r()});g.use(wi);g.get("/",t=>t.render(e(Ei,{})));g.get("/reception",t=>t.render(e(ki,{})));g.get("/accueil-chauffeur",t=>t.render(e(Ci,{})));g.get("/administrateur",t=>t.render(e(Ti,{})));g.get("/controleur",t=>t.render(e(Ai,{})));g.get("/agent-quai",t=>t.render(e(qi,{})));g.get("/nouveau",t=>t.render(e(Si,{})));g.get("/anomalies",t=>t.render(e(_i,{})));g.get("/bibliotheque",t=>t.render(e(Ri,{})));g.get("/contacts",t=>t.render(e(Fi,{})));g.get("/admin/chauffeurs-dashboard",t=>t.render(e(Li,{})));g.post("/api/admin/chat",async t=>{try{const{chauffeur_id:r,message:s}=await t.req.json();if(!r||!s)return t.json({success:!1,error:"Données manquantes"},400);const i=await t.env.DB.prepare(`
      SELECT langue FROM chauffeur_arrivals WHERE id = ?
    `).bind(r).first(),a=(i==null?void 0:i.langue)||"fr";let n=s;a!=="fr"&&(n=await kt(s,a,"fr"));try{await t.env.DB.prepare(`
      ...
      `).bind(r,s,s,n).run()}catch{console.log("Using simple chat_messages structure for admin"),await t.env.DB.prepare(`
        ...
        VALUES (?, 'admin', ?, 0)
      `).bind(r,s).run()}return t.json({success:!0,translated:n})}catch(r){return console.error("Erreur envoi message admin:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/chauffeur/chat/mark-read",async t=>{try{const{chauffeur_id:r,reader:s}=await t.req.json(),i=s==="admin"?"read_by_admin":"read_by_chauffeur";return await t.env.DB.prepare(`
      UPDATE chat_messages 
      SET ${i} = 1, read_at = datetime('now')
      WHERE chauffeur_id = ? AND ${i} = 0
    `).bind(r).run(),t.json({success:!0})}catch(r){return console.error("Erreur marquage lu:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/admin/cloturer-chauffeur",async t=>{try{const{chauffeur_id:r}=await t.req.json();return await t.env.DB.prepare(`
      UPDATE chauffeur_arrivals 
      SET status = 'completed', 
          completed = 1,
          completion_time = datetime('now')
      WHERE id = ?
    `).bind(r).run(),t.json({success:!0})}catch(r){return console.error("Erreur clôture chauffeur:",r),t.json({success:!1,error:r.message},500)}});g.get("/api/notifications/non-lues",async t=>{try{const{results:r}=await t.env.DB.prepare(`
      SELECT * FROM notifications 
      WHERE read = 0 
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return t.json({success:!0,notifications:r})}catch(r){return console.error("Erreur notifications:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/notification/mark-read",async t=>{try{const{notification_id:r}=await t.req.json();return await t.env.DB.prepare(`
      UPDATE notifications SET read = 1 WHERE id = ?
    `).bind(r).run(),t.json({success:!0})}catch(r){return console.error("Erreur marquage notification:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/admin/cloturer-chauffeur",async t=>{try{const{chauffeur_id:r}=await t.req.json();return await t.env.DB.prepare(`
      UPDATE chauffeur_arrivals 
      SET status = 'completed', 
          departure_time = datetime('now')
      WHERE id = ?
    `).bind(r).run(),console.log(`✅ Chauffeur ${r} clôturé`),t.json({success:!0})}catch(r){return console.error("Erreur clôture chauffeur:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/chauffeur/notification",async t=>{try{const{chauffeur_id:r,type:s,titre:i,message:a}=await t.req.json();return await t.env.DB.prepare(`
      INSERT INTO notifications (chauffeur_id, type, titre, message)
      VALUES (?, ?, ?, ?)
    `).bind(r,s,i,a).run(),t.json({success:!0})}catch(r){return console.error("Erreur création notification:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/chauffeurs/inscription",Ui);g.get("/api/chauffeurs/:id",$i);g.get("/api/chauffeurs/:id/taches",Vi);g.post("/api/taches/:id/completer",Hi);g.get("/api/chauffeurs/:id/messages",Gi);g.post("/api/messages",Qi);g.post("/api/messages/:id/marquer-vu",Wi);g.get("/api/admin/chauffeurs-actifs",Xi);g.post("/api/admin/taches/assigner",Zi);g.get("/api/quais",async t=>{try{const{results:r}=await t.env.DB.prepare(`
      SELECT * FROM quai_status ORDER BY quai_numero ASC
    `).all();return t.json({success:!0,quais:r})}catch(r){return console.error("Erreur récupération quais:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/fin-dechargement",async t=>{try{const r=await t.req.json();if(console.log("📦 Données reçues fin déchargement:",r),!r.quai_numero||!r.nom_agent||!r.numero_id||!r.fournisseur||!r.palettes_attendues||!r.palettes_recues||!r.palettes_a_rendre)return t.json({success:!1,error:"Données manquantes"},400);const s={numero_id:r.numero_id,fournisseur:r.fournisseur,remarques_utilisateur:r.remarques||""},i=JSON.stringify(s),a=JSON.stringify(r.problemes||[]);await t.env.DB.prepare(`
    ...
    `).bind(r).first();return t.json({success:!0,quai:l})}catch(r){return console.error("Erreur mise à jour quai:",r),t.json({success:!1,error:r.message},500)}});g.post("/api/quai/scan",async t=>{try{const{barcode:r,quai:s,action:i,timestamp:a}=await t.req.json();if(!r||!s||!i)return t.json({success:!1,error:"Paramètres manquants (barcode, quai, action requis)"},400);await t.env.DB.prepare(`
    ...
    `).first();return t.json({success:!0,scan_id:n.meta.last_row_id,barcode:r,quai:s,action:i,timestamp:a,stats:l})}catch(r){return console.error("Erreur enregistrement scan:",r),t.json({success:!1,error:r.message},500)}});g.get("/api/quai/scans",async t=>{var r;try{const s=parseInt(t.req.query("limit")||"50"),i=t.req.query("quai");let a=`
