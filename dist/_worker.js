var $r=Object.defineProperty;var Dt=t=>{throw TypeError(t)};var Vr=(t,r,s)=>r in t?$r(t,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[r]=s;var y=(t,r,s)=>Vr(t,typeof r!="symbol"?r+"":r,s),ct=(t,r,s)=>r.has(t)||Dt("Cannot "+s);var m=(t,r,s)=>(ct(t,r,"read from private field"),s?s.call(t):r.get(t)),_=(t,r,s)=>r.has(t)?Dt("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(t):r.set(t,s),w=(t,r,s,i)=>(ct(t,r,"write to private field"),i?i.call(t,s):r.set(t,s),s),k=(t,r,s)=>(ct(t,r,"access private method"),s);var jt=(t,r,s,i)=>({set _(a){w(t,r,a,s)},get _(){return m(t,r,i)}});var ar={Stringify:1},L=(t,r)=>{const s=new String(t);return s.isEscaped=!0,s.callbacks=r,s},Gr=/[&<>'"]/,nr=async(t,r)=>{let s="";r||(r=[]);const i=await Promise.all(t);for(let a=i.length-1;s+=i[a],a--,!(a<0);a--){let n=i[a];typeof n=="object"&&r.push(...n.callbacks||[]);const l=n.isEscaped;if(n=await(typeof n=="object"?n.toString():n),typeof n=="object"&&r.push(...n.callbacks||[]),n.isEscaped??l)s+=n;else{const o=[s];te(n,o),s=o[0]}}return L(s,r)},te=(t,r)=>{const s=t.search(Gr);if(s===-1){r[0]+=t;return}let i,a,n=0;for(a=s;a<t.length;a++){switch(t.charCodeAt(a)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}r[0]+=t.substring(n,a)+i,n=a+1}r[0]+=t.substring(n,a)},or=t=>{const r=t.callbacks;if(!(r!=null&&r.length))return t;const s=[t],i={};return r.forEach(a=>a({phase:ar.Stringify,buffer:s,context:i})),s[0]},lr=async(t,r,s,i,a)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const n=t.callbacks;return n!=null&&n.length?(a?a[0]+=t:a=[t],Promise.all(n.map(o=>o({phase:r,buffer:a,context:i}))).then(o=>Promise.all(o.filter(Boolean).map(c=>lr(c,r,!1,i,a))).then(()=>a[0]))):Promise.resolve(t)},Qr=(t,...r)=>{const s=[""];for(let i=0,a=t.length-1;i<a;i++){s[0]+=t[i];const n=Array.isArray(r[i])?r[i].flat(1/0):[r[i]];for(let l=0,o=n.length;l<o;l++){const c=n[l];if(typeof c=="string")te(c,s);else if(typeof c=="number")s[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)s.unshift("",c);else{const d=c.toString();d instanceof Promise?s.unshift("",d):s[0]+=d}else c instanceof Promise?s.unshift("",c):te(c.toString(),s)}}}return s[0]+=t.at(-1),s.length===1?"callbacks"in s?L(or(L(s[0],s.callbacks))):L(s[0]):nr(s,s.callbacks)},kt=Symbol("RENDERER"),vt=Symbol("ERROR_HANDLER"),S=Symbol("STASH"),cr=Symbol("INTERNAL"),Xr=Symbol("MEMO"),rt=Symbol("PERMALINK"),Ft=t=>(t[cr]=!0,t),dr=t=>({value:r,children:s})=>{if(!s)return;const i={children:[{tag:Ft(()=>{t.push(r)}),props:{}}]};Array.isArray(s)?i.children.push(...s.flat()):i.children.push(s),i.children.push({tag:Ft(()=>{t.pop()}),props:{}});const a={tag:"",props:i,type:""};return a[vt]=n=>{throw t.pop(),n},a},ur=t=>{const r=[t],s=dr(r);return s.values=r,s.Provider=s,Ee.push(s),s},Ee=[],Ct=t=>{const r=[t],s=i=>{r.push(i.value);let a;try{a=i.children?(Array.isArray(i.children)?new pr("",{},i.children):i.children).toString():""}finally{r.pop()}return a instanceof Promise?a.then(n=>L(n,n.callbacks)):L(a)};return s.values=r,s.Provider=s,s[kt]=dr(r),Ee.push(s),s},_e=t=>t.values.at(-1),Xe={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},yt={},We="data-precedence",He=t=>Array.isArray(t)?t:[t],It=new WeakMap,Lt=(t,r,s,i)=>({buffer:a,context:n})=>{if(!a)return;const l=It.get(n)||{};It.set(n,l);const o=l[t]||(l[t]=[]);let c=!1;const d=Xe[t];if(d.length>0){e:for(const[,u]of o)for(const h of d)if(((u==null?void 0:u[h])??null)===(s==null?void 0:s[h])){c=!0;break e}}if(c?a[0]=a[0].replaceAll(r,""):d.length>0?o.push([r,s,i]):o.unshift([r,s,i]),a[0].indexOf("</head>")!==-1){let u;if(i===void 0)u=o.map(([h])=>h);else{const h=[];u=o.map(([f,,b])=>{let x=h.indexOf(b);return x===-1&&(h.push(b),x=h.length-1),[f,x]}).sort((f,b)=>f[1]-b[1]).map(([f])=>f)}u.forEach(h=>{a[0]=a[0].replaceAll(h,"")}),a[0]=a[0].replace(/(?=<\/head>)/,u.join(""))}},Ue=(t,r,s)=>L(new H(t,s,He(r??[])).toString()),Be=(t,r,s,i)=>{if("itemProp"in s)return Ue(t,r,s);let{precedence:a,blocking:n,...l}=s;a=i?a??"":void 0,i&&(l[We]=a);const o=new H(t,l,He(r||[])).toString();return o instanceof Promise?o.then(c=>L(o,[...c.callbacks||[],Lt(t,c,l,a)])):L(o,[Lt(t,o,l,a)])},Wr=({children:t,...r})=>{const s=qt();if(s){const i=_e(s);if(i==="svg"||i==="head")return new H("title",r,He(t??[]))}return Be("title",t,r,!1)},Yr=({children:t,...r})=>{const s=qt();return["src","async"].some(i=>!r[i])||s&&_e(s)==="head"?Ue("script",t,r):Be("script",t,r,!1)},Zr=({children:t,...r})=>["href","precedence"].every(s=>s in r)?(r["data-href"]=r.href,delete r.href,Be("style",t,r,!0)):Ue("style",t,r),Jr=({children:t,...r})=>["onLoad","onError"].some(s=>s in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?Ue("link",t,r):Be("link",t,r,"precedence"in r),Kr=({children:t,...r})=>{const s=qt();return s&&_e(s)==="head"?Ue("meta",t,r):Be("meta",t,r,!1)},mr=(t,{children:r,...s})=>new H(t,s,He(r??[])),es=t=>(typeof t.action=="function"&&(t.action=rt in t.action?t.action[rt]:void 0),mr("form",t)),hr=(t,r)=>(typeof r.formAction=="function"&&(r.formAction=rt in r.formAction?r.formAction[rt]:void 0),mr(t,r)),ts=t=>hr("input",t),rs=t=>hr("button",t);const dt=Object.freeze(Object.defineProperty({__proto__:null,button:rs,form:es,input:ts,link:Jr,meta:Kr,script:Yr,style:Zr,title:Wr},Symbol.toStringTag,{value:"Module"}));var ss=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),st=t=>ss.get(t)||t,fr=(t,r)=>{for(const[s,i]of Object.entries(t)){const a=s[0]==="-"||!/[A-Z]/.test(s)?s:s.replace(/[A-Z]/g,n=>`-${n.toLowerCase()}`);r(a,i==null?null:typeof i=="number"?a.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Re=void 0,qt=()=>Re,is=t=>/[A-Z]/.test(t)&&t.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,as=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ns=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],At=(t,r)=>{for(let s=0,i=t.length;s<i;s++){const a=t[s];if(typeof a=="string")te(a,r);else{if(typeof a=="boolean"||a===null||a===void 0)continue;a instanceof H?a.toStringToBuffer(r):typeof a=="number"||a.isEscaped?r[0]+=a:a instanceof Promise?r.unshift("",a):At(a,r)}}},H=class{constructor(t,r,s){y(this,"tag");y(this,"props");y(this,"key");y(this,"children");y(this,"isEscaped",!0);y(this,"localContexts");this.tag=t,this.props=r,this.children=s}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var r,s;const t=[""];(r=this.localContexts)==null||r.forEach(([i,a])=>{i.values.push(a)});try{this.toStringToBuffer(t)}finally{(s=this.localContexts)==null||s.forEach(([i])=>{i.values.pop()})}return t.length===1?"callbacks"in t?or(L(t[0],t.callbacks)).toString():t[0]:nr(t,t.callbacks)}toStringToBuffer(t){const r=this.tag,s=this.props;let{children:i}=this;t[0]+=`<${r}`;const a=Re&&_e(Re)==="svg"?n=>is(st(n)):n=>st(n);for(let[n,l]of Object.entries(s))if(n=a(n),n!=="children"){if(n==="style"&&typeof l=="object"){let o="";fr(l,(c,d)=>{d!=null&&(o+=`${o?";":""}${c}:${d}`)}),t[0]+=' style="',te(o,t),t[0]+='"'}else if(typeof l=="string")t[0]+=` ${n}="`,te(l,t),t[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)t[0]+=` ${n}="${l}"`;else if(typeof l=="boolean"&&ns.includes(n))l&&(t[0]+=` ${n}=""`);else if(n==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[L(l.__html)]}else if(l instanceof Promise)t[0]+=` ${n}="`,t.unshift('"',l);else if(typeof l=="function"){if(!n.startsWith("on")&&n!=="ref")throw new Error(`Invalid prop '${n}' of type 'function' supplied to '${r}'.`)}else t[0]+=` ${n}="`,te(l.toString(),t),t[0]+='"'}if(as.includes(r)&&i.length===0){t[0]+="/>";return}t[0]+=">",At(i,t),t[0]+=`</${r}>`}},ut=class extends H{toStringToBuffer(t){const{children:r}=this,s={...this.props};r.length&&(s.children=r.length===1?r[0]:r);const i=this.tag.call(null,s);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ee.length===0)t.unshift("",i);else{const a=Ee.map(n=>[n,n.values.at(-1)]);t.unshift("",i.then(n=>(n instanceof H&&(n.localContexts=a),n)))}else i instanceof H?i.toStringToBuffer(t):typeof i=="number"||i.isEscaped?(t[0]+=i,i.callbacks&&(t.callbacks||(t.callbacks=[]),t.callbacks.push(...i.callbacks))):te(i,t)}},pr=class extends H{toStringToBuffer(t){At(this.children,t)}},Pt=(t,r,...s)=>{r??(r={}),s.length&&(r.children=s.length===1?s[0]:s);const i=r.key;delete r.key;const a=Ye(t,r,s);return a.key=i,a},Ot=!1,Ye=(t,r,s)=>{if(!Ot){for(const i in yt)dt[i][kt]=yt[i];Ot=!0}return typeof t=="function"?new ut(t,r,s):dt[t]?new ut(dt[t],r,s):t==="svg"||t==="head"?(Re||(Re=Ct("")),new H(t,r,[new ut(Re,{value:t},s)])):new H(t,r,s)},os=({children:t})=>new pr("",{children:t},Array.isArray(t)?t:t?[t]:[]);function e(t,r,s){let i;if(!r||!("children"in r))i=Ye(t,r,[]);else{const a=r.children;i=Array.isArray(a)?Ye(t,r,a):Ye(t,r,[a])}return i.key=s,i}var Mt=(t,r,s)=>(i,a)=>{let n=-1;return l(0);async function l(o){if(o<=n)throw new Error("next() called multiple times");n=o;let c,d=!1,u;if(t[o]?(u=t[o][0][0],i.req.routeIndex=o):u=o===t.length&&a||void 0,u)try{c=await u(i,()=>l(o+1))}catch(h){if(h instanceof Error&&r)i.error=h,c=await r(h,i),d=!0;else throw h}else i.finalized===!1&&s&&(c=await s(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},ls=Symbol(),cs=async(t,r=Object.create(null))=>{const{all:s=!1,dot:i=!1}=r,n=(t instanceof wr?t.raw.headers:t.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?ds(t,{all:s,dot:i}):{}};async function ds(t,r){const s=await t.formData();return s?us(s,r):{}}function us(t,r){const s=Object.create(null);return t.forEach((i,a)=>{r.all||a.endsWith("[]")?ms(s,a,i):s[a]=i}),r.dot&&Object.entries(s).forEach(([i,a])=>{i.includes(".")&&(hs(s,i,a),delete s[i])}),s}var ms=(t,r,s)=>{t[r]!==void 0?Array.isArray(t[r])?t[r].push(s):t[r]=[t[r],s]:r.endsWith("[]")?t[r]=[s]:t[r]=s},hs=(t,r,s)=>{let i=t;const a=r.split(".");a.forEach((n,l)=>{l===a.length-1?i[n]=s:((!i[n]||typeof i[n]!="object"||Array.isArray(i[n])||i[n]instanceof File)&&(i[n]=Object.create(null)),i=i[n])})},gr=t=>{const r=t.split("/");return r[0]===""&&r.shift(),r},fs=t=>{const{groups:r,path:s}=ps(t),i=gr(s);return gs(i,r)},ps=t=>{const r=[];return t=t.replace(/\{[^}]+\}/g,(s,i)=>{const a=`@${i}`;return r.push([a,s]),a}),{groups:r,path:t}},gs=(t,r)=>{for(let s=r.length-1;s>=0;s--){const[i]=r[s];for(let a=t.length-1;a>=0;a--)if(t[a].includes(i)){t[a]=t[a].replace(i,r[s][1]);break}}return t},Ge={},bs=(t,r)=>{if(t==="*")return"*";const s=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const i=`${t}#${r}`;return Ge[i]||(s[2]?Ge[i]=r&&r[0]!==":"&&r[0]!=="*"?[i,s[1],new RegExp(`^${s[2]}(?=/${r})`)]:[t,s[1],new RegExp(`^${s[2]}$`)]:Ge[i]=[t,s[1],!0]),Ge[i]}return null},St=(t,r)=>{try{return r(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return r(s)}catch{return s}})}},xs=t=>St(t,decodeURI),br=t=>{const r=t.url,s=r.indexOf("/",r.indexOf(":")+4);let i=s;for(;i<r.length;i++){const a=r.charCodeAt(i);if(a===37){const n=r.indexOf("?",i),l=r.slice(s,n===-1?void 0:n);return xs(l.includes("%25")?l.replace(/%25/g,"%2525"):l)}else if(a===63)break}return r.slice(s,i)},vs=t=>{const r=br(t);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},me=(t,r,...s)=>(s.length&&(r=me(r,...s)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${r==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),xr=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const r=t.split("/"),s=[];let i="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))i+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&i===""?s.push("/"):s.push(i);const n=a.replace("?","");i+="/"+n,s.push(i)}else i+="/"+a}),s.filter((a,n,l)=>l.indexOf(a)===n)},mt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?St(t,yr):t):t,vr=(t,r,s)=>{let i;if(!s&&r&&!/[%+]/.test(r)){let l=t.indexOf("?",8);if(l===-1)return;for(t.startsWith(r,l+1)||(l=t.indexOf(`&${r}`,l+1));l!==-1;){const o=t.charCodeAt(l+r.length+1);if(o===61){const c=l+r.length+2,d=t.indexOf("&",c);return mt(t.slice(c,d===-1?void 0:d))}else if(o==38||isNaN(o))return"";l=t.indexOf(`&${r}`,l+1)}if(i=/[%+]/.test(t),!i)return}const a={};i??(i=/[%+]/.test(t));let n=t.indexOf("?",8);for(;n!==-1;){const l=t.indexOf("&",n+1);let o=t.indexOf("=",n);o>l&&l!==-1&&(o=-1);let c=t.slice(n+1,o===-1?l===-1?void 0:l:o);if(i&&(c=mt(c)),n=l,c==="")continue;let d;o===-1?d="":(d=t.slice(o+1,l===-1?void 0:l),i&&(d=mt(d))),s?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(d)):a[c]??(a[c]=d)}return r?a[r]:a},ys=vr,ws=(t,r)=>vr(t,r,!0),yr=decodeURIComponent,Ht=t=>St(t,yr),pe,I,Q,Er,Tr,wt,W,Kt,wr=(Kt=class{constructor(t,r="/",s=[[]]){_(this,Q);y(this,"raw");_(this,pe);_(this,I);y(this,"routeIndex",0);y(this,"path");y(this,"bodyCache",{});_(this,W,t=>{const{bodyCache:r,raw:s}=this,i=r[t];if(i)return i;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[t]())):r[t]=s[t]()});this.raw=t,this.path=r,w(this,I,s),w(this,pe,{})}param(t){return t?k(this,Q,Er).call(this,t):k(this,Q,Tr).call(this)}query(t){return ys(this.url,t)}queries(t){return ws(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const r={};return this.raw.headers.forEach((s,i)=>{r[i]=s}),r}async parseBody(t){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await cs(this,t))}json(){return m(this,W).call(this,"text").then(t=>JSON.parse(t))}text(){return m(this,W).call(this,"text")}arrayBuffer(){return m(this,W).call(this,"arrayBuffer")}blob(){return m(this,W).call(this,"blob")}formData(){return m(this,W).call(this,"formData")}addValidatedData(t,r){m(this,pe)[t]=r}valid(t){return m(this,pe)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[ls](){return m(this,I)}get matchedRoutes(){return m(this,I)[0].map(([[,t]])=>t)}get routePath(){return m(this,I)[0].map(([[,t]])=>t)[this.routeIndex].path}},pe=new WeakMap,I=new WeakMap,Q=new WeakSet,Er=function(t){const r=m(this,I)[0][this.routeIndex][1][t],s=k(this,Q,wt).call(this,r);return s&&/\%/.test(s)?Ht(s):s},Tr=function(){const t={},r=Object.keys(m(this,I)[0][this.routeIndex][1]);for(const s of r){const i=k(this,Q,wt).call(this,m(this,I)[0][this.routeIndex][1][s]);i!==void 0&&(t[s]=/\%/.test(i)?Ht(i):i)}return t},wt=function(t){return m(this,I)[1]?m(this,I)[1][t]:t},W=new WeakMap,Kt),Es="text/plain; charset=UTF-8",ht=(t,r)=>({"Content-Type":t,...r}),Fe,Ie,z,ge,$,F,Le,be,xe,ie,Pe,Oe,Y,he,er,Ts=(er=class{constructor(t,r){_(this,Y);_(this,Fe);_(this,Ie);y(this,"env",{});_(this,z);y(this,"finalized",!1);y(this,"error");_(this,ge);_(this,$);_(this,F);_(this,Le);_(this,be);_(this,xe);_(this,ie);_(this,Pe);_(this,Oe);y(this,"render",(...t)=>(m(this,be)??w(this,be,r=>this.html(r)),m(this,be).call(this,...t)));y(this,"setLayout",t=>w(this,Le,t));y(this,"getLayout",()=>m(this,Le));y(this,"setRenderer",t=>{w(this,be,t)});y(this,"header",(t,r,s)=>{this.finalized&&w(this,F,new Response(m(this,F).body,m(this,F)));const i=m(this,F)?m(this,F).headers:m(this,ie)??w(this,ie,new Headers);r===void 0?i.delete(t):s!=null&&s.append?i.append(t,r):i.set(t,r)});y(this,"status",t=>{w(this,ge,t)});y(this,"set",(t,r)=>{m(this,z)??w(this,z,new Map),m(this,z).set(t,r)});y(this,"get",t=>m(this,z)?m(this,z).get(t):void 0);y(this,"newResponse",(...t)=>k(this,Y,he).call(this,...t));y(this,"body",(t,r,s)=>k(this,Y,he).call(this,t,r,s));y(this,"text",(t,r,s)=>!m(this,ie)&&!m(this,ge)&&!r&&!s&&!this.finalized?new Response(t):k(this,Y,he).call(this,t,r,ht(Es,s)));y(this,"json",(t,r,s)=>k(this,Y,he).call(this,JSON.stringify(t),r,ht("application/json",s)));y(this,"html",(t,r,s)=>{const i=a=>k(this,Y,he).call(this,a,r,ht("text/html; charset=UTF-8",s));return typeof t=="object"?lr(t,ar.Stringify,!1,{}).then(i):i(t)});y(this,"redirect",(t,r)=>{const s=String(t);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,r??302)});y(this,"notFound",()=>(m(this,xe)??w(this,xe,()=>new Response),m(this,xe).call(this,this)));w(this,Fe,t),r&&(w(this,$,r.executionCtx),this.env=r.env,w(this,xe,r.notFoundHandler),w(this,Oe,r.path),w(this,Pe,r.matchResult))}get req(){return m(this,Ie)??w(this,Ie,new wr(m(this,Fe),m(this,Oe),m(this,Pe))),m(this,Ie)}get event(){if(m(this,$)&&"respondWith"in m(this,$))return m(this,$);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,$))return m(this,$);throw Error("This context has no ExecutionContext")}get res(){return m(this,F)||w(this,F,new Response(null,{headers:m(this,ie)??w(this,ie,new Headers)}))}set res(t){if(m(this,F)&&t){t=new Response(t.body,t);for(const[r,s]of m(this,F).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const i=m(this,F).headers.getSetCookie();t.headers.delete("set-cookie");for(const a of i)t.headers.append("set-cookie",a)}else t.headers.set(r,s)}w(this,F,t),this.finalized=!0}get var(){return m(this,z)?Object.fromEntries(m(this,z)):{}}},Fe=new WeakMap,Ie=new WeakMap,z=new WeakMap,ge=new WeakMap,$=new WeakMap,F=new WeakMap,Le=new WeakMap,be=new WeakMap,xe=new WeakMap,ie=new WeakMap,Pe=new WeakMap,Oe=new WeakMap,Y=new WeakSet,he=function(t,r,s){const i=m(this,F)?new Headers(m(this,F).headers):m(this,ie)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[l,o]of n)l.toLowerCase()==="set-cookie"?i.append(l,o):i.set(l,o)}if(s)for(const[n,l]of Object.entries(s))if(typeof l=="string")i.set(n,l);else{i.delete(n);for(const o of l)i.append(n,o)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,ge);return new Response(t,{status:a,headers:i})},er),N="ALL",_s="all",ks=["get","post","put","delete","options","patch"],_r="Can not add a route since the matcher is already built.",kr=class extends Error{},Cs="__COMPOSED_HANDLER",qs=t=>t.text("404 Not Found",404),Ut=(t,r)=>{if("getResponse"in t){const s=t.getResponse();return r.newResponse(s.body,s)}return console.error(t),r.text("Internal Server Error",500)},P,R,Cr,O,re,Ze,Je,ve,As=(ve=class{constructor(r={}){_(this,R);y(this,"get");y(this,"post");y(this,"put");y(this,"delete");y(this,"options");y(this,"patch");y(this,"all");y(this,"on");y(this,"use");y(this,"router");y(this,"getPath");y(this,"_basePath","/");_(this,P,"/");y(this,"routes",[]);_(this,O,qs);y(this,"errorHandler",Ut);y(this,"onError",r=>(this.errorHandler=r,this));y(this,"notFound",r=>(w(this,O,r),this));y(this,"fetch",(r,...s)=>k(this,R,Je).call(this,r,s[1],s[0],r.method));y(this,"request",(r,s,i,a)=>r instanceof Request?this.fetch(s?new Request(r,s):r,i,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${me("/",r)}`,s),i,a)));y(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(k(this,R,Je).call(this,r.request,r,void 0,r.request.method))})});[...ks,_s].forEach(n=>{this[n]=(l,...o)=>(typeof l=="string"?w(this,P,l):k(this,R,re).call(this,n,m(this,P),l),o.forEach(c=>{k(this,R,re).call(this,n,m(this,P),c)}),this)}),this.on=(n,l,...o)=>{for(const c of[l].flat()){w(this,P,c);for(const d of[n].flat())o.map(u=>{k(this,R,re).call(this,d.toUpperCase(),m(this,P),u)})}return this},this.use=(n,...l)=>(typeof n=="string"?w(this,P,n):(w(this,P,"*"),l.unshift(n)),l.forEach(o=>{k(this,R,re).call(this,N,m(this,P),o)}),this);const{strict:i,...a}=r;Object.assign(this,a),this.getPath=i??!0?r.getPath??br:vs}route(r,s){const i=this.basePath(r);return s.routes.map(a=>{var l;let n;s.errorHandler===Ut?n=a.handler:(n=async(o,c)=>(await Mt([],s.errorHandler)(o,()=>a.handler(o,c))).res,n[Cs]=a.handler),k(l=i,R,re).call(l,a.method,a.path,n)}),this}basePath(r){const s=k(this,R,Cr).call(this);return s._basePath=me(this._basePath,r),s}mount(r,s,i){let a,n;i&&(typeof i=="function"?n=i:(n=i.optionHandler,i.replaceRequest===!1?a=c=>c:a=i.replaceRequest));const l=n?c=>{const d=n(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};a||(a=(()=>{const c=me(this._basePath,r),d=c==="/"?0:c.length;return u=>{const h=new URL(u.url);return h.pathname=h.pathname.slice(d)||"/",new Request(h,u)}})());const o=async(c,d)=>{const u=await s(a(c.req.raw),...l(c));if(u)return u;await d()};return k(this,R,re).call(this,N,me(r,"*"),o),this}},P=new WeakMap,R=new WeakSet,Cr=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,w(r,O,m(this,O)),r.routes=this.routes,r},O=new WeakMap,re=function(r,s,i){r=r.toUpperCase(),s=me(this._basePath,s);const a={basePath:this._basePath,path:s,method:r,handler:i};this.router.add(r,s,[i,a]),this.routes.push(a)},Ze=function(r,s){if(r instanceof Error)return this.errorHandler(r,s);throw r},Je=function(r,s,i,a){if(a==="HEAD")return(async()=>new Response(null,await k(this,R,Je).call(this,r,s,i,"GET")))();const n=this.getPath(r,{env:i}),l=this.router.match(a,n),o=new Ts(r,{path:n,matchResult:l,env:i,executionCtx:s,notFoundHandler:m(this,O)});if(l[0].length===1){let d;try{d=l[0][0][0][0](o,async()=>{o.res=await m(this,O).call(this,o)})}catch(u){return k(this,R,Ze).call(this,u,o)}return d instanceof Promise?d.then(u=>u||(o.finalized?o.res:m(this,O).call(this,o))).catch(u=>k(this,R,Ze).call(this,u,o)):d??m(this,O).call(this,o)}const c=Mt(l[0],this.errorHandler,m(this,O));return(async()=>{try{const d=await c(o);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return k(this,R,Ze).call(this,d,o)}})()},ve),qr=[];function Ss(t,r){const s=this.buildAllMatchers(),i=(a,n)=>{const l=s[a]||s[N],o=l[2][n];if(o)return o;const c=n.match(l[0]);if(!c)return[[],qr];const d=c.indexOf("",1);return[l[1][d],c]};return this.match=i,i(t,r)}var it="[^/]+",Se=".*",Ne="(?:|/.*)",fe=Symbol(),Ns=new Set(".\\+*[^]$()");function Rs(t,r){return t.length===1?r.length===1?t<r?-1:1:-1:r.length===1||t===Se||t===Ne?1:r===Se||r===Ne?-1:t===it?1:r===it?-1:t.length===r.length?t<r?-1:1:r.length-t.length}var ae,ne,M,ce,Ds=(ce=class{constructor(){_(this,ae);_(this,ne);_(this,M,Object.create(null))}insert(r,s,i,a,n){if(r.length===0){if(m(this,ae)!==void 0)throw fe;if(n)return;w(this,ae,s);return}const[l,...o]=r,c=l==="*"?o.length===0?["","",Se]:["","",it]:l==="/*"?["","",Ne]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const u=c[1];let h=c[2]||it;if(u&&c[2]&&(h===".*"||(h=h.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(h))))throw fe;if(d=m(this,M)[h],!d){if(Object.keys(m(this,M)).some(f=>f!==Se&&f!==Ne))throw fe;if(n)return;d=m(this,M)[h]=new ce,u!==""&&w(d,ne,a.varIndex++)}!n&&u!==""&&i.push([u,m(d,ne)])}else if(d=m(this,M)[l],!d){if(Object.keys(m(this,M)).some(u=>u.length>1&&u!==Se&&u!==Ne))throw fe;if(n)return;d=m(this,M)[l]=new ce}d.insert(o,s,i,a,n)}buildRegExpStr(){const s=Object.keys(m(this,M)).sort(Rs).map(i=>{const a=m(this,M)[i];return(typeof m(a,ne)=="number"?`(${i})@${m(a,ne)}`:Ns.has(i)?`\\${i}`:i)+a.buildRegExpStr()});return typeof m(this,ae)=="number"&&s.unshift(`#${m(this,ae)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},ae=new WeakMap,ne=new WeakMap,M=new WeakMap,ce),nt,Me,tr,js=(tr=class{constructor(){_(this,nt,{varIndex:0});_(this,Me,new Ds)}insert(t,r,s){const i=[],a=[];for(let l=0;;){let o=!1;if(t=t.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return a[l]=[d,c],l++,o=!0,d}),!o)break}const n=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=a.length-1;l>=0;l--){const[o]=a[l];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(o)!==-1){n[c]=n[c].replace(o,a[l][1]);break}}return m(this,Me).insert(n,r,i,m(this,nt),s),i}buildRegExp(){let t=m(this,Me).buildRegExpStr();if(t==="")return[/^$/,[],[]];let r=0;const s=[],i=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,l)=>n!==void 0?(s[++r]=Number(n),"$()"):(l!==void 0&&(i[Number(l)]=++r),"")),[new RegExp(`^${t}`),s,i]}},nt=new WeakMap,Me=new WeakMap,tr),Fs=[/^$/,[],Object.create(null)],Ke=Object.create(null);function Ar(t){return Ke[t]??(Ke[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Is(){Ke=Object.create(null)}function Ls(t){var d;const r=new js,s=[];if(t.length===0)return Fs;const i=t.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,h],[f,b])=>u?1:f?-1:h.length-b.length),a=Object.create(null);for(let u=0,h=-1,f=i.length;u<f;u++){const[b,x,v]=i[u];b?a[x]=[v.map(([E])=>[E,Object.create(null)]),qr]:h++;let g;try{g=r.insert(x,h,b)}catch(E){throw E===fe?new kr(x):E}b||(s[h]=v.map(([E,T])=>{const C=Object.create(null);for(T-=1;T>=0;T--){const[q,A]=g[T];C[q]=A}return[E,C]}))}const[n,l,o]=r.buildRegExp();for(let u=0,h=s.length;u<h;u++)for(let f=0,b=s[u].length;f<b;f++){const x=(d=s[u][f])==null?void 0:d[1];if(!x)continue;const v=Object.keys(x);for(let g=0,E=v.length;g<E;g++)x[v[g]]=o[x[v[g]]]}const c=[];for(const u in l)c[u]=s[l[u]];return[n,c,a]}function de(t,r){if(t){for(const s of Object.keys(t).sort((i,a)=>a.length-i.length))if(Ar(s).test(r))return[...t[s]]}}var Z,J,ot,Sr,rr,Ps=(rr=class{constructor(){_(this,ot);y(this,"name","RegExpRouter");_(this,Z);_(this,J);y(this,"match",Ss);w(this,Z,{[N]:Object.create(null)}),w(this,J,{[N]:Object.create(null)})}add(t,r,s){var o;const i=m(this,Z),a=m(this,J);if(!i||!a)throw new Error(_r);i[t]||[i,a].forEach(c=>{c[t]=Object.create(null),Object.keys(c[N]).forEach(d=>{c[t][d]=[...c[N][d]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=Ar(r);t===N?Object.keys(i).forEach(d=>{var u;(u=i[d])[r]||(u[r]=de(i[d],r)||de(i[N],r)||[])}):(o=i[t])[r]||(o[r]=de(i[t],r)||de(i[N],r)||[]),Object.keys(i).forEach(d=>{(t===N||t===d)&&Object.keys(i[d]).forEach(u=>{c.test(u)&&i[d][u].push([s,n])})}),Object.keys(a).forEach(d=>{(t===N||t===d)&&Object.keys(a[d]).forEach(u=>c.test(u)&&a[d][u].push([s,n]))});return}const l=xr(r)||[r];for(let c=0,d=l.length;c<d;c++){const u=l[c];Object.keys(a).forEach(h=>{var f;(t===N||t===h)&&((f=a[h])[u]||(f[u]=[...de(i[h],u)||de(i[N],u)||[]]),a[h][u].push([s,n-d+c+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(m(this,J)).concat(Object.keys(m(this,Z))).forEach(r=>{t[r]||(t[r]=k(this,ot,Sr).call(this,r))}),w(this,Z,w(this,J,void 0)),Is(),t}},Z=new WeakMap,J=new WeakMap,ot=new WeakSet,Sr=function(t){const r=[];let s=t===N;return[m(this,Z),m(this,J)].forEach(i=>{const a=i[t]?Object.keys(i[t]).map(n=>[n,i[t][n]]):[];a.length!==0?(s||(s=!0),r.push(...a)):t!==N&&r.push(...Object.keys(i[N]).map(n=>[n,i[N][n]]))}),s?Ls(r):null},rr),K,V,sr,Os=(sr=class{constructor(t){y(this,"name","SmartRouter");_(this,K,[]);_(this,V,[]);w(this,K,t.routers)}add(t,r,s){if(!m(this,V))throw new Error(_r);m(this,V).push([t,r,s])}match(t,r){if(!m(this,V))throw new Error("Fatal error");const s=m(this,K),i=m(this,V),a=s.length;let n=0,l;for(;n<a;n++){const o=s[n];try{for(let c=0,d=i.length;c<d;c++)o.add(...i[c]);l=o.match(t,r)}catch(c){if(c instanceof kr)continue;throw c}this.match=o.match.bind(o),w(this,K,[o]),w(this,V,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(m(this,V)||m(this,K).length!==1)throw new Error("No active router has been determined yet.");return m(this,K)[0]}},K=new WeakMap,V=new WeakMap,sr),qe=Object.create(null),ee,j,oe,ye,D,G,se,we,Ms=(we=class{constructor(r,s,i){_(this,G);_(this,ee);_(this,j);_(this,oe);_(this,ye,0);_(this,D,qe);if(w(this,j,i||Object.create(null)),w(this,ee,[]),r&&s){const a=Object.create(null);a[r]={handler:s,possibleKeys:[],score:0},w(this,ee,[a])}w(this,oe,[])}insert(r,s,i){w(this,ye,++jt(this,ye)._);let a=this;const n=fs(s),l=[];for(let o=0,c=n.length;o<c;o++){const d=n[o],u=n[o+1],h=bs(d,u),f=Array.isArray(h)?h[0]:d;if(f in m(a,j)){a=m(a,j)[f],h&&l.push(h[1]);continue}m(a,j)[f]=new we,h&&(m(a,oe).push(h),l.push(h[1])),a=m(a,j)[f]}return m(a,ee).push({[r]:{handler:i,possibleKeys:l.filter((o,c,d)=>d.indexOf(o)===c),score:m(this,ye)}}),a}search(r,s){var c;const i=[];w(this,D,qe);let n=[this];const l=gr(s),o=[];for(let d=0,u=l.length;d<u;d++){const h=l[d],f=d===u-1,b=[];for(let x=0,v=n.length;x<v;x++){const g=n[x],E=m(g,j)[h];E&&(w(E,D,m(g,D)),f?(m(E,j)["*"]&&i.push(...k(this,G,se).call(this,m(E,j)["*"],r,m(g,D))),i.push(...k(this,G,se).call(this,E,r,m(g,D)))):b.push(E));for(let T=0,C=m(g,oe).length;T<C;T++){const q=m(g,oe)[T],A=m(g,D)===qe?{}:{...m(g,D)};if(q==="*"){const X=m(g,j)["*"];X&&(i.push(...k(this,G,se).call(this,X,r,m(g,D))),w(X,D,A),b.push(X));continue}const[ke,Ve,Ce]=q;if(!h&&!(Ce instanceof RegExp))continue;const U=m(g,j)[ke],zr=l.slice(d).join("/");if(Ce instanceof RegExp){const X=Ce.exec(zr);if(X){if(A[Ve]=X[0],i.push(...k(this,G,se).call(this,U,r,m(g,D),A)),Object.keys(m(U,j)).length){w(U,D,A);const lt=((c=X[0].match(/\//))==null?void 0:c.length)??0;(o[lt]||(o[lt]=[])).push(U)}continue}}(Ce===!0||Ce.test(h))&&(A[Ve]=h,f?(i.push(...k(this,G,se).call(this,U,r,A,m(g,D))),m(U,j)["*"]&&i.push(...k(this,G,se).call(this,m(U,j)["*"],r,A,m(g,D)))):(w(U,D,A),b.push(U)))}}n=b.concat(o.shift()??[])}return i.length>1&&i.sort((d,u)=>d.score-u.score),[i.map(({handler:d,params:u})=>[d,u])]}},ee=new WeakMap,j=new WeakMap,oe=new WeakMap,ye=new WeakMap,D=new WeakMap,G=new WeakSet,se=function(r,s,i,a){const n=[];for(let l=0,o=m(r,ee).length;l<o;l++){const c=m(r,ee)[l],d=c[s]||c[N],u={};if(d!==void 0&&(d.params=Object.create(null),n.push(d),i!==qe||a&&a!==qe))for(let h=0,f=d.possibleKeys.length;h<f;h++){const b=d.possibleKeys[h],x=u[d.score];d.params[b]=a!=null&&a[b]&&!x?a[b]:i[b]??(a==null?void 0:a[b]),u[d.score]=!0}}return n},we),le,ir,Hs=(ir=class{constructor(){y(this,"name","TrieRouter");_(this,le);w(this,le,new Ms)}add(t,r,s){const i=xr(r);if(i){for(let a=0,n=i.length;a<n;a++)m(this,le).insert(t,i[a],s);return}m(this,le).insert(t,r,s)}match(t,r){return m(this,le).search(t,r)}},le=new WeakMap,ir),Nr=class extends As{constructor(t={}){super(t),this.router=t.router??new Os({routers:[new Ps,new Hs]})}},Us=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,Bt=(t,r=zs)=>{const s=/\.([a-zA-Z0-9]+?)$/,i=t.match(s);if(!i)return;let a=r[i[1]];return a&&a.startsWith("text")&&(a+="; charset=utf-8"),a},Bs={aac:"audio/aac",avi:"video/x-msvideo",avif:"image/avif",av1:"video/av1",bin:"application/octet-stream",bmp:"image/bmp",css:"text/css",csv:"text/csv",eot:"application/vnd.ms-fontobject",epub:"application/epub+zip",gif:"image/gif",gz:"application/gzip",htm:"text/html",html:"text/html",ico:"image/x-icon",ics:"text/calendar",jpeg:"image/jpeg",jpg:"image/jpeg",js:"text/javascript",json:"application/json",jsonld:"application/ld+json",map:"application/json",mid:"audio/x-midi",midi:"audio/x-midi",mjs:"text/javascript",mp3:"audio/mpeg",mp4:"video/mp4",mpeg:"video/mpeg",oga:"audio/ogg",ogv:"video/ogg",ogx:"application/ogg",opus:"audio/opus",otf:"font/otf",pdf:"application/pdf",png:"image/png",rtf:"application/rtf",svg:"image/svg+xml",tif:"image/tiff",tiff:"image/tiff",ts:"video/mp2t",ttf:"font/ttf",txt:"text/plain",wasm:"application/wasm",webm:"video/webm",weba:"audio/webm",webmanifest:"application/manifest+json",webp:"image/webp",woff:"font/woff",woff2:"font/woff2",xhtml:"application/xhtml+xml",xml:"application/xml",zip:"application/zip","3gp":"video/3gpp","3g2":"video/3gpp2",gltf:"model/gltf+json",glb:"model/gltf-binary"},zs=Bs,$s=(...t)=>{let r=t.filter(a=>a!=="").join("/");r=r.replace(new RegExp("(?<=\\/)\\/+","g"),"");const s=r.split("/"),i=[];for(const a of s)a===".."&&i.length>0&&i.at(-1)!==".."?i.pop():a!=="."&&i.push(a);return i.join("/")||"."},Rr={br:".br",zstd:".zst",gzip:".gz"},Vs=Object.keys(Rr),Gs="index.html",Qs=t=>{const r=t.root??"./",s=t.path,i=t.join??$s;return async(a,n)=>{var u,h,f,b;if(a.finalized)return n();let l;if(t.path)l=t.path;else try{if(l=decodeURIComponent(a.req.path),/(?:^|[\/\\])\.\.(?:$|[\/\\])/.test(l))throw new Error}catch{return await((u=t.onNotFound)==null?void 0:u.call(t,a.req.path,a)),n()}let o=i(r,!s&&t.rewriteRequestPath?t.rewriteRequestPath(l):l);t.isDir&&await t.isDir(o)&&(o=i(o,Gs));const c=t.getContent;let d=await c(o,a);if(d instanceof Response)return a.newResponse(d.body,d);if(d){const x=t.mimes&&Bt(o,t.mimes)||Bt(o);if(a.header("Content-Type",x||"application/octet-stream"),t.precompressed&&(!x||Us.test(x))){const v=new Set((h=a.req.header("Accept-Encoding"))==null?void 0:h.split(",").map(g=>g.trim()));for(const g of Vs){if(!v.has(g))continue;const E=await c(o+Rr[g],a);if(E){d=E,a.header("Content-Encoding",g),a.header("Vary","Accept-Encoding",{append:!0});break}}}return await((f=t.onFound)==null?void 0:f.call(t,o,a)),a.body(d)}await((b=t.onNotFound)==null?void 0:b.call(t,o,a)),await n()}},Xs=async(t,r)=>{let s;r&&r.manifest?typeof r.manifest=="string"?s=JSON.parse(r.manifest):s=r.manifest:typeof __STATIC_CONTENT_MANIFEST=="string"?s=JSON.parse(__STATIC_CONTENT_MANIFEST):s=__STATIC_CONTENT_MANIFEST;let i;r&&r.namespace?i=r.namespace:i=__STATIC_CONTENT;const a=s[t];if(!a)return null;const n=await i.get(a,{type:"stream"});return n||null},Ws=t=>async function(s,i){return Qs({...t,getContent:async n=>Xs(n,{manifest:t.manifest,namespace:t.namespace?t.namespace:s.env?s.env.__STATIC_CONTENT:void 0})})(s,i)},Ys=t=>Ws(t),De="_hp",Zs={Change:"Input",DoubleClick:"DblClick"},Js={svg:"2000/svg",math:"1998/Math/MathML"},je=[],Et=new WeakMap,Te=void 0,Ks=()=>Te,B=t=>"t"in t,ft={onClick:["click",!1]},zt=t=>{if(!t.startsWith("on"))return;if(ft[t])return ft[t];const r=t.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(r){const[,s,i]=r;return ft[t]=[(Zs[s]||s).toLowerCase(),!!i]}},$t=(t,r)=>Te&&t instanceof SVGElement&&/[A-Z]/.test(r)&&(r in t.style||r.match(/^(?:o|pai|str|u|ve)/))?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,ei=(t,r,s)=>{var i;r||(r={});for(let a in r){const n=r[a];if(a!=="children"&&(!s||s[a]!==n)){a=st(a);const l=zt(a);if(l){if((s==null?void 0:s[a])!==n&&(s&&t.removeEventListener(l[0],s[a],l[1]),n!=null)){if(typeof n!="function")throw new Error(`Event handler for "${a}" is not a function`);t.addEventListener(l[0],n,l[1])}}else if(a==="dangerouslySetInnerHTML"&&n)t.innerHTML=n.__html;else if(a==="ref"){let o;typeof n=="function"?o=n(t)||(()=>n(null)):n&&"current"in n&&(n.current=t,o=()=>n.current=null),Et.set(t,o)}else if(a==="style"){const o=t.style;typeof n=="string"?o.cssText=n:(o.cssText="",n!=null&&fr(n,o.setProperty.bind(o)))}else{if(a==="value"){const c=t.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(t.value=n==null||n===!1?null:n,c==="TEXTAREA"){t.textContent=n;continue}else if(c==="SELECT"){t.selectedIndex===-1&&(t.selectedIndex=0);continue}}}else(a==="checked"&&t.nodeName==="INPUT"||a==="selected"&&t.nodeName==="OPTION")&&(t[a]=n);const o=$t(t,a);n==null||n===!1?t.removeAttribute(o):n===!0?t.setAttribute(o,""):typeof n=="string"||typeof n=="number"?t.setAttribute(o,n):t.setAttribute(o,n.toString())}}}if(s)for(let a in s){const n=s[a];if(a!=="children"&&!(a in r)){a=st(a);const l=zt(a);l?t.removeEventListener(l[0],n,l[1]):a==="ref"?(i=Et.get(t))==null||i():t.removeAttribute($t(t,a))}}},ti=(t,r)=>{r[S][0]=0,je.push([t,r]);const s=r.tag[kt]||r.tag,i=s.defaultProps?{...s.defaultProps,...r.props}:r.props;try{return[s.call(null,i)]}finally{je.pop()}},Dr=(t,r,s,i,a)=>{var n,l;(n=t.vR)!=null&&n.length&&(i.push(...t.vR),delete t.vR),typeof t.tag=="function"&&((l=t[S][1][Lr])==null||l.forEach(o=>a.push(o))),t.vC.forEach(o=>{var c;if(B(o))s.push(o);else if(typeof o.tag=="function"||o.tag===""){o.c=r;const d=s.length;if(Dr(o,r,s,i,a),o.s){for(let u=d;u<s.length;u++)s[u].s=!0;o.s=!1}}else s.push(o),(c=o.vR)!=null&&c.length&&(i.push(...o.vR),delete o.vR)})},ri=t=>{for(;;t=t.tag===De||!t.vC||!t.pP?t.nN:t.vC[0]){if(!t)return null;if(t.tag!==De&&t.e)return t.e}},jr=t=>{var r,s,i,a,n,l;B(t)||((s=(r=t[S])==null?void 0:r[1][Lr])==null||s.forEach(o=>{var c;return(c=o[2])==null?void 0:c.call(o)}),(i=Et.get(t.e))==null||i(),t.p===2&&((a=t.vC)==null||a.forEach(o=>o.p=2)),(n=t.vC)==null||n.forEach(jr)),t.p||((l=t.e)==null||l.remove(),delete t.e),typeof t.tag=="function"&&(Ae.delete(t),et.delete(t),delete t[S][3],t.a=!0)},Fr=(t,r,s)=>{t.c=r,Ir(t,r,s)},Vt=(t,r)=>{if(r){for(let s=0,i=t.length;s<i;s++)if(t[s]===r)return s}},Gt=Symbol(),Ir=(t,r,s)=>{var d;const i=[],a=[],n=[];Dr(t,r,i,a,n),a.forEach(jr);const l=s?void 0:r.childNodes;let o,c=null;if(s)o=-1;else if(!l.length)o=0;else{const u=Vt(l,ri(t.nN));u!==void 0?(c=l[u],o=u):o=Vt(l,(d=i.find(h=>h.tag!==De&&h.e))==null?void 0:d.e)??-1,o===-1&&(s=!0)}for(let u=0,h=i.length;u<h;u++,o++){const f=i[u];let b;if(f.s&&f.e)b=f.e,f.s=!1;else{const x=s||!f.e;B(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,b=f.e||(f.e=document.createTextNode(f.t))):(b=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),ei(b,f.props,f.pP),Ir(f,b,x))}f.tag===De?o--:s?b.parentNode||r.appendChild(b):l[o]!==b&&l[o-1]!==b&&(l[o+1]===b?r.appendChild(l[o]):r.insertBefore(b,c||l[o]||null))}if(t.pP&&delete t.pP,n.length){const u=[],h=[];n.forEach(([,f,,b,x])=>{f&&u.push(f),b&&h.push(b),x==null||x()}),u.forEach(f=>f()),h.length&&requestAnimationFrame(()=>{h.forEach(f=>f())})}},si=(t,r)=>!!(t&&t.length===r.length&&t.every((s,i)=>s[1]===r[i][1])),et=new WeakMap,Tt=(t,r,s)=>{var n,l,o,c,d,u;const i=!s&&r.pC;s&&(r.pC||(r.pC=r.vC));let a;try{s||(s=typeof r.tag=="function"?ti(t,r):He(r.props.children)),((n=s[0])==null?void 0:n.tag)===""&&s[0][vt]&&(a=s[0][vt],t[5].push([t,a,r]));const h=i?[...r.pC]:r.vC?[...r.vC]:void 0,f=[];let b;for(let x=0;x<s.length;x++){Array.isArray(s[x])&&s.splice(x,1,...s[x].flat());let v=ii(s[x]);if(v){typeof v.tag=="function"&&!v.tag[cr]&&(Ee.length>0&&(v[S][2]=Ee.map(E=>[E,E.values.at(-1)])),(l=t[5])!=null&&l.length&&(v[S][3]=t[5].at(-1)));let g;if(h&&h.length){const E=h.findIndex(B(v)?T=>B(T):v.key!==void 0?T=>T.key===v.key&&T.tag===v.tag:T=>T.tag===v.tag);E!==-1&&(g=h[E],h.splice(E,1))}if(g)if(B(v))g.t!==v.t&&(g.t=v.t,g.d=!0),v=g;else{const E=g.pP=g.props;if(g.props=v.props,g.f||(g.f=v.f||r.f),typeof v.tag=="function"){const T=g[S][2];g[S][2]=v[S][2]||[],g[S][3]=v[S][3],!g.f&&((g.o||g)===v.o||(c=(o=g.tag)[Xr])!=null&&c.call(o,E,g.props))&&si(T,g[S][2])&&(g.s=!0)}v=g}else if(!B(v)&&Te){const E=_e(Te);E&&(v.n=E)}if(!B(v)&&!v.s&&(Tt(t,v),delete v.f),f.push(v),b&&!b.s&&!v.s)for(let E=b;E&&!B(E);E=(d=E.vC)==null?void 0:d.at(-1))E.nN=v;b=v}}r.vR=i?[...r.vC,...h||[]]:h||[],r.vC=f,i&&delete r.pC}catch(h){if(r.f=!0,h===Gt){if(a)return;throw h}const[f,b,x]=((u=r[S])==null?void 0:u[3])||[];if(b){const v=()=>tt([0,!1,t[2]],x),g=et.get(x)||[];g.push(v),et.set(x,g);const E=b(h,()=>{const T=et.get(x);if(T){const C=T.indexOf(v);if(C!==-1)return T.splice(C,1),v()}});if(E){if(t[0]===1)t[1]=!0;else if(Tt(t,x,[E]),(b.length===1||t!==f)&&x.c){Fr(x,x.c,!1);return}throw Gt}}throw h}finally{a&&t[5].pop()}},ii=t=>{if(!(t==null||typeof t=="boolean")){if(typeof t=="string"||typeof t=="number")return{t:t.toString(),d:!0};if("vR"in t&&(t={tag:t.tag,props:t.props,key:t.key,f:t.f,type:t.tag,ref:t.props.ref,o:t.o||t}),typeof t.tag=="function")t[S]=[0,[]];else{const r=Js[t.tag];r&&(Te||(Te=ur("")),t.props.children=[{tag:Te,props:{value:t.n=`http://www.w3.org/${r}`,children:t.props.children}}])}return t}},Qt=(t,r)=>{var s,i;(s=r[S][2])==null||s.forEach(([a,n])=>{a.values.push(n)});try{Tt(t,r,void 0)}catch{return}if(r.a){delete r.a;return}(i=r[S][2])==null||i.forEach(([a])=>{a.values.pop()}),(t[0]!==1||!t[1])&&Fr(r,r.c,!1)},Ae=new WeakMap,Xt=[],tt=async(t,r)=>{t[5]||(t[5]=[]);const s=Ae.get(r);s&&s[0](void 0);let i;const a=new Promise(n=>i=n);if(Ae.set(r,[i,()=>{t[2]?t[2](t,r,n=>{Qt(n,r)}).then(()=>i(r)):(Qt(t,r),i(r))}]),Xt.length)Xt.at(-1).add(r);else{await Promise.resolve();const n=Ae.get(r);n&&(Ae.delete(r),n[1]())}return a},ai=(t,r,s)=>({tag:De,props:{children:t},key:s,e:r,p:1}),pt=0,Lr=1,gt=2,bt=3,xt=new WeakMap,Pr=(t,r)=>!t||!r||t.length!==r.length||r.some((s,i)=>s!==t[i]),ni=void 0,Wt=[],oi=t=>{var l;const r=()=>typeof t=="function"?t():t,s=je.at(-1);if(!s)return[r(),()=>{}];const[,i]=s,a=(l=i[S][1])[pt]||(l[pt]=[]),n=i[S][0]++;return a[n]||(a[n]=[r(),o=>{const c=ni,d=a[n];if(typeof o=="function"&&(o=o(d[0])),!Object.is(o,d[0]))if(d[0]=o,Wt.length){const[u,h]=Wt.at(-1);Promise.all([u===3?i:tt([u,!1,c],i),h]).then(([f])=>{if(!f||!(u===2||u===3))return;const b=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{b===f.vC&&tt([u===3?1:0,!1,c],f)})})})}else tt([0,!1,c],i)}])},Nt=(t,r)=>{var o;const s=je.at(-1);if(!s)return t;const[,i]=s,a=(o=i[S][1])[gt]||(o[gt]=[]),n=i[S][0]++,l=a[n];return Pr(l==null?void 0:l[1],r)?a[n]=[t,r]:t=a[n][0],t},li=t=>{const r=xt.get(t);if(r){if(r.length===2)throw r[1];return r[0]}throw t.then(s=>xt.set(t,[s]),s=>xt.set(t,[void 0,s])),t},ci=(t,r)=>{var o;const s=je.at(-1);if(!s)return t();const[,i]=s,a=(o=i[S][1])[bt]||(o[bt]=[]),n=i[S][0]++,l=a[n];return Pr(l==null?void 0:l[1],r)&&(a[n]=[t(),r]),a[n][0]},di=ur({pending:!1,data:null,method:null,action:null}),Yt=new Set,ui=t=>{Yt.add(t),t.finally(()=>Yt.delete(t))},Rt=(t,r)=>ci(()=>s=>{let i;t&&(typeof t=="function"?i=t(s)||(()=>{t(null)}):t&&"current"in t&&(t.current=s,i=()=>{t.current=null}));const a=r(s);return()=>{a==null||a(),i==null||i()}},[t]),ue=Object.create(null),Qe=Object.create(null),ze=(t,r,s,i,a)=>{if(r!=null&&r.itemProp)return{tag:t,props:r,type:t,ref:r.ref};const n=document.head;let{onLoad:l,onError:o,precedence:c,blocking:d,...u}=r,h=null,f=!1;const b=Xe[t];let x;if(b.length>0){const T=n.querySelectorAll(t);e:for(const C of T)for(const q of Xe[t])if(C.getAttribute(q)===r[q]){h=C;break e}if(!h){const C=b.reduce((q,A)=>r[A]===void 0?q:`${q}-${A}-${r[A]}`,t);f=!Qe[C],h=Qe[C]||(Qe[C]=(()=>{const q=document.createElement(t);for(const A of b)r[A]!==void 0&&q.setAttribute(A,r[A]),r.rel&&q.setAttribute("rel",r.rel);return q})())}}else x=n.querySelectorAll(t);c=i?c??"":void 0,i&&(u[We]=c);const v=Nt(T=>{if(b.length>0){let C=!1;for(const q of n.querySelectorAll(t)){if(C&&q.getAttribute(We)!==c){n.insertBefore(T,q);return}q.getAttribute(We)===c&&(C=!0)}n.appendChild(T)}else if(x){let C=!1;for(const q of x)if(q===T){C=!0;break}C||n.insertBefore(T,n.contains(x[0])?x[0]:n.querySelector(t)),x=void 0}},[c]),g=Rt(r.ref,T=>{var A;const C=b[0];if(s===2&&(T.innerHTML=""),(f||x)&&v(T),!o&&!l)return;let q=ue[A=T.getAttribute(C)]||(ue[A]=new Promise((ke,Ve)=>{T.addEventListener("load",ke),T.addEventListener("error",Ve)}));l&&(q=q.then(l)),o&&(q=q.catch(o)),q.catch(()=>{})});if(a&&d==="render"){const T=Xe[t][0];if(r[T]){const C=r[T],q=ue[C]||(ue[C]=new Promise((A,ke)=>{v(h),h.addEventListener("load",A),h.addEventListener("error",ke)}));li(q)}}const E={tag:t,type:t,props:{...u,ref:g},ref:g};return E.p=s,h&&(E.e=h),ai(E,n)},mi=t=>{const r=Ks(),s=r&&_e(r);return s!=null&&s.endsWith("svg")?{tag:"title",props:t,type:"title",ref:t.ref}:ze("title",t,void 0,!1,!1)},hi=t=>!t||["src","async"].some(r=>!t[r])?{tag:"script",props:t,type:"script",ref:t.ref}:ze("script",t,1,!1,!0),fi=t=>!t||!["href","precedence"].every(r=>r in t)?{tag:"style",props:t,type:"style",ref:t.ref}:(t["data-href"]=t.href,delete t.href,ze("style",t,2,!0,!0)),pi=t=>!t||["onLoad","onError"].some(r=>r in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?{tag:"link",props:t,type:"link",ref:t.ref}:ze("link",t,1,"precedence"in t,!0),gi=t=>ze("meta",t,void 0,!1,!1),Or=Symbol(),bi=t=>{const{action:r,...s}=t;typeof r!="function"&&(s.action=r);const[i,a]=oi([null,!1]),n=Nt(async d=>{const u=d.isTrusted?r:d.detail[Or];if(typeof u!="function")return;d.preventDefault();const h=new FormData(d.target);a([h,!0]);const f=u(h);f instanceof Promise&&(ui(f),await f),a([null,!0])},[]),l=Rt(t.ref,d=>(d.addEventListener("submit",n),()=>{d.removeEventListener("submit",n)})),[o,c]=i;return i[1]=!1,{tag:di,props:{value:{pending:o!==null,data:o,method:o?"post":null,action:o?r:null},children:{tag:"form",props:{...s,ref:l},type:"form",ref:l}},f:c}},Mr=(t,{formAction:r,...s})=>{if(typeof r=="function"){const i=Nt(a=>{a.preventDefault(),a.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Or]:r}}))},[]);s.ref=Rt(s.ref,a=>(a.addEventListener("click",i),()=>{a.removeEventListener("click",i)}))}return{tag:t,props:s,type:t,ref:s.ref}},xi=t=>Mr("input",t),vi=t=>Mr("button",t);Object.assign(yt,{title:mi,script:hi,style:fi,link:pi,meta:gi,form:bi,input:xi,button:vi});Ct(null);new TextEncoder;var yi=Ct(null),wi=(t,r,s,i)=>(a,n)=>{const l="<!DOCTYPE html>",o=s?Pt(d=>s(d,t),{Layout:r,...n},a):a,c=Qr`${L(l)}${Pt(yi.Provider,{value:t},o)}`;return t.html(c)},Hr=(t,r)=>function(i,a){const n=i.getLayout()??os;return t&&i.setLayout(l=>t({...l,Layout:n},i)),i.setRenderer(wi(i,n,t)),a()};const Ei=Hr(({children:t})=>e("html",{lang:"fr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"GXO Logistics - Intranet Moissy"}),e("script",{dangerouslySetInnerHTML:{__html:`
...
<body class="bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen p-8">
  ...
  `}async function Vi(t){try{const{nom:r,entreprise:s,telephone:i,plaque:a,type_camion:n,langue:l}=await t.req.json();if(!r||!s||!i||!a||!n)return t.json({error:"Tous les champs sont obligatoires"},400);const c=(await t.env.DB.prepare(`
    ...
    `).bind(r).all(),i=await t.env.DB.prepare(`
      ...
      LIMIT 10
    `).bind(r).all();return t.json({taches_en_cours:s.results||[],taches_terminees:i.results||[]})}catch(r){return console.error("Erreur récupération tâches:",r),t.json({error:"Erreur serveur"},500)}}async function Xi(t){try{const r=t.req.param("id");return await t.env.DB.prepare(`
      UPDATE taches_v2
    ...
    `).bind(r,s,i,a||null).run();return t.json({success:!0,id:n.meta.last_row_id,message:"Tâche assignée"})}catch(r){return console.error("Erreur assignation tâche:",r),t.json({error:"Erreur serveur"},500)}}const p=new Nr;function at(){return new Date().toLocaleString("sv-SE",{timeZone:"Europe/Paris",year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}).replace(",","")}p.use("/static/*",Ys({root:"./",onNotFound:(t,r)=>(console.log("Fichier non trouvé:",t),r.notFound())}));p.get("/login",$e,t=>t.render(e(Ii,{})));p.get("/qrcode-chauffeur",$e,t=>t.render(e(Li,{})));p.get("/chauffeur/langue",$e,t=>t.render(e(Pi,{})));p.get("/gestion-quais",$e,t=>t.render(e(Bi,{})));p.get("/pdf-barcodes",t=>t.html(zi()));p.get("/qrcode-generator",t=>t.html($i()));p.get("/scan-dechargement",t=>{const r=t.req.query("quai");return t.redirect(`/scan?quai=${r}`)});p.get("/scan",t=>{const r=t.req.query("quai"),s=t.req.query("action")||"start";return r?t.html(`
    <!DOCTYPE html>
    <html lang="fr">
    <head>
      <meta charset="UTF-8">
  ...
  `):t.html(`
    ...
    `)});p.post("/api/fin-controle",async t=>{try{const r=await t.req.json(),{quai:s,controleurNom:i}=r;if(!s||!i)return t.json({error:"Données manquantes"},400);const a=await t.env.DB.prepare(`
      ...
      FROM quai_status 
      WHERE quai_numero = ?
    `).bind(s).first();let n=null;if(a!=null&&a.timer_controle_start){const l=new Date(a.timer_controle_start.replace(" ","T")).getTime(),o=new Date(at().replace(" ","T")).getTime();n=Math.floor((o-l)/1e3),console.log(`⏱️ Durée contrôle calculée (JavaScript): ${n}s`),console.log(`   Start: ${a.timer_controle_start} → ${l}`),console.log(`   End: ${at()} → ${o}`)}await t.env.DB.prepare(`
      UPDATE quai_status 
...
<body class="bg-gradient-to-br from-purple-50 to-purple-100 min-h-screen p-8">
    ...
    `).bind(r.quai_numero,r.nom_agent,r.palettes_attendues,r.palettes_recues,r.palettes_a_rendre,a,r.autres_commentaire||null,i).run();console.log("✅ Fin de déchargement enregistrée - ID:",n.meta.last_row_id);const l=await t.env.DB.prepare(`
      SELECT timer_start FROM quai_status WHERE quai_numero = ?
    `).bind(r.quai_numero).first();console.log("📊 Quai data AVANT UPDATE:",l);const o=l==null?void 0:l.timer_start;let c=null;if(l!=null&&l.timer_start){const u=new Date(l.timer_start.replace(" ","T")).getTime(),h=new Date(at().replace(" ","T")).getTime();c=Math.floor((h-u)/1e3),console.log(`⏱️ Durée calculée (JavaScript): ${c}s (${Math.floor(c/3600)}h ${Math.floor(c%3600/60)}m ${c%60}s)`),console.log(`   Start: ${l.timer_start} → ${u}`),console.log(`   End: ${at()} → ${h}`)}console.log("📊 Timer start:",l==null?void 0:l.timer_start),console.log("💾 UPDATE avec:",{timerDuration:c,commentaire:`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,commentaire_auteur:r.nom_agent,quai_numero:r.quai_numero}),await t.env.DB.prepare(`
      UPDATE quai_status 
      SET statut = 'fin_dechargement',
          ...
          updated_at = datetime('now', 'localtime')
      WHERE quai_numero = ?
    `).bind(c,`Déchargement terminé - ${r.nom_agent} - ${r.fournisseur} - ID:${r.numero_id}`,r.nom_agent,r.quai_numero).run(),console.log("✅ Quai",r.quai_numero,"marqué comme fin_dechargement - Timer figé à",c,"secondes");let d=!1;try{console.log("🔍 Vérification alerte - Données reçues:",{palettes_attendues:r.palettes_attendues,palettes_recues:r.palettes_recues,problemes:r.problemes});const u=parseInt(r.palettes_attendues)!==parseInt(r.palettes_recues);console.log("📊 Écart palettes:",u,`(${r.palettes_attendues} vs ${r.palettes_recues})`);const h=r.problemes||[],f=h.length>0;console.log("⚠️ Non-conformités:",f,"Nombre:",h.length),console.log("📊 CRÉATION ALERTE KPI - Tous les camions sont enregistrés"),console.log("   Quai:",r.quai_numero),console.log("   ID:",r.numero_id),console.log("   Fournisseur:",r.fournisseur);{const b=new Date().toISOString().slice(0,19).replace("T"," ");console.log("⏰ Utilisation timer_start sauvegardé:",o),console.log("⏰ timer_fin_timestamp (NOW):",b),await t.env.DB.prepare(`
        ...
        `).run(),console.log("✅ Table controleur_alertes vérifiée");let x="";u&&(x=`Écart palettes: Attendues ${r.palettes_attendues}, Reçues ${r.palettes_recues}`);const v=JSON.stringify(h);console.log("📝 Non-conformités (problèmes):",v);const g=JSON.stringify(r.verification_points||{});console.log("📝 Points de vérification:",g);const E=u||f?"en_attente":"traitee";console.log("📊 Statut alerte:",E,"(Problèmes:",u||f,")"),console.log("⏱️ Durée déchargement:",c,"secondes");const T=await t.env.DB.prepare(`
