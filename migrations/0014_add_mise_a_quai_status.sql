-- ===================================================================
-- MIGRATION CLOUDFLARE D1 - Ajout statut "mise_a_quai_non_decharge"
-- ===================================================================
-- Date: 2026-03-10
-- Version: 3.8.1
-- Description: Ajouter le statut "mise_a_quai_non_decharge" (marron)
--              pour les camions stationnés mais pas encore déchargés
-- ===================================================================

-- COMMANDE 1: Supprimer l'ancienne table temporaire si elle existe
DROP TABLE IF EXISTS quai_status_new;

-- COMMANDE 2: Créer la nouvelle table avec les 7 statuts
...
-- COMMANDE 8: Vérifier les statuts possibles
SELECT DISTINCT statut FROM quai_status;

-- ===================================================================
-- RÉSULTAT ATTENDU: 
-- - total_quais = 45
-- - NOUVEAU STATUT: 'mise_a_quai_non_decharge' (marron, icône 📦)
-- - Utilisé pour les camions stationnés mais pas encore déchargés
-- - Nécessite un commentaire obligatoire (comme 'indisponible')
-- ===================================================================
