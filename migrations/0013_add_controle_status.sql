-- ===================================================================
-- MIGRATION CLOUDFLARE D1 - Ajout statuts "en_controle" et "fin_controle"
-- ===================================================================
...
-- COMMANDE 2: Créer la nouvelle table avec les 6 statuts
...
-- NOUVEAUX CHAMPS: timer_controle_start, timer_controle_duration
-- NOUVEAUX STATUTS: 'en_controle', 'fin_controle'
-- ===================================================================
