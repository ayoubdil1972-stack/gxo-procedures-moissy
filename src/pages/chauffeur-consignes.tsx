        ...
        <div class="flex-1 flex items-center justify-center p-4 md:p-6">
          <div class="w-full max-w-4xl bg-white rounded-xl shadow-2xl p-6 md:p-8">
                ...
                <div class="flex-1">
                  ...
                  <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                      ...
                      <span class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.consigneEPI}}></span>
                    </li>
                    <li class="flex items-start gap-3">
                      <i class="fas fa-smoking-ban text-red-600 text-xl mt-1"></i>
                      <span class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.consigneFumer}}></span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div class="flex-1">
                  ...
                  <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                      ...
                      <span class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.consignePalette}}></span>
                    </li>
                    <li class="flex items-start gap-3">
                      <i class="fas fa-truck-loading text-blue-600 text-xl mt-1"></i>
                      <span class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.consigneHayon}}></span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="mb-8 bg-green-50 border-l-4 border-green-500 rounded-lg p-6">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.consigneClefs}}></p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-orange-50 border-2 border-orange-300 rounded-lg p-6 mb-8">
              ...
              <p class="text-gray-700 text-base md:text-lg leading-relaxed" dangerouslySetInnerHTML={{__html: t.messageImportant}}></p>
            </div>
