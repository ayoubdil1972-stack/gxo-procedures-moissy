    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 p-4">
      <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div class="text-center mb-8">
          <img src="/static/gxo-logo-official.svg" alt="GXO Logistics" class="h-20 mx-auto mb-4" />
        ...
        {/* QR Code */}
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-8 mb-6 text-center">
          <div class="bg-white inline-block p-4 rounded-lg shadow-md">
            <div id="qrcode-container"></div>
          </div>
          <p class="text-gray-700 font-semibold mt-4 text-sm">
            🇫🇷 🇬🇧 🇪🇸 🇵🇱 🇩🇪 🇮🇹
          </p>
        ...
        <div class="text-center">
          <p class="text-gray-600 text-sm mb-3">Ou cliquez directement :</p>
          <a 
            href="/chauffeur/langue" 
            class="inline-block bg-gradient-to-r from-[#FF5A1A] to-[#FF4500] text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all"
          >
        ...
        __html: `
          document.addEventListener('DOMContentLoaded', function() {
            ...
            if (container && typeof QRCode !== 'undefined') {
              // URL complète du système chauffeur
