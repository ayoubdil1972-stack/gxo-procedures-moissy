...
// 🔄 CORRÉLATION DIRECTE avec quai_status (comme avant v3.11.34)
  ...
  try {
    ...
    const moyennes = {
      ...
      dechargement_minutes: totalCamions > 0 
        ? Math.round((dureeDechTotal / totalCamions) / 60) 
        : 0,
      controle_minutes: totalCamions > 0
        ? Math.round((dureeCtrlTotal / totalCamions) / 60) 
        : 0
    }
    
    console.log('📊✅ Moyennes:', moyennes)
    
    // ✅ RETOUR AVEC "quais" (frontend attend ce nom)
    return c.json({
      success: true,
      quais: results,
      moyennes: moyennes,
